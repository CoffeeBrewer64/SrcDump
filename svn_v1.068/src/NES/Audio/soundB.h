...
inline void __ProcessSoundBPitchOrg()
{
...
inline void __Sound_Write_B(u16 reg, u8 value)
{
	u8 old;
	(void)value;
	reg = (u16)(reg - 4);
	...
	case 0:
		...
		{			
			...
			SoundB.envinterval = __SoundEnvelopeRateTo32(SoundB.envinterval);			
	...
	case 1:
		...
		SoundB.sweepinterval = __SoundSweepRateTo32(SoundB.sweepinterval);
...
inline s16 __ProcessSoundB(void)
{
	s32 sample;
	u32 samplef32;
	f32 wave;
