...
inline s8 __GetWave_Triangle(s32 counter)
{	
	return(TRIANGLE_TABLE[counter]);	
}

inline u32 __PitchTo32_HVC_C(u16 pitch)
{
	f32 freq;
	u32 cc;
...
inline void __Sound_Write_C(u16 reg, u8 value)
{
	u8 old;
...
inline s16 __ProcessSoundC(void)
{
	...
	s16 sample = (s16)(s8)__GetWave_Triangle(SoundC.fcounter.fc.high);
