...
inline void __ProcessSoundAPitchOrg()
{
...
inline void __Sound_Write_A(u16 reg, u8 value)
{
	u8 old;
...
inline s16 __ProcessSoundA()
{
	...
	u32 samplef32 = __GetWave_Pulse2(SoundA.dutytype+DUTY_0, &(SoundA.fc32), SoundA.pitch);
	...
	f32 wave = VOLTABLE_HVCPULSE[SoundA.envgain >> 8];
	...
	s32 sample = (s16)((f32)(wave) * samplef32);
