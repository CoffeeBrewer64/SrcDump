/*---------------------------------------------------------------------------*
  ...
  File:     nn/hw/CTR-MG20/ARM9/ioreg_mg20patch_AES.h
...
//
#ifndef NN_HW_CTR_MG20_ARM9_IOREG_MG20PATCH_AES_H_
#define NN_HW_CTR_MG20_ARM9_IOREG_MG20PATCH_AES_H_
...
#define REG_AES_CNT_OFFSET                                 0x60000
#define REG_AES_CNT_ADDR                                   (HW_MG20IOP_REG + REG_AES_CNT_OFFSET)
#define reg_AES_AES_CNT                                    (*( REGType32v *) REG_AES_CNT_ADDR)

/* AES_LEN */

#define REG_AES_LEN_OFFSET                                 0x60004
#define REG_AES_LEN_ADDR                                   (HW_MG20IOP_REG + REG_AES_LEN_OFFSET)
#define reg_AES_AES_LEN                                    (*( REGType32v *) REG_AES_LEN_ADDR)

/* AES_ALEN */

#define REG_AES_ALEN_OFFSET                                0x60004
#define REG_AES_ALEN_ADDR                                  (HW_MG20IOP_REG + REG_AES_ALEN_OFFSET)
#define reg_AES_AES_ALEN                                   (*( REGType16v *) REG_AES_ALEN_ADDR)

/* AES_PLEN */

#define REG_AES_PLEN_OFFSET                                0x60006
#define REG_AES_PLEN_ADDR                                  (HW_MG20IOP_REG + REG_AES_PLEN_OFFSET)
#define reg_AES_AES_PLEN                                   (*( REGType16v *) REG_AES_PLEN_ADDR)

/* AES_IFIFO */

#define REG_AES_IFIFO_OFFSET                               0x60008
#define REG_AES_IFIFO_ADDR                                 (HW_MG20IOP_REG + REG_AES_IFIFO_OFFSET)
#define reg_AES_AES_IFIFO                                  (*( REGType32v *) REG_AES_IFIFO_ADDR)

/* AES_OFIFO */

#define REG_AES_OFIFO_OFFSET                               0x6000c
#define REG_AES_OFIFO_ADDR                                 (HW_MG20IOP_REG + REG_AES_OFIFO_OFFSET)
#define reg_AES_AES_OFIFO                                  (*(const REGType32v *) REG_AES_OFIFO_ADDR)

/* AES_KEY_A0 */

#define REG_AES_KEY_A0_OFFSET                              0x60010
#define REG_AES_KEY_A0_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_A0_OFFSET)
#define reg_AES_AES_KEY_A0                                 (*( REGType32v *) REG_AES_KEY_A0_ADDR)

/* AES_KEY_A1 */

#define REG_AES_KEY_A1_OFFSET                              0x60014
#define REG_AES_KEY_A1_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_A1_OFFSET)
#define reg_AES_AES_KEY_A1                                 (*( REGType32v *) REG_AES_KEY_A1_ADDR)

/* AES_KEY_A2 */

#define REG_AES_KEY_A2_OFFSET                              0x60018
#define REG_AES_KEY_A2_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_A2_OFFSET)
#define reg_AES_AES_KEY_A2                                 (*( REGType32v *) REG_AES_KEY_A2_ADDR)

/* AES_KEY_A3 */

#define REG_AES_KEY_A3_OFFSET                              0x6001c
#define REG_AES_KEY_A3_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_A3_OFFSET)
#define reg_AES_AES_KEY_A3                                 (*( REGType32v *) REG_AES_KEY_A3_ADDR)

/* AES_NONCE0 */

#define REG_AES_NONCE0_OFFSET                              0x60020
#define REG_AES_NONCE0_ADDR                                (HW_MG20IOP_REG + REG_AES_NONCE0_OFFSET)
#define reg_AES_AES_NONCE0                                 (*( REGType32v *) REG_AES_NONCE0_ADDR)

/* AES_NONCE1 */

#define REG_AES_NONCE1_OFFSET                              0x60024
#define REG_AES_NONCE1_ADDR                                (HW_MG20IOP_REG + REG_AES_NONCE1_OFFSET)
#define reg_AES_AES_NONCE1                                 (*( REGType32v *) REG_AES_NONCE1_ADDR)

/* AES_NONCE2 */

#define REG_AES_NONCE2_OFFSET                              0x60028
#define REG_AES_NONCE2_ADDR                                (HW_MG20IOP_REG + REG_AES_NONCE2_OFFSET)
#define reg_AES_AES_NONCE2                                 (*( REGType32v *) REG_AES_NONCE2_ADDR)

/* AES_NONCE3 */

#define REG_AES_NONCE3_OFFSET                              0x6002c
#define REG_AES_NONCE3_ADDR                                (HW_MG20IOP_REG + REG_AES_NONCE3_OFFSET)
#define reg_AES_AES_NONCE3                                 (*( REGType32v *) REG_AES_NONCE3_ADDR)

/* AES_MAC0 */

#define REG_AES_MAC0_OFFSET                                0x60030
#define REG_AES_MAC0_ADDR                                  (HW_MG20IOP_REG + REG_AES_MAC0_OFFSET)
#define reg_AES_AES_MAC0                                   (*( REGType32v *) REG_AES_MAC0_ADDR)

/* AES_MAC1 */

#define REG_AES_MAC1_OFFSET                                0x60034
#define REG_AES_MAC1_ADDR                                  (HW_MG20IOP_REG + REG_AES_MAC1_OFFSET)
#define reg_AES_AES_MAC1                                   (*( REGType32v *) REG_AES_MAC1_ADDR)

/* AES_MAC2 */

#define REG_AES_MAC2_OFFSET                                0x60038
#define REG_AES_MAC2_ADDR                                  (HW_MG20IOP_REG + REG_AES_MAC2_OFFSET)
#define reg_AES_AES_MAC2                                   (*( REGType32v *) REG_AES_MAC2_ADDR)

/* AES_MAC3 */

#define REG_AES_MAC3_OFFSET                                0x6003c
#define REG_AES_MAC3_ADDR                                  (HW_MG20IOP_REG + REG_AES_MAC3_OFFSET)
#define reg_AES_AES_MAC3                                   (*( REGType32v *) REG_AES_MAC3_ADDR)

/* AES_ID_A0 */

#define REG_AES_ID_A0_OFFSET                               0x60040
#define REG_AES_ID_A0_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_A0_OFFSET)
#define reg_AES_AES_ID_A0                                  (*( REGType32v *) REG_AES_ID_A0_ADDR)

/* AES_ID_A1 */

#define REG_AES_ID_A1_OFFSET                               0x60044
#define REG_AES_ID_A1_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_A1_OFFSET)
#define reg_AES_AES_ID_A1                                  (*( REGType32v *) REG_AES_ID_A1_ADDR)

/* AES_ID_A2 */

#define REG_AES_ID_A2_OFFSET                               0x60048
#define REG_AES_ID_A2_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_A2_OFFSET)
#define reg_AES_AES_ID_A2                                  (*( REGType32v *) REG_AES_ID_A2_ADDR)

/* AES_ID_A3 */

#define REG_AES_ID_A3_OFFSET                               0x6004c
#define REG_AES_ID_A3_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_A3_OFFSET)
#define reg_AES_AES_ID_A3                                  (*( REGType32v *) REG_AES_ID_A3_ADDR)

/* AES_SEED_A0 */

#define REG_AES_SEED_A0_OFFSET                             0x60050
#define REG_AES_SEED_A0_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_A0_OFFSET)
#define reg_AES_AES_SEED_A0                                (*( REGType32v *) REG_AES_SEED_A0_ADDR)

/* AES_SEED_A1 */

#define REG_AES_SEED_A1_OFFSET                             0x60054
#define REG_AES_SEED_A1_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_A1_OFFSET)
#define reg_AES_AES_SEED_A1                                (*( REGType32v *) REG_AES_SEED_A1_ADDR)

/* AES_SEED_A2 */

#define REG_AES_SEED_A2_OFFSET                             0x60058
#define REG_AES_SEED_A2_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_A2_OFFSET)
#define reg_AES_AES_SEED_A2                                (*( REGType32v *) REG_AES_SEED_A2_ADDR)

/* AES_SEED_A3 */

#define REG_AES_SEED_A3_OFFSET                             0x6005c
#define REG_AES_SEED_A3_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_A3_OFFSET)
#define reg_AES_AES_SEED_A3                                (*( REGType32v *) REG_AES_SEED_A3_ADDR)

/* AES_KEYSEL */

#define REG_AES_KEYSEL_OFFSET                              0x60060
#define REG_AES_KEYSEL_ADDR                                (HW_MG20IOP_REG + REG_AES_KEYSEL_OFFSET)
#define reg_AES_AES_KEYSEL                                 (*( REGType16v *) REG_AES_KEYSEL_ADDR)

/* AES_USEKEY */

#define REG_AES_USEKEY_OFFSET                              0x60060
#define REG_AES_USEKEY_ADDR                                (HW_MG20IOP_REG + REG_AES_USEKEY_OFFSET)
#define reg_AES_AES_USEKEY                                 (*( REGType8v *) REG_AES_USEKEY_ADDR)

/* AES_STRKEY */

#define REG_AES_STRKEY_OFFSET                              0x60061
#define REG_AES_STRKEY_ADDR                                (HW_MG20IOP_REG + REG_AES_STRKEY_OFFSET)
#define reg_AES_AES_STRKEY                                 (*( REGType8v *) REG_AES_STRKEY_ADDR)

/* AES_KEY_B0 */

#define REG_AES_KEY_B0_OFFSET                              0x60070
#define REG_AES_KEY_B0_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_B0_OFFSET)
#define reg_AES_AES_KEY_B0                                 (*( REGType32v *) REG_AES_KEY_B0_ADDR)

/* AES_KEY_B1 */

#define REG_AES_KEY_B1_OFFSET                              0x60074
#define REG_AES_KEY_B1_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_B1_OFFSET)
#define reg_AES_AES_KEY_B1                                 (*( REGType32v *) REG_AES_KEY_B1_ADDR)

/* AES_KEY_B2 */

#define REG_AES_KEY_B2_OFFSET                              0x60078
#define REG_AES_KEY_B2_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_B2_OFFSET)
#define reg_AES_AES_KEY_B2                                 (*( REGType32v *) REG_AES_KEY_B2_ADDR)

/* AES_KEY_B3 */

#define REG_AES_KEY_B3_OFFSET                              0x6007c
#define REG_AES_KEY_B3_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_B3_OFFSET)
#define reg_AES_AES_KEY_B3                                 (*( REGType32v *) REG_AES_KEY_B3_ADDR)

/* AES_ID_B0 */

#define REG_AES_ID_B0_OFFSET                               0x60080
#define REG_AES_ID_B0_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_B0_OFFSET)
#define reg_AES_AES_ID_B0                                  (*( REGType32v *) REG_AES_ID_B0_ADDR)

/* AES_ID_B1 */

#define REG_AES_ID_B1_OFFSET                               0x60084
#define REG_AES_ID_B1_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_B1_OFFSET)
#define reg_AES_AES_ID_B1                                  (*( REGType32v *) REG_AES_ID_B1_ADDR)

/* AES_ID_B2 */

#define REG_AES_ID_B2_OFFSET                               0x60088
#define REG_AES_ID_B2_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_B2_OFFSET)
#define reg_AES_AES_ID_B2                                  (*( REGType32v *) REG_AES_ID_B2_ADDR)

/* AES_ID_B3 */

#define REG_AES_ID_B3_OFFSET                               0x6008c
#define REG_AES_ID_B3_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_B3_OFFSET)
#define reg_AES_AES_ID_B3                                  (*( REGType32v *) REG_AES_ID_B3_ADDR)

/* AES_SEED_B0 */

#define REG_AES_SEED_B0_OFFSET                             0x60090
#define REG_AES_SEED_B0_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_B0_OFFSET)
#define reg_AES_AES_SEED_B0                                (*( REGType32v *) REG_AES_SEED_B0_ADDR)

/* AES_SEED_B1 */

#define REG_AES_SEED_B1_OFFSET                             0x60094
#define REG_AES_SEED_B1_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_B1_OFFSET)
#define reg_AES_AES_SEED_B1                                (*( REGType32v *) REG_AES_SEED_B1_ADDR)

/* AES_SEED_B2 */

#define REG_AES_SEED_B2_OFFSET                             0x60098
#define REG_AES_SEED_B2_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_B2_OFFSET)
#define reg_AES_AES_SEED_B2                                (*( REGType32v *) REG_AES_SEED_B2_ADDR)

/* AES_SEED_B3 */

#define REG_AES_SEED_B3_OFFSET                             0x6009c
#define REG_AES_SEED_B3_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_B3_OFFSET)
#define reg_AES_AES_SEED_B3                                (*( REGType32v *) REG_AES_SEED_B3_ADDR)

/* AES_KEY_C0 */

#define REG_AES_KEY_C0_OFFSET                              0x600a0
#define REG_AES_KEY_C0_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_C0_OFFSET)
#define reg_AES_AES_KEY_C0                                 (*( REGType32v *) REG_AES_KEY_C0_ADDR)

/* AES_KEY_C1 */

#define REG_AES_KEY_C1_OFFSET                              0x600a4
#define REG_AES_KEY_C1_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_C1_OFFSET)
#define reg_AES_AES_KEY_C1                                 (*( REGType32v *) REG_AES_KEY_C1_ADDR)

/* AES_KEY_C2 */

#define REG_AES_KEY_C2_OFFSET                              0x600a8
#define REG_AES_KEY_C2_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_C2_OFFSET)
#define reg_AES_AES_KEY_C2                                 (*( REGType32v *) REG_AES_KEY_C2_ADDR)

/* AES_KEY_C3 */

#define REG_AES_KEY_C3_OFFSET                              0x600ac
#define REG_AES_KEY_C3_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_C3_OFFSET)
#define reg_AES_AES_KEY_C3                                 (*( REGType32v *) REG_AES_KEY_C3_ADDR)

/* AES_ID_C0 */

#define REG_AES_ID_C0_OFFSET                               0x600b0
#define REG_AES_ID_C0_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_C0_OFFSET)
#define reg_AES_AES_ID_C0                                  (*( REGType32v *) REG_AES_ID_C0_ADDR)

/* AES_ID_C1 */

#define REG_AES_ID_C1_OFFSET                               0x600b4
#define REG_AES_ID_C1_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_C1_OFFSET)
#define reg_AES_AES_ID_C1                                  (*( REGType32v *) REG_AES_ID_C1_ADDR)

/* AES_ID_C2 */

#define REG_AES_ID_C2_OFFSET                               0x600b8
#define REG_AES_ID_C2_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_C2_OFFSET)
#define reg_AES_AES_ID_C2                                  (*( REGType32v *) REG_AES_ID_C2_ADDR)

/* AES_ID_C3 */

#define REG_AES_ID_C3_OFFSET                               0x600bc
#define REG_AES_ID_C3_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_C3_OFFSET)
#define reg_AES_AES_ID_C3                                  (*( REGType32v *) REG_AES_ID_C3_ADDR)

/* AES_SEED_C0 */

#define REG_AES_SEED_C0_OFFSET                             0x600c0
#define REG_AES_SEED_C0_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_C0_OFFSET)
#define reg_AES_AES_SEED_C0                                (*( REGType32v *) REG_AES_SEED_C0_ADDR)

/* AES_SEED_C1 */

#define REG_AES_SEED_C1_OFFSET                             0x600c4
#define REG_AES_SEED_C1_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_C1_OFFSET)
#define reg_AES_AES_SEED_C1                                (*( REGType32v *) REG_AES_SEED_C1_ADDR)

/* AES_SEED_C2 */

#define REG_AES_SEED_C2_OFFSET                             0x600c8
#define REG_AES_SEED_C2_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_C2_OFFSET)
#define reg_AES_AES_SEED_C2                                (*( REGType32v *) REG_AES_SEED_C2_ADDR)

/* AES_SEED_C3 */

#define REG_AES_SEED_C3_OFFSET                             0x600cc
#define REG_AES_SEED_C3_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_C3_OFFSET)
#define reg_AES_AES_SEED_C3                                (*( REGType32v *) REG_AES_SEED_C3_ADDR)

/* AES_KEY_D0 */

#define REG_AES_KEY_D0_OFFSET                              0x600d0
#define REG_AES_KEY_D0_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_D0_OFFSET)
#define reg_AES_AES_KEY_D0                                 (*( REGType32v *) REG_AES_KEY_D0_ADDR)

/* AES_KEY_D1 */

#define REG_AES_KEY_D1_OFFSET                              0x600d4
#define REG_AES_KEY_D1_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_D1_OFFSET)
#define reg_AES_AES_KEY_D1                                 (*( REGType32v *) REG_AES_KEY_D1_ADDR)

/* AES_KEY_D2 */

#define REG_AES_KEY_D2_OFFSET                              0x600d8
#define REG_AES_KEY_D2_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_D2_OFFSET)
#define reg_AES_AES_KEY_D2                                 (*( REGType32v *) REG_AES_KEY_D2_ADDR)

/* AES_KEY_D3 */

#define REG_AES_KEY_D3_OFFSET                              0x600dc
#define REG_AES_KEY_D3_ADDR                                (HW_MG20IOP_REG + REG_AES_KEY_D3_OFFSET)
#define reg_AES_AES_KEY_D3                                 (*( REGType32v *) REG_AES_KEY_D3_ADDR)

/* AES_ID_D0 */

#define REG_AES_ID_D0_OFFSET                               0x600e0
#define REG_AES_ID_D0_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_D0_OFFSET)
#define reg_AES_AES_ID_D0                                  (*( REGType32v *) REG_AES_ID_D0_ADDR)

/* AES_ID_D1 */

#define REG_AES_ID_D1_OFFSET                               0x600e4
#define REG_AES_ID_D1_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_D1_OFFSET)
#define reg_AES_AES_ID_D1                                  (*( REGType32v *) REG_AES_ID_D1_ADDR)

/* AES_ID_D2 */

#define REG_AES_ID_D2_OFFSET                               0x600e8
#define REG_AES_ID_D2_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_D2_OFFSET)
#define reg_AES_AES_ID_D2                                  (*( REGType32v *) REG_AES_ID_D2_ADDR)

/* AES_ID_D3 */

#define REG_AES_ID_D3_OFFSET                               0x600ec
#define REG_AES_ID_D3_ADDR                                 (HW_MG20IOP_REG + REG_AES_ID_D3_OFFSET)
#define reg_AES_AES_ID_D3                                  (*( REGType32v *) REG_AES_ID_D3_ADDR)

/* AES_SEED_D0 */

#define REG_AES_SEED_D0_OFFSET                             0x600f0
#define REG_AES_SEED_D0_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_D0_OFFSET)
#define reg_AES_AES_SEED_D0                                (*( REGType32v *) REG_AES_SEED_D0_ADDR)

/* AES_SEED_D1 */

#define REG_AES_SEED_D1_OFFSET                             0x600f4
#define REG_AES_SEED_D1_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_D1_OFFSET)
#define reg_AES_AES_SEED_D1                                (*( REGType32v *) REG_AES_SEED_D1_ADDR)

/* AES_SEED_D2 */

#define REG_AES_SEED_D2_OFFSET                             0x600f8
#define REG_AES_SEED_D2_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_D2_OFFSET)
#define reg_AES_AES_SEED_D2                                (*( REGType32v *) REG_AES_SEED_D2_ADDR)

/* AES_SEED_D3 */

#define REG_AES_SEED_D3_OFFSET                             0x600fc
#define REG_AES_SEED_D3_ADDR                               (HW_MG20IOP_REG + REG_AES_SEED_D3_OFFSET)
#define reg_AES_AES_SEED_D3                                (*( REGType32v *) REG_AES_SEED_D3_ADDR)

/* AES_KEY_E */

#define REG_AES_KEY_E_OFFSET                               0x60100
#define REG_AES_KEY_E_ADDR                                 (HW_MG20IOP_REG + REG_AES_KEY_E_OFFSET)
#define reg_AES_AES_KEY_E                                  (*( REGType32v *) REG_AES_KEY_E_ADDR)

/* AES_ID_E */

#define REG_AES_ID_E_OFFSET                                0x60104
#define REG_AES_ID_E_ADDR                                  (HW_MG20IOP_REG + REG_AES_ID_E_OFFSET)
#define reg_AES_AES_ID_E                                   (*( REGType32v *) REG_AES_ID_E_ADDR)

/* AES_SEED_E */

#define REG_AES_SEED_E_OFFSET                              0x60108
#define REG_AES_SEED_E_ADDR                                (HW_MG20IOP_REG + REG_AES_SEED_E_OFFSET)
...
#define REG_AES_AES_CNT_MODE_SHIFT                         28
#define REG_AES_AES_CNT_MODE_SIZE                          2
#define REG_AES_AES_CNT_MODE_MASK                          0x30000000

#define REG_AES_AES_CNT_BUSSEL_SHIFT                       26
#define REG_AES_AES_CNT_BUSSEL_SIZE                        2
#define REG_AES_AES_CNT_BUSSEL_MASK                        0x0c000000

#define REG_AES_AES_CNT_KEYBUSY_SHIFT                      25
#define REG_AES_AES_CNT_KEYBUSY_SIZE                       1
#define REG_AES_AES_CNT_KEYBUSY_MASK                       0x02000000

#define REG_AES_AES_CNT_KEYSET_SHIFT                       24
#define REG_AES_AES_CNT_KEYSET_SIZE                        1
#define REG_AES_AES_CNT_KEYSET_MASK                        0x01000000

#define REG_AES_AES_CNT_WSFT_SHIFT                         23
#define REG_AES_AES_CNT_WSFT_SIZE                          1
#define REG_AES_AES_CNT_WSFT_MASK                          0x00800000

#define REG_AES_AES_CNT_RSFT_SHIFT                         22
#define REG_AES_AES_CNT_RSFT_SIZE                          1
#define REG_AES_AES_CNT_RSFT_MASK                          0x00400000
...
#ifndef SDK_ASM
#define REG_AES_AES_CNT_FIELD( e, i, mode, bussel, keybusy, keyset, wsft, rsft, wend, rend, ccm_dec, valid, msel, ade, mac_len, ofifo_dreq, ififo_dreq, fifo_clr, ofifo_clr, ififo_clr, ofifo_cnt, ififo_cnt ) \
    (u32)( \
    ((u32)(e) << REG_AES_AES_CNT_E_SHIFT) | \
    ((u32)(i) << REG_AES_AES_CNT_I_SHIFT) | \
    ((u32)(mode) << REG_AES_AES_CNT_MODE_SHIFT) | \
    ((u32)(bussel) << REG_AES_AES_CNT_BUSSEL_SHIFT) | \
    ((u32)(keybusy) << REG_AES_AES_CNT_KEYBUSY_SHIFT) | \
...
/* NN_HW_CTR_MG20_ARM9_IOREG_MG20PATCH_AES_H_ */
#endif
