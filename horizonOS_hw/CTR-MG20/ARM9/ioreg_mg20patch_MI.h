/*---------------------------------------------------------------------------*
  ...
  File:     nn/hw/CTR-MG20/ARM9/ioreg_mg20patch_MI.h
...
//
#ifndef NN_HW_CTR_MG20_ARM9_IOREG_MG20PATCH_MI_H_
#define NN_HW_CTR_MG20_ARM9_IOREG_MG20PATCH_MI_H_
...
#define REG_NDMAGCNT_OFFSET                                0x20000
#define REG_NDMAGCNT_ADDR                                  (HW_MG20IOP_REG + REG_NDMAGCNT_OFFSET)
#define reg_MI_NDMAGCNT                                    (*( REGType32v *) REG_NDMAGCNT_ADDR)

/* NDMA0SAD */

#define REG_NDMA0SAD_OFFSET                                0x20004
#define REG_NDMA0SAD_ADDR                                  (HW_MG20IOP_REG + REG_NDMA0SAD_OFFSET)
#define reg_MI_NDMA0SAD                                    (*( REGType32v *) REG_NDMA0SAD_ADDR)

/* NDMA0DAD */

#define REG_NDMA0DAD_OFFSET                                0x20008
#define REG_NDMA0DAD_ADDR                                  (HW_MG20IOP_REG + REG_NDMA0DAD_OFFSET)
#define reg_MI_NDMA0DAD                                    (*( REGType32v *) REG_NDMA0DAD_ADDR)

/* NDMA0TCNT */

#define REG_NDMA0TCNT_OFFSET                               0x2000c
#define REG_NDMA0TCNT_ADDR                                 (HW_MG20IOP_REG + REG_NDMA0TCNT_OFFSET)
#define reg_MI_NDMA0TCNT                                   (*( REGType32v *) REG_NDMA0TCNT_ADDR)

/* NDMA0WCNT */

#define REG_NDMA0WCNT_OFFSET                               0x20010
#define REG_NDMA0WCNT_ADDR                                 (HW_MG20IOP_REG + REG_NDMA0WCNT_OFFSET)
#define reg_MI_NDMA0WCNT                                   (*( REGType32v *) REG_NDMA0WCNT_ADDR)

/* NDMA0BCNT */

#define REG_NDMA0BCNT_OFFSET                               0x20014
#define REG_NDMA0BCNT_ADDR                                 (HW_MG20IOP_REG + REG_NDMA0BCNT_OFFSET)
#define reg_MI_NDMA0BCNT                                   (*( REGType32v *) REG_NDMA0BCNT_ADDR)

/* NDMA0FDATA */

#define REG_NDMA0FDATA_OFFSET                              0x20018
#define REG_NDMA0FDATA_ADDR                                (HW_MG20IOP_REG + REG_NDMA0FDATA_OFFSET)
#define reg_MI_NDMA0FDATA                                  (*( REGType32v *) REG_NDMA0FDATA_ADDR)

/* NDMA0CNT */

#define REG_NDMA0CNT_OFFSET                                0x2001c
#define REG_NDMA0CNT_ADDR                                  (HW_MG20IOP_REG + REG_NDMA0CNT_OFFSET)
#define reg_MI_NDMA0CNT                                    (*( REGType32v *) REG_NDMA0CNT_ADDR)

/* NDMA1SAD */

#define REG_NDMA1SAD_OFFSET                                0x20020
#define REG_NDMA1SAD_ADDR                                  (HW_MG20IOP_REG + REG_NDMA1SAD_OFFSET)
#define reg_MI_NDMA1SAD                                    (*( REGType32v *) REG_NDMA1SAD_ADDR)

/* NDMA1DAD */

#define REG_NDMA1DAD_OFFSET                                0x20024
#define REG_NDMA1DAD_ADDR                                  (HW_MG20IOP_REG + REG_NDMA1DAD_OFFSET)
#define reg_MI_NDMA1DAD                                    (*( REGType32v *) REG_NDMA1DAD_ADDR)

/* NDMA1TCNT */

#define REG_NDMA1TCNT_OFFSET                               0x20028
#define REG_NDMA1TCNT_ADDR                                 (HW_MG20IOP_REG + REG_NDMA1TCNT_OFFSET)
#define reg_MI_NDMA1TCNT                                   (*( REGType32v *) REG_NDMA1TCNT_ADDR)

/* NDMA1WCNT */

#define REG_NDMA1WCNT_OFFSET                               0x2002c
#define REG_NDMA1WCNT_ADDR                                 (HW_MG20IOP_REG + REG_NDMA1WCNT_OFFSET)
#define reg_MI_NDMA1WCNT                                   (*( REGType32v *) REG_NDMA1WCNT_ADDR)

/* NDMA1BCNT */

#define REG_NDMA1BCNT_OFFSET                               0x20030
#define REG_NDMA1BCNT_ADDR                                 (HW_MG20IOP_REG + REG_NDMA1BCNT_OFFSET)
#define reg_MI_NDMA1BCNT                                   (*( REGType32v *) REG_NDMA1BCNT_ADDR)

/* NDMA1FDATA */

#define REG_NDMA1FDATA_OFFSET                              0x20034
#define REG_NDMA1FDATA_ADDR                                (HW_MG20IOP_REG + REG_NDMA1FDATA_OFFSET)
#define reg_MI_NDMA1FDATA                                  (*( REGType32v *) REG_NDMA1FDATA_ADDR)

/* NDMA1CNT */

#define REG_NDMA1CNT_OFFSET                                0x20038
#define REG_NDMA1CNT_ADDR                                  (HW_MG20IOP_REG + REG_NDMA1CNT_OFFSET)
#define reg_MI_NDMA1CNT                                    (*( REGType32v *) REG_NDMA1CNT_ADDR)

/* XDMA_DS */

#define REG_XDMA_DS_OFFSET                                 0xc000
#define REG_XDMA_DS_ADDR                                   (HW_MG20IOP_REG + REG_XDMA_DS_OFFSET)
#define reg_MI_XDMA_DS                                     (*(const REGType32v *) REG_XDMA_DS_ADDR)

/* XDMA_DPC */

#define REG_XDMA_DPC_OFFSET                                0xc004
#define REG_XDMA_DPC_ADDR                                  (HW_MG20IOP_REG + REG_XDMA_DPC_OFFSET)
#define reg_MI_XDMA_DPC                                    (*(const REGType32v *) REG_XDMA_DPC_ADDR)

/* XDMA_IE */

#define REG_XDMA_IE_OFFSET                                 0xc020
#define REG_XDMA_IE_ADDR                                   (HW_MG20IOP_REG + REG_XDMA_IE_OFFSET)
#define reg_MI_XDMA_IE                                     (*( REGType32v *) REG_XDMA_IE_ADDR)

/* XDMA_ES */

#define REG_XDMA_ES_OFFSET                                 0xc024
#define REG_XDMA_ES_ADDR                                   (HW_MG20IOP_REG + REG_XDMA_ES_OFFSET)
#define reg_MI_XDMA_ES                                     (*(const REGType32v *) REG_XDMA_ES_ADDR)

/* XDMA_ISTAT */

#define REG_XDMA_ISTAT_OFFSET                              0xc028
#define REG_XDMA_ISTAT_ADDR                                (HW_MG20IOP_REG + REG_XDMA_ISTAT_OFFSET)
#define reg_MI_XDMA_ISTAT                                  (*(const REGType32v *) REG_XDMA_ISTAT_ADDR)

/* XDMA_ICLR */

#define REG_XDMA_ICLR_OFFSET                               0xc02c
#define REG_XDMA_ICLR_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_ICLR_OFFSET)
#define reg_MI_XDMA_ICLR                                   (*( REGType32v *) REG_XDMA_ICLR_ADDR)

/* XDMA_FSM */

#define REG_XDMA_FSM_OFFSET                                0xc030
#define REG_XDMA_FSM_ADDR                                  (HW_MG20IOP_REG + REG_XDMA_FSM_OFFSET)
#define reg_MI_XDMA_FSM                                    (*(const REGType32v *) REG_XDMA_FSM_ADDR)

/* XDMA_FSC */

#define REG_XDMA_FSC_OFFSET                                0xc034
#define REG_XDMA_FSC_ADDR                                  (HW_MG20IOP_REG + REG_XDMA_FSC_OFFSET)
#define reg_MI_XDMA_FSC                                    (*(const REGType32v *) REG_XDMA_FSC_ADDR)

/* XDMA_FTM */

#define REG_XDMA_FTM_OFFSET                                0xc038
#define REG_XDMA_FTM_ADDR                                  (HW_MG20IOP_REG + REG_XDMA_FTM_OFFSET)
#define reg_MI_XDMA_FTM                                    (*(const REGType32v *) REG_XDMA_FTM_ADDR)

/* XDMA_FTC0 */

#define REG_XDMA_FTC0_OFFSET                               0xc040
#define REG_XDMA_FTC0_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_FTC0_OFFSET)
#define reg_MI_XDMA_FTC0                                   (*(const REGType32v *) REG_XDMA_FTC0_ADDR)

/* XDMA_FTC1 */

#define REG_XDMA_FTC1_OFFSET                               0xc044
#define REG_XDMA_FTC1_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_FTC1_OFFSET)
#define reg_MI_XDMA_FTC1                                   (*(const REGType32v *) REG_XDMA_FTC1_ADDR)

/* XDMA_CS0 */

#define REG_XDMA_CS0_OFFSET                                0xc100
#define REG_XDMA_CS0_ADDR                                  (HW_MG20IOP_REG + REG_XDMA_CS0_OFFSET)
#define reg_MI_XDMA_CS0                                    (*(const REGType32v *) REG_XDMA_CS0_ADDR)

/* XDMA_CPC0 */

#define REG_XDMA_CPC0_OFFSET                               0xc104
#define REG_XDMA_CPC0_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_CPC0_OFFSET)
#define reg_MI_XDMA_CPC0                                   (*(const REGType32v *) REG_XDMA_CPC0_ADDR)

/* XDMA_CS1 */

#define REG_XDMA_CS1_OFFSET                                0xc108
#define REG_XDMA_CS1_ADDR                                  (HW_MG20IOP_REG + REG_XDMA_CS1_OFFSET)
#define reg_MI_XDMA_CS1                                    (*(const REGType32v *) REG_XDMA_CS1_ADDR)

/* XDMA_CPC1 */

#define REG_XDMA_CPC1_OFFSET                               0xc10c
#define REG_XDMA_CPC1_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_CPC1_OFFSET)
#define reg_MI_XDMA_CPC1                                   (*(const REGType32v *) REG_XDMA_CPC1_ADDR)

/* XDMA_SA0 */

#define REG_XDMA_SA0_OFFSET                                0xc400
#define REG_XDMA_SA0_ADDR                                  (HW_MG20IOP_REG + REG_XDMA_SA0_OFFSET)
#define reg_MI_XDMA_SA0                                    (*(const REGType32v *) REG_XDMA_SA0_ADDR)

/* XDMA_DA0 */

#define REG_XDMA_DA0_OFFSET                                0xc404
#define REG_XDMA_DA0_ADDR                                  (HW_MG20IOP_REG + REG_XDMA_DA0_OFFSET)
#define reg_MI_XDMA_DA0                                    (*(const REGType32v *) REG_XDMA_DA0_ADDR)

/* XDMA_CC0 */

#define REG_XDMA_CC0_OFFSET                                0xc408
#define REG_XDMA_CC0_ADDR                                  (HW_MG20IOP_REG + REG_XDMA_CC0_OFFSET)
#define reg_MI_XDMA_CC0                                    (*(const REGType32v *) REG_XDMA_CC0_ADDR)

/* XDMA_LC00 */

#define REG_XDMA_LC00_OFFSET                               0xc40c
#define REG_XDMA_LC00_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_LC00_OFFSET)
#define reg_MI_XDMA_LC00                                   (*(const REGType32v *) REG_XDMA_LC00_ADDR)

/* XDMA_LC10 */

#define REG_XDMA_LC10_OFFSET                               0xc410
#define REG_XDMA_LC10_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_LC10_OFFSET)
#define reg_MI_XDMA_LC10                                   (*(const REGType32v *) REG_XDMA_LC10_ADDR)

/* XDMA_SA1 */

#define REG_XDMA_SA1_OFFSET                                0xc420
#define REG_XDMA_SA1_ADDR                                  (HW_MG20IOP_REG + REG_XDMA_SA1_OFFSET)
#define reg_MI_XDMA_SA1                                    (*(const REGType32v *) REG_XDMA_SA1_ADDR)

/* XDMA_DA1 */

#define REG_XDMA_DA1_OFFSET                                0xc424
#define REG_XDMA_DA1_ADDR                                  (HW_MG20IOP_REG + REG_XDMA_DA1_OFFSET)
#define reg_MI_XDMA_DA1                                    (*(const REGType32v *) REG_XDMA_DA1_ADDR)

/* XDMA_CC1 */

#define REG_XDMA_CC1_OFFSET                                0xc428
#define REG_XDMA_CC1_ADDR                                  (HW_MG20IOP_REG + REG_XDMA_CC1_OFFSET)
#define reg_MI_XDMA_CC1                                    (*(const REGType32v *) REG_XDMA_CC1_ADDR)

/* XDMA_LC01 */

#define REG_XDMA_LC01_OFFSET                               0xc42c
#define REG_XDMA_LC01_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_LC01_OFFSET)
#define reg_MI_XDMA_LC01                                   (*(const REGType32v *) REG_XDMA_LC01_ADDR)

/* XDMA_LC11 */

#define REG_XDMA_LC11_OFFSET                               0xc430
#define REG_XDMA_LC11_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_LC11_OFFSET)
#define reg_MI_XDMA_LC11                                   (*(const REGType32v *) REG_XDMA_LC11_ADDR)

/* XDMA_DBGSTAT */

#define REG_XDMA_DBGSTAT_OFFSET                            0xcd00
#define REG_XDMA_DBGSTAT_ADDR                              (HW_MG20IOP_REG + REG_XDMA_DBGSTAT_OFFSET)
#define reg_MI_XDMA_DBGSTAT                                (*(const REGType32v *) REG_XDMA_DBGSTAT_ADDR)

/* XDMA_DBGCMD */

#define REG_XDMA_DBGCMD_OFFSET                             0xcd04
#define REG_XDMA_DBGCMD_ADDR                               (HW_MG20IOP_REG + REG_XDMA_DBGCMD_OFFSET)
#define reg_MI_XDMA_DBGCMD                                 (*( REGType32v *) REG_XDMA_DBGCMD_ADDR)

/* XDMA_DBGINST0 */

#define REG_XDMA_DBGINST0_OFFSET                           0xcd08
#define REG_XDMA_DBGINST0_ADDR                             (HW_MG20IOP_REG + REG_XDMA_DBGINST0_OFFSET)
#define reg_MI_XDMA_DBGINST0                               (*( REGType32v *) REG_XDMA_DBGINST0_ADDR)

/* XDMA_DBGINST1 */

#define REG_XDMA_DBGINST1_OFFSET                           0xcd0c
#define REG_XDMA_DBGINST1_ADDR                             (HW_MG20IOP_REG + REG_XDMA_DBGINST1_OFFSET)
#define reg_MI_XDMA_DBGINST1                               (*( REGType32v *) REG_XDMA_DBGINST1_ADDR)

/* XDMA_CFG0 */

#define REG_XDMA_CFG0_OFFSET                               0xce00
#define REG_XDMA_CFG0_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_CFG0_OFFSET)
#define reg_MI_XDMA_CFG0                                   (*(const REGType32v *) REG_XDMA_CFG0_ADDR)

/* XDMA_CFG1 */

#define REG_XDMA_CFG1_OFFSET                               0xce04
#define REG_XDMA_CFG1_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_CFG1_OFFSET)
#define reg_MI_XDMA_CFG1                                   (*(const REGType32v *) REG_XDMA_CFG1_ADDR)

/* XDMA_CFG2 */

#define REG_XDMA_CFG2_OFFSET                               0xce08
#define REG_XDMA_CFG2_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_CFG2_OFFSET)
#define reg_MI_XDMA_CFG2                                   (*(const REGType32v *) REG_XDMA_CFG2_ADDR)

/* XDMA_CFG3 */

#define REG_XDMA_CFG3_OFFSET                               0xce0c
#define REG_XDMA_CFG3_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_CFG3_OFFSET)
#define reg_MI_XDMA_CFG3                                   (*(const REGType32v *) REG_XDMA_CFG3_ADDR)

/* XDMA_CFG4 */

#define REG_XDMA_CFG4_OFFSET                               0xce10
#define REG_XDMA_CFG4_ADDR                                 (HW_MG20IOP_REG + REG_XDMA_CFG4_OFFSET)
#define reg_MI_XDMA_CFG4                                   (*(const REGType32v *) REG_XDMA_CFG4_ADDR)

/* XDMA_CFGDN */

#define REG_XDMA_CFGDN_OFFSET                              0xce14
#define REG_XDMA_CFGDN_ADDR                                (HW_MG20IOP_REG + REG_XDMA_CFGDN_OFFSET)
#define reg_MI_XDMA_CFGDN                                  (*(const REGType32v *) REG_XDMA_CFGDN_ADDR)

/* MCMCNT */

#define REG_MCMCNT_OFFSET                                  0x90000
#define REG_MCMCNT_ADDR                                    (HW_MG20IOP_REG + REG_MCMCNT_OFFSET)
#define reg_MI_MCMCNT                                      (*( REGType16v *) REG_MCMCNT_ADDR)

/* MCCNT0 */

#define REG_MCCNT0_OFFSET                                  0x90050
#define REG_MCCNT0_ADDR                                    (HW_MG20IOP_REG + REG_MCCNT0_OFFSET)
#define reg_MI_MCCNT0                                      (*( REGType16v *) REG_MCCNT0_ADDR)

/* MCD0 */

#define REG_MCD0_OFFSET                                    0x90052
#define REG_MCD0_ADDR                                      (HW_MG20IOP_REG + REG_MCD0_OFFSET)
#define reg_MI_MCD0                                        (*( REGType16v *) REG_MCD0_ADDR)

/* MCCNT1 */

#define REG_MCCNT1_OFFSET                                  0x90054
#define REG_MCCNT1_ADDR                                    (HW_MG20IOP_REG + REG_MCCNT1_OFFSET)
#define reg_MI_MCCNT1                                      (*( REGType32v *) REG_MCCNT1_ADDR)

/* MCCMD0 */

#define REG_MCCMD0_OFFSET                                  0x90058
#define REG_MCCMD0_ADDR                                    (HW_MG20IOP_REG + REG_MCCMD0_OFFSET)
#define reg_MI_MCCMD0                                      (*( REGType32v *) REG_MCCMD0_ADDR)

/* MCCMD1 */

#define REG_MCCMD1_OFFSET                                  0x9005c
#define REG_MCCMD1_ADDR                                    (HW_MG20IOP_REG + REG_MCCMD1_OFFSET)
#define reg_MI_MCCMD1                                      (*( REGType32v *) REG_MCCMD1_ADDR)

/* MCSCRA_L */

#define REG_MCSCRA_L_OFFSET                                0x90060
#define REG_MCSCRA_L_ADDR                                  (HW_MG20IOP_REG + REG_MCSCRA_L_OFFSET)
#define reg_MI_MCSCRA_L                                    (*( REGType32v *) REG_MCSCRA_L_ADDR)

/* MCSCRB_L */

#define REG_MCSCRB_L_OFFSET                                0x90064
#define REG_MCSCRB_L_ADDR                                  (HW_MG20IOP_REG + REG_MCSCRB_L_OFFSET)
#define reg_MI_MCSCRB_L                                    (*( REGType32v *) REG_MCSCRB_L_ADDR)

/* MCSCRA_H */

#define REG_MCSCRA_H_OFFSET                                0x90068
#define REG_MCSCRA_H_ADDR                                  (HW_MG20IOP_REG + REG_MCSCRA_H_OFFSET)
#define reg_MI_MCSCRA_H                                    (*( REGType8v *) REG_MCSCRA_H_ADDR)

/* MCSCRB_H */

#define REG_MCSCRB_H_OFFSET                                0x9006a
#define REG_MCSCRB_H_ADDR                                  (HW_MG20IOP_REG + REG_MCSCRB_H_OFFSET)
#define reg_MI_MCSCRB_H                                    (*( REGType8v *) REG_MCSCRB_H_ADDR)

/* MCD1 */

#define REG_MCD1_OFFSET                                    0x90070
#define REG_MCD1_ADDR                                      (HW_MG20IOP_REG + REG_MCD1_OFFSET)
...
#define REG_MI_MCMCNT_E_SHIFT                              15
#define REG_MI_MCMCNT_E_SIZE                               1
#define REG_MI_MCMCNT_E_MASK                               0x8000

#define REG_MI_MCMCNT_I_SHIFT                              14
#define REG_MI_MCMCNT_I_SIZE                               1
#define REG_MI_MCMCNT_I_MASK                               0x4000

#define REG_MI_MCMCNT_SEL_SHIFT                            13
#define REG_MI_MCMCNT_SEL_SIZE                             1
#define REG_MI_MCMCNT_SEL_MASK                             0x2000

#define REG_MI_MCMCNT_DTC_SHIFT                            12
#define REG_MI_MCMCNT_DTC_SIZE                             1
#define REG_MI_MCMCNT_DTC_MASK                             0x1000

#define REG_MI_MCMCNT_MCI_SHIFT                            11
#define REG_MI_MCMCNT_MCI_SIZE                             1
#define REG_MI_MCMCNT_MCI_MASK                             0x0800

#define REG_MI_MCMCNT_MSEL_SHIFT                           10
#define REG_MI_MCMCNT_MSEL_SIZE                            1
#define REG_MI_MCMCNT_MSEL_MASK                            0x0400

#define REG_MI_MCMCNT_BUSY_SHIFT                           7
#define REG_MI_MCMCNT_BUSY_SIZE                            1
#define REG_MI_MCMCNT_BUSY_MASK                            0x0080

#define REG_MI_MCMCNT_MODE_SHIFT                           6
#define REG_MI_MCMCNT_MODE_SIZE                            1
#define REG_MI_MCMCNT_MODE_MASK                            0x0040

#define REG_MI_MCMCNT_BAUDRATE_SHIFT                       0
#define REG_MI_MCMCNT_BAUDRATE_SIZE                        3
#define REG_MI_MCMCNT_BAUDRATE_MASK                        0x0007

#ifndef SDK_ASM
#define REG_MI_MCMCNT_FIELD( e, i, sel, dtc, mci, msel, busy, mode, baudrate ) \
    (u16)( \
    ((u32)(e) << REG_MI_MCMCNT_E_SHIFT) | \
    ((u32)(i) << REG_MI_MCMCNT_I_SHIFT) | \
    ((u32)(sel) << REG_MI_MCMCNT_SEL_SHIFT) | \
    ((u32)(dtc) << REG_MI_MCMCNT_DTC_SHIFT) | \
    ((u32)(mci) << REG_MI_MCMCNT_MCI_SHIFT) | \
    ((u32)(msel) << REG_MI_MCMCNT_MSEL_SHIFT) | \
    ((u32)(busy) << REG_MI_MCMCNT_BUSY_SHIFT) | \
    ((u32)(mode) << REG_MI_MCMCNT_MODE_SHIFT) | \
    ((u32)(baudrate) << REG_MI_MCMCNT_BAUDRATE_SHIFT))
#endif
...
/* NN_HW_CTR_MG20_ARM9_IOREG_MG20PATCH_MI_H_ */
#endif
