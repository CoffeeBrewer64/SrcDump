/*---------------------------------------------------------------------------*
  ...
  File:     nn/hw/CTR-MG20/ARM9/ioreg_mg20patch_SND.h
...
//
#ifndef NN_HW_CTR_MG20_ARM9_IOREG_MG20PATCH_SND_H_
#define NN_HW_CTR_MG20_ARM9_IOREG_MG20PATCH_SND_H_
...
#define REG_SNDCNT_OFFSET                                  0x40000
#define REG_SNDCNT_ADDR                                    (HW_MG20IOP_REG + REG_SNDCNT_OFFSET)
#define reg_SND_SNDCNT                                     (*( REGType32v *) REG_SNDCNT_ADDR)

/* SOUND0CNT */

#define REG_SOUND0CNT_OFFSET                               0x40400
#define REG_SOUND0CNT_ADDR                                 (HW_MG20IOP_REG + REG_SOUND0CNT_OFFSET)
#define reg_SND_SOUND0CNT                                  (*( REGType32v *) REG_SOUND0CNT_ADDR)

/* SOUND0CNT_VOL_16 */

#define REG_SOUND0CNT_VOL_16_OFFSET                        0x40400
#define REG_SOUND0CNT_VOL_16_ADDR                          (HW_MG20IOP_REG + REG_SOUND0CNT_VOL_16_OFFSET)
#define reg_SND_SOUND0CNT_VOL_16                           (*( REGType16v *) REG_SOUND0CNT_VOL_16_ADDR)

/* SOUND0CNT_VOL */

#define REG_SOUND0CNT_VOL_OFFSET                           0x40400
#define REG_SOUND0CNT_VOL_ADDR                             (HW_MG20IOP_REG + REG_SOUND0CNT_VOL_OFFSET)
#define reg_SND_SOUND0CNT_VOL                              (*( REGType8v *) REG_SOUND0CNT_VOL_ADDR)

/* SOUND0CNT_PAN */

#define REG_SOUND0CNT_PAN_OFFSET                           0x40402
#define REG_SOUND0CNT_PAN_ADDR                             (HW_MG20IOP_REG + REG_SOUND0CNT_PAN_OFFSET)
#define reg_SND_SOUND0CNT_PAN                              (*( REGType8v *) REG_SOUND0CNT_PAN_ADDR)

/* SOUND0CNT_8 */

#define REG_SOUND0CNT_8_OFFSET                             0x40403
#define REG_SOUND0CNT_8_ADDR                               (HW_MG20IOP_REG + REG_SOUND0CNT_8_OFFSET)
#define reg_SND_SOUND0CNT_8                                (*( REGType8v *) REG_SOUND0CNT_8_ADDR)

/* SOUND0SAD */

#define REG_SOUND0SAD_OFFSET                               0x40404
#define REG_SOUND0SAD_ADDR                                 (HW_MG20IOP_REG + REG_SOUND0SAD_OFFSET)
#define reg_SND_SOUND0SAD                                  (*( REGType32v *) REG_SOUND0SAD_ADDR)

/* SOUND0TMR */

#define REG_SOUND0TMR_OFFSET                               0x40408
#define REG_SOUND0TMR_ADDR                                 (HW_MG20IOP_REG + REG_SOUND0TMR_OFFSET)
#define reg_SND_SOUND0TMR                                  (*( REGType16v *) REG_SOUND0TMR_ADDR)

/* SOUND0RPT_PT */

#define REG_SOUND0RPT_PT_OFFSET                            0x4040a
#define REG_SOUND0RPT_PT_ADDR                              (HW_MG20IOP_REG + REG_SOUND0RPT_PT_OFFSET)
#define reg_SND_SOUND0RPT_PT                               (*( REGType16v *) REG_SOUND0RPT_PT_ADDR)

/* SOUND0RPT_LEN */

#define REG_SOUND0RPT_LEN_OFFSET                           0x4040c
#define REG_SOUND0RPT_LEN_ADDR                             (HW_MG20IOP_REG + REG_SOUND0RPT_LEN_OFFSET)
#define reg_SND_SOUND0RPT_LEN                              (*( REGType32v *) REG_SOUND0RPT_LEN_ADDR)

/* SOUNDCNT */

#define REG_SOUNDCNT_OFFSET                                0x40500
#define REG_SOUNDCNT_ADDR                                  (HW_MG20IOP_REG + REG_SOUNDCNT_OFFSET)
#define reg_SND_SOUNDCNT                                   (*( REGType16v *) REG_SOUNDCNT_ADDR)

/* SOUNDCNT_8 */

#define REG_SOUNDCNT_8_OFFSET                              0x40501
#define REG_SOUNDCNT_8_ADDR                                (HW_MG20IOP_REG + REG_SOUNDCNT_8_OFFSET)
#define reg_SND_SOUNDCNT_8                                 (*( REGType8v *) REG_SOUNDCNT_8_ADDR)

/* SOUNDCNT_VOL */

#define REG_SOUNDCNT_VOL_OFFSET                            0x40500
#define REG_SOUNDCNT_VOL_ADDR                              (HW_MG20IOP_REG + REG_SOUNDCNT_VOL_OFFSET)
#define reg_SND_SOUNDCNT_VOL                               (*( REGType8v *) REG_SOUNDCNT_VOL_ADDR)

/* SNDCAPCNT */

#define REG_SNDCAPCNT_OFFSET                               0x40508
#define REG_SNDCAPCNT_ADDR                                 (HW_MG20IOP_REG + REG_SNDCAPCNT_OFFSET)
#define reg_SND_SNDCAPCNT                                  (*( REGType16v *) REG_SNDCAPCNT_ADDR)

/* SNDCAP0CNT */

#define REG_SNDCAP0CNT_OFFSET                              0x40508
#define REG_SNDCAP0CNT_ADDR                                (HW_MG20IOP_REG + REG_SNDCAP0CNT_OFFSET)
#define reg_SND_SNDCAP0CNT                                 (*( REGType8v *) REG_SNDCAP0CNT_ADDR)

/* SNDCAP1CNT */

#define REG_SNDCAP1CNT_OFFSET                              0x40509
#define REG_SNDCAP1CNT_ADDR                                (HW_MG20IOP_REG + REG_SNDCAP1CNT_OFFSET)
#define reg_SND_SNDCAP1CNT                                 (*( REGType8v *) REG_SNDCAP1CNT_ADDR)

/* SNDCAP0DAD */

#define REG_SNDCAP0DAD_OFFSET                              0x40510
#define REG_SNDCAP0DAD_ADDR                                (HW_MG20IOP_REG + REG_SNDCAP0DAD_OFFSET)
#define reg_SND_SNDCAP0DAD                                 (*( REGType32v *) REG_SNDCAP0DAD_ADDR)

/* SNDCAP0LEN */

#define REG_SNDCAP0LEN_OFFSET                              0x40514
#define REG_SNDCAP0LEN_ADDR                                (HW_MG20IOP_REG + REG_SNDCAP0LEN_OFFSET)
#define reg_SND_SNDCAP0LEN                                 (*( REGType16v *) REG_SNDCAP0LEN_ADDR)

/* SNDCAP1DAD */

#define REG_SNDCAP1DAD_OFFSET                              0x40518
#define REG_SNDCAP1DAD_ADDR                                (HW_MG20IOP_REG + REG_SNDCAP1DAD_OFFSET)
#define reg_SND_SNDCAP1DAD                                 (*( REGType32v *) REG_SNDCAP1DAD_ADDR)

/* SNDCAP1LEN */

#define REG_SNDCAP1LEN_OFFSET                              0x4051c
#define REG_SNDCAP1LEN_ADDR                                (HW_MG20IOP_REG + REG_SNDCAP1LEN_OFFSET)
...
#define REG_SND_SNDCNT_I2S_E_SHIFT                         31
#define REG_SND_SNDCNT_I2S_E_SIZE                          1
#define REG_SND_SNDCNT_I2S_E_MASK                          0x80000000

#define REG_SND_SNDCNT_I2S_MUTE_SHIFT                      20
#define REG_SND_SNDCNT_I2S_MUTE_SIZE                       1
#define REG_SND_SNDCNT_I2S_MUTE_MASK                       0x00100000

#define REG_SND_SNDCNT_I2S_MIX_RATE_SHIFT                  16
#define REG_SND_SNDCNT_I2S_MIX_RATE_SIZE                   4
#define REG_SND_SNDCNT_I2S_MIX_RATE_MASK                   0x000f0000

#define REG_SND_SNDCNT_PWM_E_SHIFT                         15
#define REG_SND_SNDCNT_PWM_E_SIZE                          1
#define REG_SND_SNDCNT_PWM_E_MASK                          0x00008000

#define REG_SND_SNDCNT_PWM_MIX_RATE_SHIFT                  10
#define REG_SND_SNDCNT_PWM_MIX_RATE_SIZE                   4
#define REG_SND_SNDCNT_PWM_MIX_RATE_MASK                   0x00003c00

#define REG_SND_SNDCNT_PWM_BIAS_LEVEL_SHIFT                0
#define REG_SND_SNDCNT_PWM_BIAS_LEVEL_SIZE                 10
#define REG_SND_SNDCNT_PWM_BIAS_LEVEL_MASK                 0x000003ff

#ifndef SDK_ASM
#define REG_SND_SNDCNT_FIELD( i2s_e, i2s_mute, i2s_mix_rate, pwm_e, pwm_mix_rate, pwm_bias_level ) \
    (u32)( \
    ((u32)(i2s_e) << REG_SND_SNDCNT_I2S_E_SHIFT) | \
    ((u32)(i2s_mute) << REG_SND_SNDCNT_I2S_MUTE_SHIFT) | \
    ((u32)(i2s_mix_rate) << REG_SND_SNDCNT_I2S_MIX_RATE_SHIFT) | \
    ((u32)(pwm_e) << REG_SND_SNDCNT_PWM_E_SHIFT) | \
    ((u32)(pwm_mix_rate) << REG_SND_SNDCNT_PWM_MIX_RATE_SHIFT) | \
    ((u32)(pwm_bias_level) << REG_SND_SNDCNT_PWM_BIAS_LEVEL_SHIFT))
#endif
...
#define REG_SND_SOUND0SAD_SRC_SIZE                         32
#define REG_SND_SOUND0SAD_SRC_MASK                         0xffffffff
...
#define REG_SND_SNDCAP1DAD_DEST_SIZE                       32
#define REG_SND_SNDCAP1DAD_DEST_MASK                       0xffffffff
...
/* NN_HW_CTR_MG20_ARM9_IOREG_MG20PATCH_SND_H_ */
#endif
