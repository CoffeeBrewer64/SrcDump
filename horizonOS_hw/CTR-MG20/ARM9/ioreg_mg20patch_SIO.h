/*---------------------------------------------------------------------------*
  ...
  File:     nn/hw/CTR-MG20/ARM9/ioreg_mg20patch_SIO.h
...
//
#ifndef NN_HW_CTR_MG20_ARM9_IOREG_MG20PATCH_SIO_H_
#define NN_HW_CTR_MG20_ARM9_IOREG_MG20PATCH_SIO_H_
...
#define REG_SPI1CNT_OFFSET                                 0xf0000
#define REG_SPI1CNT_ADDR                                   (HW_MG20IOP_REG + REG_SPI1CNT_OFFSET)
#define reg_SIO_SPI1CNT                                    (*( REGType16v *) REG_SPI1CNT_ADDR)

/* SPI1D */

#define REG_SPI1D_OFFSET                                   0xf0002
#define REG_SPI1D_ADDR                                     (HW_MG20IOP_REG + REG_SPI1D_OFFSET)
#define reg_SIO_SPI1D                                      (*( REGType8v *) REG_SPI1D_ADDR)

/* SPI2CNT */

#define REG_SPI2CNT_OFFSET                                 0xf0010
#define REG_SPI2CNT_ADDR                                   (HW_MG20IOP_REG + REG_SPI2CNT_OFFSET)
#define reg_SIO_SPI2CNT                                    (*( REGType16v *) REG_SPI2CNT_ADDR)

/* SPI2D */

#define REG_SPI2D_OFFSET                                   0xf0012
#define REG_SPI2D_ADDR                                     (HW_MG20IOP_REG + REG_SPI2D_OFFSET)
#define reg_SIO_SPI2D                                      (*( REGType8v *) REG_SPI2D_ADDR)

/* SPI3CNT */

#define REG_SPI3CNT_OFFSET                                 0xf0020
#define REG_SPI3CNT_ADDR                                   (HW_MG20IOP_REG + REG_SPI3CNT_OFFSET)
#define reg_SIO_SPI3CNT                                    (*( REGType16v *) REG_SPI3CNT_ADDR)

/* SPI3D */

#define REG_SPI3D_OFFSET                                   0xf0022
#define REG_SPI3D_ADDR                                     (HW_MG20IOP_REG + REG_SPI3D_OFFSET)
#define reg_SIO_SPI3D                                      (*( REGType8v *) REG_SPI3D_ADDR)

/* I2C1_DAT */

#define REG_I2C1_DAT_OFFSET                                0x100000
#define REG_I2C1_DAT_ADDR                                  (HW_MG20IOP_REG + REG_I2C1_DAT_OFFSET)
#define reg_SIO_I2C1_DAT                                   (*( REGType8v *) REG_I2C1_DAT_ADDR)

/* I2C1_CNT */

#define REG_I2C1_CNT_OFFSET                                0x100001
#define REG_I2C1_CNT_ADDR                                  (HW_MG20IOP_REG + REG_I2C1_CNT_OFFSET)
#define reg_SIO_I2C1_CNT                                   (*( REGType8v *) REG_I2C1_CNT_ADDR)

/* I2C1_CNT_EX */

#define REG_I2C1_CNT_EX_OFFSET                             0x100002
#define REG_I2C1_CNT_EX_ADDR                               (HW_MG20IOP_REG + REG_I2C1_CNT_EX_OFFSET)
#define reg_SIO_I2C1_CNT_EX                                (*( REGType16v *) REG_I2C1_CNT_EX_ADDR)

/* I2C1_SCL */

#define REG_I2C1_SCL_OFFSET                                0x100004
#define REG_I2C1_SCL_ADDR                                  (HW_MG20IOP_REG + REG_I2C1_SCL_OFFSET)
#define reg_SIO_I2C1_SCL                                   (*( REGType16v *) REG_I2C1_SCL_ADDR)

/* I2C2_DAT */

#define REG_I2C2_DAT_OFFSET                                0x100010
#define REG_I2C2_DAT_ADDR                                  (HW_MG20IOP_REG + REG_I2C2_DAT_OFFSET)
#define reg_SIO_I2C2_DAT                                   (*( REGType8v *) REG_I2C2_DAT_ADDR)

/* I2C2_CNT */

#define REG_I2C2_CNT_OFFSET                                0x100011
#define REG_I2C2_CNT_ADDR                                  (HW_MG20IOP_REG + REG_I2C2_CNT_OFFSET)
#define reg_SIO_I2C2_CNT                                   (*( REGType8v *) REG_I2C2_CNT_ADDR)

/* I2C2_CNT_EX */

#define REG_I2C2_CNT_EX_OFFSET                             0x100012
#define REG_I2C2_CNT_EX_ADDR                               (HW_MG20IOP_REG + REG_I2C2_CNT_EX_OFFSET)
#define reg_SIO_I2C2_CNT_EX                                (*( REGType16v *) REG_I2C2_CNT_EX_ADDR)

/* I2C2_SCL */

#define REG_I2C2_SCL_OFFSET                                0x100014
#define REG_I2C2_SCL_ADDR                                  (HW_MG20IOP_REG + REG_I2C2_SCL_OFFSET)
...
/* NN_HW_CTR_MG20_ARM9_IOREG_MG20PATCH_SIO_H_ */
#endif
