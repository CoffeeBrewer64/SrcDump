/*---------------------------------------------------------------------------*
  ...
  File:     nn/hw/CTR-TS/ARM9/ioreg_tspatch_RSA.h
...
//
#ifndef NN_HW_CTR_TS_ARM9_IOREG_TSPATCH_RSA_H_
#define NN_HW_CTR_TS_ARM9_IOREG_TSPATCH_RSA_H_
...
#define REG_RSA_RSA_CNT_WSWAP_SHIFT                        9
#define REG_RSA_RSA_CNT_WSWAP_SIZE                         1
#define REG_RSA_RSA_CNT_WSWAP_MASK                         0x00000200

#define REG_RSA_RSA_CNT_BSWAP_SHIFT                        8
#define REG_RSA_RSA_CNT_BSWAP_SIZE                         1
#define REG_RSA_RSA_CNT_BSWAP_MASK                         0x00000100
...
#ifndef SDK_ASM
#define REG_RSA_RSA_CNT_FIELD( wswap, bswap, keysel, i, start ) \
    (u32)( \
    ((u32)(wswap) << REG_RSA_RSA_CNT_WSWAP_SHIFT) | \
    ((u32)(bswap) << REG_RSA_RSA_CNT_BSWAP_SHIFT) | \
...
/* NN_HW_CTR_TS_ARM9_IOREG_TSPATCH_RSA_H_ */
#endif
