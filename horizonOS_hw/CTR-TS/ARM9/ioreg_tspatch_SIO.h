/*---------------------------------------------------------------------------*
  ...
  File:     nn/hw/CTR-TS/ARM9/ioreg_tspatch_SIO.h
...
//
#ifndef NN_HW_CTR_TS_ARM9_IOREG_TSPATCH_SIO_H_
#define NN_HW_CTR_TS_ARM9_IOREG_TSPATCH_SIO_H_
...
#define REG_SPI1CNT0_OFFSET                                0x160800
#define REG_SPI1CNT0_ADDR                                  (HW_REG_BASE + REG_SPI1CNT0_OFFSET)
#define reg_SIO_SPI1CNT0                                   (*( REGType16v *) REG_SPI1CNT0_ADDR)

/* SPI2CNT0 */

#define REG_SPI2CNT0_OFFSET                                0x142800
#define REG_SPI2CNT0_ADDR                                  (HW_REG_BASE + REG_SPI2CNT0_OFFSET)
#define reg_SIO_SPI2CNT0                                   (*( REGType16v *) REG_SPI2CNT0_ADDR)

/* SPI3CNT0 */

#define REG_SPI3CNT0_OFFSET                                0x143800
#define REG_SPI3CNT0_ADDR                                  (HW_REG_BASE + REG_SPI3CNT0_OFFSET)
#define reg_SIO_SPI3CNT0                                   (*( REGType16v *) REG_SPI3CNT0_ADDR)

/* NSPI_CNT */

#define REG_NSPI_CNT_OFFSET                                0x00d800
#define REG_NSPI_CNT_ADDR                                  (HW_REG_BASE + REG_NSPI_CNT_OFFSET)
#define reg_SIO_NSPI_CNT                                   (*( REGType32v *) REG_NSPI_CNT_ADDR)

/* NSPI_CS */

#define REG_NSPI_CS_OFFSET                                 0x00d804
#define REG_NSPI_CS_ADDR                                   (HW_REG_BASE + REG_NSPI_CS_OFFSET)
#define reg_SIO_NSPI_CS                                    (*( REGType32v *) REG_NSPI_CS_ADDR)

/* NSPI_LEN */

#define REG_NSPI_LEN_OFFSET                                0x00d808
#define REG_NSPI_LEN_ADDR                                  (HW_REG_BASE + REG_NSPI_LEN_OFFSET)
#define reg_SIO_NSPI_LEN                                   (*( REGType32v *) REG_NSPI_LEN_ADDR)

/* NSPI_DT */

#define REG_NSPI_DT_OFFSET                                 0x00d80c
#define REG_NSPI_DT_ADDR                                   (HW_REG_BASE + REG_NSPI_DT_OFFSET)
#define reg_SIO_NSPI_DT                                    (*( REGType32v *) REG_NSPI_DT_ADDR)

/* NSPI_DS */

#define REG_NSPI_DS_OFFSET                                 0x00d810
#define REG_NSPI_DS_ADDR                                   (HW_REG_BASE + REG_NSPI_DS_OFFSET)
#define reg_SIO_NSPI_DS                                    (*(const REGType32v *) REG_NSPI_DS_ADDR)

/* NSPI_AP */

#define REG_NSPI_AP_OFFSET                                 0x00d814
#define REG_NSPI_AP_ADDR                                   (HW_REG_BASE + REG_NSPI_AP_OFFSET)
#define reg_SIO_NSPI_AP                                    (*( REGType32v *) REG_NSPI_AP_ADDR)

/* NSPI_MASK */

#define REG_NSPI_MASK_OFFSET                               0x00d818
#define REG_NSPI_MASK_ADDR                                 (HW_REG_BASE + REG_NSPI_MASK_OFFSET)
#define reg_SIO_NSPI_MASK                                  (*( REGType32v *) REG_NSPI_MASK_ADDR)

/* NSPI_INTRS */

#define REG_NSPI_INTRS_OFFSET                              0x00d81c
#define REG_NSPI_INTRS_ADDR                                (HW_REG_BASE + REG_NSPI_INTRS_OFFSET)
#define reg_SIO_NSPI_INTRS                                 (*( REGType32v *) REG_NSPI_INTRS_ADDR)
...
#define REG_SIO_SPI1CNT0_E_SHIFT                           15
#define REG_SIO_SPI1CNT0_E_SIZE                            1
#define REG_SIO_SPI1CNT0_E_MASK                            0x8000

#define REG_SIO_SPI1CNT0_I_SHIFT                           14
#define REG_SIO_SPI1CNT0_I_SIZE                            1
#define REG_SIO_SPI1CNT0_I_MASK                            0x4000

#define REG_SIO_SPI1CNT0_MODE_SHIFT                        11
#define REG_SIO_SPI1CNT0_MODE_SIZE                         1
#define REG_SIO_SPI1CNT0_MODE_MASK                         0x0800

#define REG_SIO_SPI1CNT0_CLKMODE_SHIFT                     10
#define REG_SIO_SPI1CNT0_CLKMODE_SIZE                      1
#define REG_SIO_SPI1CNT0_CLKMODE_MASK                      0x0400

#define REG_SIO_SPI1CNT0_SEL_SHIFT                         8
#define REG_SIO_SPI1CNT0_SEL_SIZE                          2
#define REG_SIO_SPI1CNT0_SEL_MASK                          0x0300

#define REG_SIO_SPI1CNT0_BUSY_SHIFT                        7
#define REG_SIO_SPI1CNT0_BUSY_SIZE                         1
#define REG_SIO_SPI1CNT0_BUSY_MASK                         0x0080

#define REG_SIO_SPI1CNT0_BAUDRATE_SHIFT                    0
#define REG_SIO_SPI1CNT0_BAUDRATE_SIZE                     3
#define REG_SIO_SPI1CNT0_BAUDRATE_MASK                     0x0007

#ifndef SDK_ASM
#define REG_SIO_SPI1CNT0_FIELD( e, i, mode, clkmode, sel, busy, baudrate ) \
    (u16)( \
    ((u32)(e) << REG_SIO_SPI1CNT0_E_SHIFT) | \
    ((u32)(i) << REG_SIO_SPI1CNT0_I_SHIFT) | \
    ((u32)(mode) << REG_SIO_SPI1CNT0_MODE_SHIFT) | \
    ((u32)(clkmode) << REG_SIO_SPI1CNT0_CLKMODE_SHIFT) | \
    ((u32)(sel) << REG_SIO_SPI1CNT0_SEL_SHIFT) | \
    ((u32)(busy) << REG_SIO_SPI1CNT0_BUSY_SHIFT) | \
    ((u32)(baudrate) << REG_SIO_SPI1CNT0_BAUDRATE_SHIFT))
#endif


/* SPI2CNT0 */

#define REG_SIO_SPI2CNT0_E_SHIFT                           15
#define REG_SIO_SPI2CNT0_E_SIZE                            1
#define REG_SIO_SPI2CNT0_E_MASK                            0x8000

#define REG_SIO_SPI2CNT0_I_SHIFT                           14
#define REG_SIO_SPI2CNT0_I_SIZE                            1
#define REG_SIO_SPI2CNT0_I_MASK                            0x4000

#define REG_SIO_SPI2CNT0_MODE_SHIFT                        11
#define REG_SIO_SPI2CNT0_MODE_SIZE                         1
#define REG_SIO_SPI2CNT0_MODE_MASK                         0x0800

#define REG_SIO_SPI2CNT0_CLKMODE_SHIFT                     10
#define REG_SIO_SPI2CNT0_CLKMODE_SIZE                      1
#define REG_SIO_SPI2CNT0_CLKMODE_MASK                      0x0400

#define REG_SIO_SPI2CNT0_SEL_SHIFT                         8
#define REG_SIO_SPI2CNT0_SEL_SIZE                          2
#define REG_SIO_SPI2CNT0_SEL_MASK                          0x0300

#define REG_SIO_SPI2CNT0_BUSY_SHIFT                        7
#define REG_SIO_SPI2CNT0_BUSY_SIZE                         1
#define REG_SIO_SPI2CNT0_BUSY_MASK                         0x0080

#define REG_SIO_SPI2CNT0_BAUDRATE_SHIFT                    0
#define REG_SIO_SPI2CNT0_BAUDRATE_SIZE                     3
#define REG_SIO_SPI2CNT0_BAUDRATE_MASK                     0x0007

#ifndef SDK_ASM
#define REG_SIO_SPI2CNT0_FIELD( e, i, mode, clkmode, sel, busy, baudrate ) \
    (u16)( \
    ((u32)(e) << REG_SIO_SPI2CNT0_E_SHIFT) | \
    ((u32)(i) << REG_SIO_SPI2CNT0_I_SHIFT) | \
    ((u32)(mode) << REG_SIO_SPI2CNT0_MODE_SHIFT) | \
    ((u32)(clkmode) << REG_SIO_SPI2CNT0_CLKMODE_SHIFT) | \
    ((u32)(sel) << REG_SIO_SPI2CNT0_SEL_SHIFT) | \
    ((u32)(busy) << REG_SIO_SPI2CNT0_BUSY_SHIFT) | \
    ((u32)(baudrate) << REG_SIO_SPI2CNT0_BAUDRATE_SHIFT))
#endif


/* SPI3CNT0 */

#define REG_SIO_SPI3CNT0_E_SHIFT                           15
#define REG_SIO_SPI3CNT0_E_SIZE                            1
#define REG_SIO_SPI3CNT0_E_MASK                            0x8000

#define REG_SIO_SPI3CNT0_I_SHIFT                           14
#define REG_SIO_SPI3CNT0_I_SIZE                            1
#define REG_SIO_SPI3CNT0_I_MASK                            0x4000

#define REG_SIO_SPI3CNT0_MODE_SHIFT                        11
#define REG_SIO_SPI3CNT0_MODE_SIZE                         1
#define REG_SIO_SPI3CNT0_MODE_MASK                         0x0800

#define REG_SIO_SPI3CNT0_CLKMODE_SHIFT                     10
#define REG_SIO_SPI3CNT0_CLKMODE_SIZE                      1
#define REG_SIO_SPI3CNT0_CLKMODE_MASK                      0x0400

#define REG_SIO_SPI3CNT0_BUSY_SHIFT                        7
#define REG_SIO_SPI3CNT0_BUSY_SIZE                         1
#define REG_SIO_SPI3CNT0_BUSY_MASK                         0x0080

#define REG_SIO_SPI3CNT0_BAUDRATE_SHIFT                    0
#define REG_SIO_SPI3CNT0_BAUDRATE_SIZE                     3
#define REG_SIO_SPI3CNT0_BAUDRATE_MASK                     0x0007

#ifndef SDK_ASM
#define REG_SIO_SPI3CNT0_FIELD( e, i, mode, clkmode, busy, baudrate ) \
    (u16)( \
    ((u32)(e) << REG_SIO_SPI3CNT0_E_SHIFT) | \
    ((u32)(i) << REG_SIO_SPI3CNT0_I_SHIFT) | \
    ((u32)(mode) << REG_SIO_SPI3CNT0_MODE_SHIFT) | \
    ((u32)(clkmode) << REG_SIO_SPI3CNT0_CLKMODE_SHIFT) | \
    ((u32)(busy) << REG_SIO_SPI3CNT0_BUSY_SHIFT) | \
    ((u32)(baudrate) << REG_SIO_SPI3CNT0_BAUDRATE_SHIFT))
#endif


/* NSPI_CNT */

#define REG_SIO_NSPI_CNT_E_SHIFT                           15
#define REG_SIO_NSPI_CNT_E_SIZE                            1
#define REG_SIO_NSPI_CNT_E_MASK                            0x00008000

#define REG_SIO_NSPI_CNT_STREAM_SHIFT                      13
#define REG_SIO_NSPI_CNT_STREAM_SIZE                       1
#define REG_SIO_NSPI_CNT_STREAM_MASK                       0x00002000

#define REG_SIO_NSPI_CNT_MODE_SHIFT                        12
#define REG_SIO_NSPI_CNT_MODE_SIZE                         1
#define REG_SIO_NSPI_CNT_MODE_MASK                         0x00001000

#define REG_SIO_NSPI_CNT_SEL_SHIFT                         6
#define REG_SIO_NSPI_CNT_SEL_SIZE                          2
#define REG_SIO_NSPI_CNT_SEL_MASK                          0x000000c0

#define REG_SIO_NSPI_CNT_BAUDRATE_SHIFT                    0
#define REG_SIO_NSPI_CNT_BAUDRATE_SIZE                     3
#define REG_SIO_NSPI_CNT_BAUDRATE_MASK                     0x00000007

#ifndef SDK_ASM
#define REG_SIO_NSPI_CNT_FIELD( e, stream, mode, sel, baudrate ) \
    (u32)( \
    ((u32)(e) << REG_SIO_NSPI_CNT_E_SHIFT) | \
    ((u32)(stream) << REG_SIO_NSPI_CNT_STREAM_SHIFT) | \
    ((u32)(mode) << REG_SIO_NSPI_CNT_MODE_SHIFT) | \
    ((u32)(sel) << REG_SIO_NSPI_CNT_SEL_SHIFT) | \
    ((u32)(baudrate) << REG_SIO_NSPI_CNT_BAUDRATE_SHIFT))
#endif


/* NSPI_CS */

#define REG_SIO_NSPI_CS_CSB_SHIFT                          0
#define REG_SIO_NSPI_CS_CSB_SIZE                           1
#define REG_SIO_NSPI_CS_CSB_MASK                           0x00000001

#ifndef SDK_ASM
#define REG_SIO_NSPI_CS_FIELD( csb ) \
    (u32)( \
    ((u32)(csb) << REG_SIO_NSPI_CS_CSB_SHIFT))
#endif


/* NSPI_LEN */

#define REG_SIO_NSPI_LEN_LEN_SHIFT                         0
#define REG_SIO_NSPI_LEN_LEN_SIZE                          21
#define REG_SIO_NSPI_LEN_LEN_MASK                          0x001fffff

#ifndef SDK_ASM
#define REG_SIO_NSPI_LEN_FIELD( len ) \
    (u32)( \
    ((u32)(len) << REG_SIO_NSPI_LEN_LEN_SHIFT))
#endif


/* NSPI_DT */

#define REG_SIO_NSPI_DT_DATA_SHIFT                         0
#define REG_SIO_NSPI_DT_DATA_SIZE                          32
#define REG_SIO_NSPI_DT_DATA_MASK                          0xffffffff

#ifndef SDK_ASM
#define REG_SIO_NSPI_DT_FIELD( data ) \
    (u32)( \
    ((u32)(data) << REG_SIO_NSPI_DT_DATA_SHIFT))
#endif


/* NSPI_DS */

#define REG_SIO_NSPI_DS_DBUSY_SHIFT                        0
#define REG_SIO_NSPI_DS_DBUSY_SIZE                         1
#define REG_SIO_NSPI_DS_DBUSY_MASK                         0x00000001

#ifndef SDK_ASM
#define REG_SIO_NSPI_DS_FIELD( dbusy ) \
    (u32)( \
    ((u32)(dbusy) << REG_SIO_NSPI_DS_DBUSY_SHIFT))
#endif


/* NSPI_AP */

#define REG_SIO_NSPI_AP_CMD_SHIFT                          0
#define REG_SIO_NSPI_AP_CMD_SIZE                           8
#define REG_SIO_NSPI_AP_CMD_MASK                           0x000000ff

#define REG_SIO_NSPI_AP_TIME_OUT_SHIFT                     16
#define REG_SIO_NSPI_AP_TIME_OUT_SIZE                      4
#define REG_SIO_NSPI_AP_TIME_OUT_MASK                      0x000f0000

#define REG_SIO_NSPI_AP_RBFLAG_POS_SHIFT                   24
#define REG_SIO_NSPI_AP_RBFLAG_POS_SIZE                    3
#define REG_SIO_NSPI_AP_RBFLAG_POS_MASK                    0x07000000

#define REG_SIO_NSPI_AP_SET_RBL_SHIFT                      30
#define REG_SIO_NSPI_AP_SET_RBL_SIZE                       1
#define REG_SIO_NSPI_AP_SET_RBL_MASK                       0x40000000

#define REG_SIO_NSPI_AP_E_SHIFT                            31
#define REG_SIO_NSPI_AP_E_SIZE                             1
#define REG_SIO_NSPI_AP_E_MASK                             0x80000000

#ifndef SDK_ASM
#define REG_SIO_NSPI_AP_FIELD( cmd, time_out, rbflag_pos, set_rbl, e ) \
    (u32)( \
    ((u32)(cmd) << REG_SIO_NSPI_AP_CMD_SHIFT) | \
    ((u32)(time_out) << REG_SIO_NSPI_AP_TIME_OUT_SHIFT) | \
    ((u32)(rbflag_pos) << REG_SIO_NSPI_AP_RBFLAG_POS_SHIFT) | \
    ((u32)(set_rbl) << REG_SIO_NSPI_AP_SET_RBL_SHIFT) | \
    ((u32)(e) << REG_SIO_NSPI_AP_E_SHIFT))
#endif


/* NSPI_MASK */

#define REG_SIO_NSPI_MASK_INTR_SHIFT                       0
#define REG_SIO_NSPI_MASK_INTR_SIZE                        3
#define REG_SIO_NSPI_MASK_INTR_MASK                        0x00000007

#define REG_SIO_NSPI_MASK_DREQ_SHIFT                       3
#define REG_SIO_NSPI_MASK_DREQ_SIZE                        1
#define REG_SIO_NSPI_MASK_DREQ_MASK                        0x00000008

#ifndef SDK_ASM
#define REG_SIO_NSPI_MASK_FIELD( intr, dreq ) \
    (u32)( \
    ((u32)(intr) << REG_SIO_NSPI_MASK_INTR_SHIFT) | \
    ((u32)(dreq) << REG_SIO_NSPI_MASK_DREQ_SHIFT))
#endif


/* NSPI_INTRS */

#define REG_SIO_NSPI_INTRS_CAUSE_SHIFT                     0
#define REG_SIO_NSPI_INTRS_CAUSE_SIZE                      3
#define REG_SIO_NSPI_INTRS_CAUSE_MASK                      0x00000007

#ifndef SDK_ASM
#define REG_SIO_NSPI_INTRS_FIELD( cause ) \
    (u32)( \
    ((u32)(cause) << REG_SIO_NSPI_INTRS_CAUSE_SHIFT))
#endif
...
/* NN_HW_CTR_TS_ARM9_IOREG_TSPATCH_SIO_H_ */
#endif
