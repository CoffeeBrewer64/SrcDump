/*---------------------------------------------------------------------------*
  ...
  File:     nn/hw/CTR-TEG2/MPCore/ioreg_PAD.h
...
//
#ifndef NN_HW_CTR_TEG2_MPCORE_IOREG_PAD_H_
#define NN_HW_CTR_TEG2_MPCORE_IOREG_PAD_H_
...
#define REG_PAD_KEYINPUT_Y_SHIFT                           11
#define REG_PAD_KEYINPUT_Y_SIZE                            1
#define REG_PAD_KEYINPUT_Y_MASK                            0x0800

#define REG_PAD_KEYINPUT_X_SHIFT                           10
#define REG_PAD_KEYINPUT_X_SIZE                            1
#define REG_PAD_KEYINPUT_X_MASK                            0x0400
...
#ifndef SDK_ASM
#define REG_PAD_KEYINPUT_FIELD( y, x, l, r, down, up, left, right, start, sel, b, a ) \
    (u16)( \
...
#define REG_PAD_KEYCNT_X_MASK                              0x0800

#define REG_PAD_KEYCNT_Y_SHIFT                             10
#define REG_PAD_KEYCNT_Y_SIZE                              1
#define REG_PAD_KEYCNT_Y_MASK                              0x0400
...
#ifndef SDK_ASM
#define REG_PAD_KEYCNT_FIELD( logic, intr, x, y, l, r, down, up, left, right, start, sel, b, a ) \
    (u16)( \
...
/* NN_HW_CTR_TEG2_MPCORE_IOREG_PAD_H_ */
#endif
