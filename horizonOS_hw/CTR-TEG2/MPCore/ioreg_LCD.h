/*---------------------------------------------------------------------------*
  ...
  File:     nn/hw/CTR-TEG2/MPCore/ioreg_LCD.h
...
//
#ifndef NN_HW_CTR_TEG2_MPCORE_IOREG_LCD_H_
#define NN_HW_CTR_TEG2_MPCORE_IOREG_LCD_H_
...
#ifndef SDK_ASM
#define REG_LCD_LCDC_CNT0_FIELD( pwm_inv, pwm_auto, pwm_en ) \
    (u32)( \
...
#ifndef SDK_ASM
#define REG_LCD_LCDC_CNT2_FIELD( x2, mode, en ) \
    (u32)( \
...
#define REG_LCD_LCDC_CNT3_LVDS_SHIFT                       8
#define REG_LCD_LCDC_CNT3_LVDS_SIZE                        4
#define REG_LCD_LCDC_CNT3_LVDS_MASK                        0x00000f00
...
#ifndef SDK_ASM
#define REG_LCD_LCDC_CNT3_FIELD( fix2, lvds, fix1 ) \
    (u32)( \
    ((u32)(fix2) << REG_LCD_LCDC_CNT3_FIX2_SHIFT) | \
    ((u32)(lvds) << REG_LCD_LCDC_CNT3_LVDS_SHIFT) | \
...
/* NN_HW_CTR_TEG2_MPCORE_IOREG_LCD_H_ */
#endif
