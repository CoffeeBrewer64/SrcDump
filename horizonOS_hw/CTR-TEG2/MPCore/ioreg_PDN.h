/*---------------------------------------------------------------------------*
  ...
  File:     nn/hw/CTR-TEG2/MPCore/ioreg_PDN.h
...
//
#ifndef NN_HW_CTR_TEG2_MPCORE_IOREG_PDN_H_
#define NN_HW_CTR_TEG2_MPCORE_IOREG_PDN_H_
...
#define reg_PDN_CNT                                        (*( REGType8v *) REG_CNT_ADDR)
...
#define REG_PDN_CNT_SLP_MASK                               0x01

#ifndef SDK_ASM
#define REG_PDN_CNT_FIELD( slp ) \
    (u8)( \
...
#define REG_PDN_WE_LCD_RST_SHIFT                           27
#define REG_PDN_WE_LCD_RST_SIZE                            1
#define REG_PDN_WE_LCD_RST_MASK                            0x08000000
...
#define REG_PDN_WE_TWL_MCU_SHIFT                           5
#define REG_PDN_WE_TWL_MCU_SIZE                            1
#define REG_PDN_WE_TWL_MCU_MASK                            0x00000020
...
#define REG_PDN_WE_LGC_SHIFT                               2
#define REG_PDN_WE_LGC_SIZE                                1
#define REG_PDN_WE_LGC_MASK                                0x00000004

#define REG_PDN_WE_KEY_SHIFT                               1
#define REG_PDN_WE_KEY_SIZE                                1
#define REG_PDN_WE_KEY_MASK                                0x00000002

#define REG_PDN_WE_RTC_SHIFT                               0
#define REG_PDN_WE_RTC_SIZE                                1
#define REG_PDN_WE_RTC_MASK                                0x00000001

#ifndef SDK_ASM
#define REG_PDN_WE_FIELD( cgc, lcd_rst, ctr_mcu, rmc, wl_rst, sp_sel, gpio3_18_3, gpio3_18_2, gpio3_18_1, gpio3_18_0, gpio3_33_7, gpio3_33_6, gpio3_33_5, gpio3_33_4, gpio3_33_3, gpio3_33_2, gpio3_33_1, gpio3_33_0, sd3, sd2, sd1, twl_depop, twl_mcu, hp, cover, lgc, key, rtc ) \
    (u32)( \
    ((u32)(cgc) << REG_PDN_WE_CGC_SHIFT) | \
    ((u32)(lcd_rst) << REG_PDN_WE_LCD_RST_SHIFT) | \
    ...
    ((u32)(twl_mcu) << REG_PDN_WE_TWL_MCU_SHIFT) | \
    ((u32)(hp) << REG_PDN_WE_HP_SHIFT) | \
    ((u32)(cover) << REG_PDN_WE_COVER_SHIFT) | \
    ((u32)(lgc) << REG_PDN_WE_LGC_SHIFT) | \
    ((u32)(key) << REG_PDN_WE_KEY_SHIFT) | \
    ((u32)(rtc) << REG_PDN_WE_RTC_SHIFT))
#endif
...
#define REG_PDN_WRS_LCD_RST_SHIFT                          27
#define REG_PDN_WRS_LCD_RST_SIZE                           1
#define REG_PDN_WRS_LCD_RST_MASK                           0x08000000
...
#define REG_PDN_WRS_TWL_MCU_SHIFT                          5
#define REG_PDN_WRS_TWL_MCU_SIZE                           1
#define REG_PDN_WRS_TWL_MCU_MASK                           0x00000020
...
#define REG_PDN_WRS_LGC_SHIFT                              2
#define REG_PDN_WRS_LGC_SIZE                               1
#define REG_PDN_WRS_LGC_MASK                               0x00000004

#define REG_PDN_WRS_KEY_SHIFT                              1
#define REG_PDN_WRS_KEY_SIZE                               1
#define REG_PDN_WRS_KEY_MASK                               0x00000002

#define REG_PDN_WRS_RTC_SHIFT                              0
#define REG_PDN_WRS_RTC_SIZE                               1
#define REG_PDN_WRS_RTC_MASK                               0x00000001

#ifndef SDK_ASM
#define REG_PDN_WRS_FIELD( cgc, lcd_rst, ctr_mcu, rmc, wl_rst, sp_sel, gpio3_18_3, gpio3_18_2, gpio3_18_1, gpio3_18_0, gpio3_33_7, gpio3_33_6, gpio3_33_5, gpio3_33_4, gpio3_33_3, gpio3_33_2, gpio3_33_1, gpio3_33_0, sd3, sd2, sd1, twl_depop, twl_mcu, hp, cover, lgc, key, rtc ) \
    (u32)( \
    ((u32)(cgc) << REG_PDN_WRS_CGC_SHIFT) | \
    ((u32)(lcd_rst) << REG_PDN_WRS_LCD_RST_SHIFT) | \
    ...
    ((u32)(twl_mcu) << REG_PDN_WRS_TWL_MCU_SHIFT) | \
    ((u32)(hp) << REG_PDN_WRS_HP_SHIFT) | \
    ((u32)(cover) << REG_PDN_WRS_COVER_SHIFT) | \
    ((u32)(lgc) << REG_PDN_WRS_LGC_SHIFT) | \
    ((u32)(key) << REG_PDN_WRS_KEY_SHIFT) | \
    ((u32)(rtc) << REG_PDN_WRS_RTC_SHIFT))
#endif
...
/* NN_HW_CTR_TEG2_MPCORE_IOREG_PDN_H_ */
#endif
