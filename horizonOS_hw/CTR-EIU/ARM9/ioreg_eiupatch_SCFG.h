/*---------------------------------------------------------------------------*
  ...
  File:     nn/hw/CTR-EIU/ARM9/ioreg_eiupatch_SCFG.h
...
//
#ifndef NN_HW_CTR_EIU_ARM9_IOREG_EIUPATCH_SCFG_H_
#define NN_HW_CTR_EIU_ARM9_IOREG_EIUPATCH_SCFG_H_
...
#define reg_SCFG_GC                                        (*( REGType16v *) REG_GC_ADDR)
...
#define REG_SCFG_WRAM_OFFSET                               0x200
#define REG_SCFG_WRAM_ADDR                                 (HW_REG_BASE + REG_SCFG_WRAM_OFFSET)
#define reg_SCFG_SCFG_WRAM                                 (*( REGType8v *) REG_SCFG_WRAM_ADDR)
...
#define REG_TWL_OP_OFFSET                                  0x10014
#define REG_TWL_OP_ADDR                                    (HW_REG_BASE + REG_TWL_OP_OFFSET)
#define reg_SCFG_TWL_OP                                    (*( REGType8v *) REG_TWL_OP_ADDR)
...
#define REG_TWL_FUSE0_OFFSET                               0x12100
#define REG_TWL_FUSE0_ADDR                                 (HW_REG_BASE + REG_TWL_FUSE0_OFFSET)
#define reg_SCFG_TWL_FUSE0                                 (*( REGType32v *) REG_TWL_FUSE0_ADDR)
...
#define REG_SCFG_GC_MEDIA_SEL_MASK                         0x0100

#define REG_SCFG_GC_SPI_SEL_SHIFT                          4
#define REG_SCFG_GC_SPI_SEL_SIZE                           1
#define REG_SCFG_GC_SPI_SEL_MASK                           0x0010

#define REG_SCFG_GC_GC_SEL_SHIFT                           0
#define REG_SCFG_GC_GC_SEL_SIZE                            2
#define REG_SCFG_GC_GC_SEL_MASK                            0x0003
...
#define REG_SCFG_SCFG_WRAM_A9W1_SHIFT                      0
#define REG_SCFG_SCFG_WRAM_A9W1_SIZE                       1
#define REG_SCFG_SCFG_WRAM_A9W1_MASK                       0x01

#ifndef SDK_ASM
#define REG_SCFG_SCFG_WRAM_FIELD( a9w1 ) \
    (u8)( \
    ((u32)(a9w1) << REG_SCFG_SCFG_WRAM_A9W1_SHIFT))
#endif
...
#define REG_SCFG_TWL_OP_TYPE_SHIFT                         0
#define REG_SCFG_TWL_OP_TYPE_SIZE                          2
#define REG_SCFG_TWL_OP_TYPE_MASK                          0x03

#ifndef SDK_ASM
#define REG_SCFG_TWL_OP_FIELD( type ) \
    (u8)( \
    ((u32)(type) << REG_SCFG_TWL_OP_TYPE_SHIFT))
#endif
...
/* NN_HW_CTR_EIU_ARM9_IOREG_EIUPATCH_SCFG_H_ */
#endif
