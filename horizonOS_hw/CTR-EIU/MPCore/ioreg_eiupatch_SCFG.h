/*---------------------------------------------------------------------------*
  ...
  File:     nn/hw/CTR-EIU/MPCore/ioreg_eiupatch_SCFG.h
...
//
#ifndef NN_HW_CTR_EIU_MPCORE_IOREG_EIUPATCH_SCFG_H_
#define NN_HW_CTR_EIU_MPCORE_IOREG_EIUPATCH_SCFG_H_
...
#define reg_SCFG_ACS                                       (*( REGType16v *) REG_ACS_ADDR)

/* ACS_EIU */

#define REG_ACS_EIU_OFFSET                                 0x140140
#define REG_ACS_EIU_ADDR                                   (HW_REG_BASE + REG_ACS_EIU_OFFSET)
#define reg_SCFG_ACS_EIU                                   (*( REGType16v *) REG_ACS_EIU_ADDR)
...
#define REG_GPU_CTRL_OFFSET                                0x140400
#define REG_GPU_CTRL_ADDR                                  (HW_REG_BASE + REG_GPU_CTRL_OFFSET)
#define reg_SCFG_GPU_CTRL                                  (*( REGType8v *) REG_GPU_CTRL_ADDR)

/* DMAC */

#define REG_DMAC_OFFSET                                    0x140410
#define REG_DMAC_ADDR                                      (HW_REG_BASE + REG_DMAC_OFFSET)
#define reg_SCFG_DMAC                                      (*( REGType32v *) REG_DMAC_ADDR)

/* LAGER_BOOT_CNT */

#define REG_LAGER_BOOT_CNT_OFFSET                          0x140420
#define REG_LAGER_BOOT_CNT_ADDR                            (HW_REG_BASE + REG_LAGER_BOOT_CNT_OFFSET)
#define reg_SCFG_LAGER_BOOT_CNT                            (*( REGType8v *) REG_LAGER_BOOT_CNT_ADDR)

/* LAGER_BOOT_ADDR */

#define REG_LAGER_BOOT_ADDR_OFFSET                         0x140424
#define REG_LAGER_BOOT_ADDR_ADDR                           (HW_REG_BASE + REG_LAGER_BOOT_ADDR_OFFSET)
#define reg_SCFG_LAGER_BOOT_ADDR                           (*( REGType32v *) REG_LAGER_BOOT_ADDR_ADDR)

/* LAGER_CPU_CNT */

#define REG_LAGER_CPU_CNT_OFFSET                           0x140428
#define REG_LAGER_CPU_CNT_ADDR                             (HW_REG_BASE + REG_LAGER_CPU_CNT_OFFSET)
#define reg_SCFG_LAGER_CPU_CNT                             (*( REGType8v *) REG_LAGER_CPU_CNT_ADDR)
...
#define REG_SCFG_FIQ_MSK3_SHIFT                            3
#define REG_SCFG_FIQ_MSK3_SIZE                             1
#define REG_SCFG_FIQ_MSK3_MASK                             0x08

#define REG_SCFG_FIQ_MSK2_SHIFT                            2
#define REG_SCFG_FIQ_MSK2_SIZE                             1
#define REG_SCFG_FIQ_MSK2_MASK                             0x04
...
#ifndef SDK_ASM
#define REG_SCFG_FIQ_FIELD( msk3, msk2, msk1, msk0 ) \
    (u8)( \
    ((u32)(msk3) << REG_SCFG_FIQ_MSK3_SHIFT) | \
    ((u32)(msk2) << REG_SCFG_FIQ_MSK2_SHIFT) | \
...
#define REG_SCFG_DBGREQ_MSK3_SHIFT                         3
#define REG_SCFG_DBGREQ_MSK3_SIZE                          1
#define REG_SCFG_DBGREQ_MSK3_MASK                          0x08

#define REG_SCFG_DBGREQ_MSK2_SHIFT                         2
#define REG_SCFG_DBGREQ_MSK2_SIZE                          1
#define REG_SCFG_DBGREQ_MSK2_MASK                          0x04
...
#ifndef SDK_ASM
#define REG_SCFG_DBGREQ_FIELD( msk3, msk2, msk1, msk0 ) \
    (u8)( \
    ((u32)(msk3) << REG_SCFG_DBGREQ_MSK3_SHIFT) | \
    ((u32)(msk2) << REG_SCFG_DBGREQ_MSK2_SHIFT) | \
...
#define REG_SCFG_ACS_W_MASK                                0x0100

#define REG_SCFG_ACS_FCRAM_SHIFT                           0
#define REG_SCFG_ACS_FCRAM_SIZE                            4
#define REG_SCFG_ACS_FCRAM_MASK                            0x000f
...
#define REG_SCFG_ACS_EIU_WRAMEX2_SHIFT                     10
#define REG_SCFG_ACS_EIU_WRAMEX2_SIZE                      1
#define REG_SCFG_ACS_EIU_WRAMEX2_MASK                      0x0400

#define REG_SCFG_ACS_EIU_WRAMEX1_SHIFT                     9
#define REG_SCFG_ACS_EIU_WRAMEX1_SIZE                      1
#define REG_SCFG_ACS_EIU_WRAMEX1_MASK                      0x0200

#define REG_SCFG_ACS_EIU_W_SHIFT                           8
#define REG_SCFG_ACS_EIU_W_SIZE                            1
#define REG_SCFG_ACS_EIU_W_MASK                            0x0100

#define REG_SCFG_ACS_EIU_FCRAMEX_SHIFT                     4
#define REG_SCFG_ACS_EIU_FCRAMEX_SIZE                      4
#define REG_SCFG_ACS_EIU_FCRAMEX_MASK                      0x00f0

#define REG_SCFG_ACS_EIU_FCRAM_SHIFT                       0
#define REG_SCFG_ACS_EIU_FCRAM_SIZE                        4
#define REG_SCFG_ACS_EIU_FCRAM_MASK                        0x000f

#ifndef SDK_ASM
#define REG_SCFG_ACS_EIU_FIELD( wramex2, wramex1, w, fcramex, fcram ) \
    (u16)( \
    ((u32)(wramex2) << REG_SCFG_ACS_EIU_WRAMEX2_SHIFT) | \
    ((u32)(wramex1) << REG_SCFG_ACS_EIU_WRAMEX1_SHIFT) | \
    ((u32)(w) << REG_SCFG_ACS_EIU_W_SHIFT) | \
    ((u32)(fcramex) << REG_SCFG_ACS_EIU_FCRAMEX_SHIFT) | \
    ((u32)(fcram) << REG_SCFG_ACS_EIU_FCRAM_SHIFT))
#endif
...
#define REG_SCFG_GPU_CTRL_BUG_FIX_SHIFT                    1
#define REG_SCFG_GPU_CTRL_BUG_FIX_SIZE                     1
#define REG_SCFG_GPU_CTRL_BUG_FIX_MASK                     0x02

#define REG_SCFG_GPU_CTRL_GPU_MODE_SHIFT                   0
#define REG_SCFG_GPU_CTRL_GPU_MODE_SIZE                    1
#define REG_SCFG_GPU_CTRL_GPU_MODE_MASK                    0x01

#ifndef SDK_ASM
#define REG_SCFG_GPU_CTRL_FIELD( bug_fix, gpu_mode ) \
    (u8)( \
    ((u32)(bug_fix) << REG_SCFG_GPU_CTRL_BUG_FIX_SHIFT) | \
    ((u32)(gpu_mode) << REG_SCFG_GPU_CTRL_GPU_MODE_SHIFT))
#endif


/* DMAC */

#define REG_SCFG_DMAC_DREQ_SEL_SHIFT                       0
#define REG_SCFG_DMAC_DREQ_SEL_SIZE                        18
#define REG_SCFG_DMAC_DREQ_SEL_MASK                        0x0003ffff

#ifndef SDK_ASM
#define REG_SCFG_DMAC_FIELD( dreq_sel ) \
    (u32)( \
    ((u32)(dreq_sel) << REG_SCFG_DMAC_DREQ_SEL_SHIFT))
#endif


/* LAGER_BOOT_CNT */

#define REG_SCFG_LAGER_BOOT_CNT_EN_SHIFT                   0
#define REG_SCFG_LAGER_BOOT_CNT_EN_SIZE                    1
#define REG_SCFG_LAGER_BOOT_CNT_EN_MASK                    0x01

#ifndef SDK_ASM
#define REG_SCFG_LAGER_BOOT_CNT_FIELD( en ) \
    (u8)( \
    ((u32)(en) << REG_SCFG_LAGER_BOOT_CNT_EN_SHIFT))
#endif
...
#define REG_SCFG_LAGER_CPU_CNT_MST1_EN_SHIFT               0
#define REG_SCFG_LAGER_CPU_CNT_MST1_EN_SIZE                1
#define REG_SCFG_LAGER_CPU_CNT_MST1_EN_MASK                0x01

#ifndef SDK_ASM
#define REG_SCFG_LAGER_CPU_CNT_FIELD( mst1_en ) \
    (u8)( \
    ((u32)(mst1_en) << REG_SCFG_LAGER_CPU_CNT_MST1_EN_SHIFT))
#endif


/* VER */

#define REG_SCFG_VER_LAGER2_SHIFT                          2
#define REG_SCFG_VER_LAGER2_SIZE                           1
#define REG_SCFG_VER_LAGER2_MASK                           0x0004

#define REG_SCFG_VER_LAGER_SHIFT                           1
#define REG_SCFG_VER_LAGER_SIZE                            1
#define REG_SCFG_VER_LAGER_MASK                            0x0002
...
#ifndef SDK_ASM
#define REG_SCFG_VER_FIELD( lager2, lager, ts ) \
    (u16)( \
    ((u32)(lager2) << REG_SCFG_VER_LAGER2_SHIFT) | \
    ((u32)(lager) << REG_SCFG_VER_LAGER_SHIFT) | \
...
/* NN_HW_CTR_EIU_MPCORE_IOREG_EIUPATCH_SCFG_H_ */
#endif
