/*---------------------------------------------------------------------------*
  ...
  File:     nn/hw/CTR-EIU/MPCore/ioreg_eiupatch_OS.h
...
//
#ifndef NN_HW_CTR_EIU_MPCORE_IOREG_EIUPATCH_OS_H_
#define NN_HW_CTR_EIU_MPCORE_IOREG_EIUPATCH_OS_H_
...
#define REG_L2_CACHE_ID_OFFSET                             0x10000
#define REG_L2_CACHE_ID_ADDR                               (HW_VIRTUAL_MPCORE_REG + REG_L2_CACHE_ID_OFFSET)
#define reg_OS_L2_CACHE_ID                                 (*(const REGType32v *) REG_L2_CACHE_ID_ADDR)

/* L2_CACHE_TYPE */

#define REG_L2_CACHE_TYPE_OFFSET                           0x10004
#define REG_L2_CACHE_TYPE_ADDR                             (HW_VIRTUAL_MPCORE_REG + REG_L2_CACHE_TYPE_OFFSET)
#define reg_OS_L2_CACHE_TYPE                               (*(const REGType32v *) REG_L2_CACHE_TYPE_ADDR)

/* L2_CTRL */

#define REG_L2_CTRL_OFFSET                                 0x10100
#define REG_L2_CTRL_ADDR                                   (HW_VIRTUAL_MPCORE_REG + REG_L2_CTRL_OFFSET)
#define reg_OS_L2_CTRL                                     (*( REGType8v *) REG_L2_CTRL_ADDR)

/* L2_AUX_CTRL */

#define REG_L2_AUX_CTRL_OFFSET                             0x10104
#define REG_L2_AUX_CTRL_ADDR                               (HW_VIRTUAL_MPCORE_REG + REG_L2_AUX_CTRL_OFFSET)
#define reg_OS_L2_AUX_CTRL                                 (*( REGType32v *) REG_L2_AUX_CTRL_ADDR)

/* L2_TAG_RAM_CTRL */

#define REG_L2_TAG_RAM_CTRL_OFFSET                         0x10108
#define REG_L2_TAG_RAM_CTRL_ADDR                           (HW_VIRTUAL_MPCORE_REG + REG_L2_TAG_RAM_CTRL_OFFSET)
#define reg_OS_L2_TAG_RAM_CTRL                             (*( REGType16v *) REG_L2_TAG_RAM_CTRL_ADDR)

/* L2_DATA_RAM_CTRL */

#define REG_L2_DATA_RAM_CTRL_OFFSET                        0x1010c
#define REG_L2_DATA_RAM_CTRL_ADDR                          (HW_VIRTUAL_MPCORE_REG + REG_L2_DATA_RAM_CTRL_OFFSET)
#define reg_OS_L2_DATA_RAM_CTRL                            (*( REGType16v *) REG_L2_DATA_RAM_CTRL_ADDR)

/* L2_EV_COUNTER_CTRL */

#define REG_L2_EV_COUNTER_CTRL_OFFSET                      0x10200
#define REG_L2_EV_COUNTER_CTRL_ADDR                        (HW_VIRTUAL_MPCORE_REG + REG_L2_EV_COUNTER_CTRL_OFFSET)
#define reg_OS_L2_EV_COUNTER_CTRL                          (*( REGType8v *) REG_L2_EV_COUNTER_CTRL_ADDR)

/* L2_EV_COUNTER1_CFG */

#define REG_L2_EV_COUNTER1_CFG_OFFSET                      0x10204
#define REG_L2_EV_COUNTER1_CFG_ADDR                        (HW_VIRTUAL_MPCORE_REG + REG_L2_EV_COUNTER1_CFG_OFFSET)
#define reg_OS_L2_EV_COUNTER1_CFG                          (*( REGType8v *) REG_L2_EV_COUNTER1_CFG_ADDR)

/* L2_EV_COUNTER0_CFG */

#define REG_L2_EV_COUNTER0_CFG_OFFSET                      0x10208
#define REG_L2_EV_COUNTER0_CFG_ADDR                        (HW_VIRTUAL_MPCORE_REG + REG_L2_EV_COUNTER0_CFG_OFFSET)
#define reg_OS_L2_EV_COUNTER0_CFG                          (*( REGType8v *) REG_L2_EV_COUNTER0_CFG_ADDR)

/* L2_EV_COUNTER1 */

#define REG_L2_EV_COUNTER1_OFFSET                          0x1020c
#define REG_L2_EV_COUNTER1_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_EV_COUNTER1_OFFSET)
#define reg_OS_L2_EV_COUNTER1                              (*( REGType32v *) REG_L2_EV_COUNTER1_ADDR)

/* L2_EV_COUNTER0 */

#define REG_L2_EV_COUNTER0_OFFSET                          0x10210
#define REG_L2_EV_COUNTER0_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_EV_COUNTER0_OFFSET)
#define reg_OS_L2_EV_COUNTER0                              (*( REGType32v *) REG_L2_EV_COUNTER0_ADDR)

/* L2_INT_MASK */

#define REG_L2_INT_MASK_OFFSET                             0x10214
#define REG_L2_INT_MASK_ADDR                               (HW_VIRTUAL_MPCORE_REG + REG_L2_INT_MASK_OFFSET)
#define reg_OS_L2_INT_MASK                                 (*( REGType16v *) REG_L2_INT_MASK_ADDR)

/* L2_INT_MASK_STATUS */

#define REG_L2_INT_MASK_STATUS_OFFSET                      0x10218
#define REG_L2_INT_MASK_STATUS_ADDR                        (HW_VIRTUAL_MPCORE_REG + REG_L2_INT_MASK_STATUS_OFFSET)
#define reg_OS_L2_INT_MASK_STATUS                          (*(const REGType16v *) REG_L2_INT_MASK_STATUS_ADDR)

/* L2_INT_RAW_STATUS */

#define REG_L2_INT_RAW_STATUS_OFFSET                       0x1021c
#define REG_L2_INT_RAW_STATUS_ADDR                         (HW_VIRTUAL_MPCORE_REG + REG_L2_INT_RAW_STATUS_OFFSET)
#define reg_OS_L2_INT_RAW_STATUS                           (*(const REGType16v *) REG_L2_INT_RAW_STATUS_ADDR)

/* L2_INT_CLEAR */

#define REG_L2_INT_CLEAR_OFFSET                            0x10220
#define REG_L2_INT_CLEAR_ADDR                              (HW_VIRTUAL_MPCORE_REG + REG_L2_INT_CLEAR_OFFSET)
#define reg_OS_L2_INT_CLEAR                                (*( REGType16v *) REG_L2_INT_CLEAR_ADDR)

/* L2_CACHE_SYNC */

#define REG_L2_CACHE_SYNC_OFFSET                           0x10730
#define REG_L2_CACHE_SYNC_ADDR                             (HW_VIRTUAL_MPCORE_REG + REG_L2_CACHE_SYNC_OFFSET)
#define reg_OS_L2_CACHE_SYNC                               (*( REGType8v *) REG_L2_CACHE_SYNC_ADDR)

/* L2_INV_PA */

#define REG_L2_INV_PA_OFFSET                               0x10770
#define REG_L2_INV_PA_ADDR                                 (HW_VIRTUAL_MPCORE_REG + REG_L2_INV_PA_OFFSET)
#define reg_OS_L2_INV_PA                                   (*( REGType32v *) REG_L2_INV_PA_ADDR)

/* L2_INV_WAY */

#define REG_L2_INV_WAY_OFFSET                              0x1077c
#define REG_L2_INV_WAY_ADDR                                (HW_VIRTUAL_MPCORE_REG + REG_L2_INV_WAY_OFFSET)
#define reg_OS_L2_INV_WAY                                  (*( REGType16v *) REG_L2_INV_WAY_ADDR)

/* L2_CLEAN_PA */

#define REG_L2_CLEAN_PA_OFFSET                             0x107b0
#define REG_L2_CLEAN_PA_ADDR                               (HW_VIRTUAL_MPCORE_REG + REG_L2_CLEAN_PA_OFFSET)
#define reg_OS_L2_CLEAN_PA                                 (*( REGType32v *) REG_L2_CLEAN_PA_ADDR)

/* L2_CLEAN_INDEX */

#define REG_L2_CLEAN_INDEX_OFFSET                          0x107b8
#define REG_L2_CLEAN_INDEX_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_CLEAN_INDEX_OFFSET)
#define reg_OS_L2_CLEAN_INDEX                              (*( REGType32v *) REG_L2_CLEAN_INDEX_ADDR)

/* L2_CLEAN_WAY */

#define REG_L2_CLEAN_WAY_OFFSET                            0x107bc
#define REG_L2_CLEAN_WAY_ADDR                              (HW_VIRTUAL_MPCORE_REG + REG_L2_CLEAN_WAY_OFFSET)
#define reg_OS_L2_CLEAN_WAY                                (*( REGType16v *) REG_L2_CLEAN_WAY_ADDR)

/* L2_CLEAN_INV_PA */

#define REG_L2_CLEAN_INV_PA_OFFSET                         0x107f0
#define REG_L2_CLEAN_INV_PA_ADDR                           (HW_VIRTUAL_MPCORE_REG + REG_L2_CLEAN_INV_PA_OFFSET)
#define reg_OS_L2_CLEAN_INV_PA                             (*( REGType32v *) REG_L2_CLEAN_INV_PA_ADDR)

/* L2_CLEAN_INV_INDEX */

#define REG_L2_CLEAN_INV_INDEX_OFFSET                      0x107f8
#define REG_L2_CLEAN_INV_INDEX_ADDR                        (HW_VIRTUAL_MPCORE_REG + REG_L2_CLEAN_INV_INDEX_OFFSET)
#define reg_OS_L2_CLEAN_INV_INDEX                          (*( REGType32v *) REG_L2_CLEAN_INV_INDEX_ADDR)

/* L2_CLEAN_INV_WAY */

#define REG_L2_CLEAN_INV_WAY_OFFSET                        0x107fc
#define REG_L2_CLEAN_INV_WAY_ADDR                          (HW_VIRTUAL_MPCORE_REG + REG_L2_CLEAN_INV_WAY_OFFSET)
#define reg_OS_L2_CLEAN_INV_WAY                            (*( REGType16v *) REG_L2_CLEAN_INV_WAY_ADDR)

/* L2_D_LOCKDOWN0 */

#define REG_L2_D_LOCKDOWN0_OFFSET                          0x10900
#define REG_L2_D_LOCKDOWN0_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_D_LOCKDOWN0_OFFSET)
#define reg_OS_L2_D_LOCKDOWN0                              (*( REGType16v *) REG_L2_D_LOCKDOWN0_ADDR)

/* L2_I_LOCKDOWN0 */

#define REG_L2_I_LOCKDOWN0_OFFSET                          0x10904
#define REG_L2_I_LOCKDOWN0_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_I_LOCKDOWN0_OFFSET)
#define reg_OS_L2_I_LOCKDOWN0                              (*( REGType16v *) REG_L2_I_LOCKDOWN0_ADDR)

/* L2_D_LOCKDOWN1 */

#define REG_L2_D_LOCKDOWN1_OFFSET                          0x10908
#define REG_L2_D_LOCKDOWN1_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_D_LOCKDOWN1_OFFSET)
#define reg_OS_L2_D_LOCKDOWN1                              (*( REGType16v *) REG_L2_D_LOCKDOWN1_ADDR)

/* L2_I_LOCKDOWN1 */

#define REG_L2_I_LOCKDOWN1_OFFSET                          0x1090c
#define REG_L2_I_LOCKDOWN1_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_I_LOCKDOWN1_OFFSET)
#define reg_OS_L2_I_LOCKDOWN1                              (*( REGType16v *) REG_L2_I_LOCKDOWN1_ADDR)

/* L2_D_LOCKDOWN2 */

#define REG_L2_D_LOCKDOWN2_OFFSET                          0x10910
#define REG_L2_D_LOCKDOWN2_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_D_LOCKDOWN2_OFFSET)
#define reg_OS_L2_D_LOCKDOWN2                              (*( REGType16v *) REG_L2_D_LOCKDOWN2_ADDR)

/* L2_I_LOCKDOWN2 */

#define REG_L2_I_LOCKDOWN2_OFFSET                          0x10914
#define REG_L2_I_LOCKDOWN2_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_I_LOCKDOWN2_OFFSET)
#define reg_OS_L2_I_LOCKDOWN2                              (*( REGType16v *) REG_L2_I_LOCKDOWN2_ADDR)

/* L2_D_LOCKDOWN3 */

#define REG_L2_D_LOCKDOWN3_OFFSET                          0x10918
#define REG_L2_D_LOCKDOWN3_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_D_LOCKDOWN3_OFFSET)
#define reg_OS_L2_D_LOCKDOWN3                              (*( REGType16v *) REG_L2_D_LOCKDOWN3_ADDR)

/* L2_I_LOCKDOWN3 */

#define REG_L2_I_LOCKDOWN3_OFFSET                          0x1091c
#define REG_L2_I_LOCKDOWN3_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_I_LOCKDOWN3_OFFSET)
#define reg_OS_L2_I_LOCKDOWN3                              (*( REGType16v *) REG_L2_I_LOCKDOWN3_ADDR)

/* L2_D_LOCKDOWN4 */

#define REG_L2_D_LOCKDOWN4_OFFSET                          0x10920
#define REG_L2_D_LOCKDOWN4_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_D_LOCKDOWN4_OFFSET)
#define reg_OS_L2_D_LOCKDOWN4                              (*( REGType16v *) REG_L2_D_LOCKDOWN4_ADDR)

/* L2_I_LOCKDOWN4 */

#define REG_L2_I_LOCKDOWN4_OFFSET                          0x10924
#define REG_L2_I_LOCKDOWN4_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_I_LOCKDOWN4_OFFSET)
#define reg_OS_L2_I_LOCKDOWN4                              (*( REGType16v *) REG_L2_I_LOCKDOWN4_ADDR)

/* L2_D_LOCKDOWN5 */

#define REG_L2_D_LOCKDOWN5_OFFSET                          0x10928
#define REG_L2_D_LOCKDOWN5_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_D_LOCKDOWN5_OFFSET)
#define reg_OS_L2_D_LOCKDOWN5                              (*( REGType16v *) REG_L2_D_LOCKDOWN5_ADDR)

/* L2_I_LOCKDOWN5 */

#define REG_L2_I_LOCKDOWN5_OFFSET                          0x1092c
#define REG_L2_I_LOCKDOWN5_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_I_LOCKDOWN5_OFFSET)
#define reg_OS_L2_I_LOCKDOWN5                              (*( REGType16v *) REG_L2_I_LOCKDOWN5_ADDR)

/* L2_D_LOCKDOWN6 */

#define REG_L2_D_LOCKDOWN6_OFFSET                          0x10930
#define REG_L2_D_LOCKDOWN6_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_D_LOCKDOWN6_OFFSET)
#define reg_OS_L2_D_LOCKDOWN6                              (*( REGType16v *) REG_L2_D_LOCKDOWN6_ADDR)

/* L2_I_LOCKDOWN6 */

#define REG_L2_I_LOCKDOWN6_OFFSET                          0x10934
#define REG_L2_I_LOCKDOWN6_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_I_LOCKDOWN6_OFFSET)
#define reg_OS_L2_I_LOCKDOWN6                              (*( REGType16v *) REG_L2_I_LOCKDOWN6_ADDR)

/* L2_D_LOCKDOWN7 */

#define REG_L2_D_LOCKDOWN7_OFFSET                          0x10938
#define REG_L2_D_LOCKDOWN7_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_D_LOCKDOWN7_OFFSET)
#define reg_OS_L2_D_LOCKDOWN7                              (*( REGType16v *) REG_L2_D_LOCKDOWN7_ADDR)

/* L2_I_LOCKDOWN7 */

#define REG_L2_I_LOCKDOWN7_OFFSET                          0x1093c
#define REG_L2_I_LOCKDOWN7_ADDR                            (HW_VIRTUAL_MPCORE_REG + REG_L2_I_LOCKDOWN7_OFFSET)
#define reg_OS_L2_I_LOCKDOWN7                              (*( REGType16v *) REG_L2_I_LOCKDOWN7_ADDR)

/* L2_LOCK_LINE_EN */

#define REG_L2_LOCK_LINE_EN_OFFSET                         0x10950
#define REG_L2_LOCK_LINE_EN_ADDR                           (HW_VIRTUAL_MPCORE_REG + REG_L2_LOCK_LINE_EN_OFFSET)
#define reg_OS_L2_LOCK_LINE_EN                             (*( REGType8v *) REG_L2_LOCK_LINE_EN_ADDR)

/* L2_UNLOCK_WAY */

#define REG_L2_UNLOCK_WAY_OFFSET                           0x10954
#define REG_L2_UNLOCK_WAY_ADDR                             (HW_VIRTUAL_MPCORE_REG + REG_L2_UNLOCK_WAY_OFFSET)
#define reg_OS_L2_UNLOCK_WAY                               (*( REGType16v *) REG_L2_UNLOCK_WAY_ADDR)

/* L2_DEBUG_CTRL */

#define REG_L2_DEBUG_CTRL_OFFSET                           0x10f40
#define REG_L2_DEBUG_CTRL_ADDR                             (HW_VIRTUAL_MPCORE_REG + REG_L2_DEBUG_CTRL_OFFSET)
#define reg_OS_L2_DEBUG_CTRL                               (*( REGType8v *) REG_L2_DEBUG_CTRL_ADDR)

/* L2_PREFETCH_CTRL */

#define REG_L2_PREFETCH_CTRL_OFFSET                        0x10f60
#define REG_L2_PREFETCH_CTRL_ADDR                          (HW_VIRTUAL_MPCORE_REG + REG_L2_PREFETCH_CTRL_OFFSET)
#define reg_OS_L2_PREFETCH_CTRL                            (*( REGType32v *) REG_L2_PREFETCH_CTRL_ADDR)

/* L2_POWER_CTRL */

#define REG_L2_POWER_CTRL_OFFSET                           0x10f80
#define REG_L2_POWER_CTRL_ADDR                             (HW_VIRTUAL_MPCORE_REG + REG_L2_POWER_CTRL_OFFSET)
#define reg_OS_L2_POWER_CTRL                               (*( REGType8v *) REG_L2_POWER_CTRL_ADDR)
...
#define REG_OS_CPUI_HI_PND_CPU_SRC_SHIFT                   10
#define REG_OS_CPUI_HI_PND_CPU_SRC_SIZE                    3
#define REG_OS_CPUI_HI_PND_CPU_SRC_MASK                    0x00001c00
...
#ifndef SDK_ASM
#define REG_OS_IDR_SET_IE1_FIELD( xdma_abt, xdma7, xdma6, xdma5, xdma4, xdma3, xdma2, xdma1, xdma0, gpu_p3d, gpu_ppf, gpu_pdc1, gpu_pdc0, gpu_psc1, gpu_psc0, dbg_spi, j1_tx, j1_rx, j0_tx, j0_rx ) \
    (u32)( \
...
#define REG_OS_IDR_SET_IE2_I2C3_SHIFT                      28
#define REG_OS_IDR_SET_IE2_I2C3_SIZE                       1
#define REG_OS_IDR_SET_IE2_I2C3_MASK                       0x10000000
...
#ifndef SDK_ASM
#define REG_OS_IDR_SET_IE2_FIELD( ds_wl, i2c3, key, mic, pdn_lgy, pdn_wake, spi2, spi1, i2c2, i2c1, pxi_rx, pxi_tx, cpu1, cpu0, sclr2, sclr1, yuv2rgb, dsp, cam2, cam1, lgc_det, lgc_i, lmc, sd3_a, sd3, sd2_a, sd2 ) \
    (u32)( \
    ((u32)(ds_wl) << REG_OS_IDR_SET_IE2_DS_WL_SHIFT) | \
    ((u32)(i2c3) << REG_OS_IDR_SET_IE2_I2C3_SHIFT) | \
...
#define REG_OS_IDR_SET_IE3_PMUIRQ7_SHIFT                   31
#define REG_OS_IDR_SET_IE3_PMUIRQ7_SIZE                    1
#define REG_OS_IDR_SET_IE3_PMUIRQ7_MASK                    0x80000000

#define REG_OS_IDR_SET_IE3_PMUIRQ6_SHIFT                   30
#define REG_OS_IDR_SET_IE3_PMUIRQ6_SIZE                    1
#define REG_OS_IDR_SET_IE3_PMUIRQ6_MASK                    0x40000000

#define REG_OS_IDR_SET_IE3_PMUIRQ5_SHIFT                   29
#define REG_OS_IDR_SET_IE3_PMUIRQ5_SIZE                    1
#define REG_OS_IDR_SET_IE3_PMUIRQ5_MASK                    0x20000000

#define REG_OS_IDR_SET_IE3_PMUIRQ4_SHIFT                   28
#define REG_OS_IDR_SET_IE3_PMUIRQ4_SIZE                    1
#define REG_OS_IDR_SET_IE3_PMUIRQ4_MASK                    0x10000000

#define REG_OS_IDR_SET_IE3_PMUIRQ3_SHIFT                   27
#define REG_OS_IDR_SET_IE3_PMUIRQ3_SIZE                    1
#define REG_OS_IDR_SET_IE3_PMUIRQ3_MASK                    0x08000000

#define REG_OS_IDR_SET_IE3_PMUIRQ2_SHIFT                   26
#define REG_OS_IDR_SET_IE3_PMUIRQ2_SIZE                    1
#define REG_OS_IDR_SET_IE3_PMUIRQ2_MASK                    0x04000000
...
#define REG_OS_IDR_SET_IE3_SPM_SHIFT                       23
#define REG_OS_IDR_SET_IE3_SPM_SIZE                        1
#define REG_OS_IDR_SET_IE3_SPM_MASK                        0x00800000

#define REG_OS_IDR_SET_IE3_L2_SHIFT                        22
#define REG_OS_IDR_SET_IE3_L2_SIZE                         1
#define REG_OS_IDR_SET_IE3_L2_MASK                         0x00400000
...
#define REG_OS_IDR_SET_IE3_GPIO3_18_5_SHIFT                19
#define REG_OS_IDR_SET_IE3_GPIO3_18_5_SIZE                 1
#define REG_OS_IDR_SET_IE3_GPIO3_18_5_MASK                 0x00080000

#define REG_OS_IDR_SET_IE3_GPIO3_18_4_SHIFT                18
#define REG_OS_IDR_SET_IE3_GPIO3_18_4_SIZE                 1
#define REG_OS_IDR_SET_IE3_GPIO3_18_4_MASK                 0x00040000

#define REG_OS_IDR_SET_IE3_GPIO3_18_3_SHIFT                17
#define REG_OS_IDR_SET_IE3_GPIO3_18_3_SIZE                 1
#define REG_OS_IDR_SET_IE3_GPIO3_18_3_MASK                 0x00020000

#define REG_OS_IDR_SET_IE3_GPIO3_18_2_SHIFT                16
#define REG_OS_IDR_SET_IE3_GPIO3_18_2_SIZE                 1
#define REG_OS_IDR_SET_IE3_GPIO3_18_2_MASK                 0x00010000

#define REG_OS_IDR_SET_IE3_GPIO3_18_1_SHIFT                15
#define REG_OS_IDR_SET_IE3_GPIO3_18_1_SIZE                 1
#define REG_OS_IDR_SET_IE3_GPIO3_18_1_MASK                 0x00008000

#define REG_OS_IDR_SET_IE3_GPIO3_18_0_SHIFT                14
#define REG_OS_IDR_SET_IE3_GPIO3_18_0_SIZE                 1
#define REG_OS_IDR_SET_IE3_GPIO3_18_0_MASK                 0x00004000
...
#define REG_OS_IDR_SET_IE3_IR_SHIFT                        10
#define REG_OS_IDR_SET_IE3_IR_SIZE                         1
#define REG_OS_IDR_SET_IE3_IR_MASK                         0x00000400
...
#define REG_OS_IDR_SET_IE3_TP_SHIFT                        3
#define REG_OS_IDR_SET_IE3_TP_SIZE                         1
#define REG_OS_IDR_SET_IE3_TP_MASK                         0x00000008

#define REG_OS_IDR_SET_IE3_COVER_R_SHIFT                   2
#define REG_OS_IDR_SET_IE3_COVER_R_SIZE                    1
#define REG_OS_IDR_SET_IE3_COVER_R_MASK                    0x00000004
...
#define REG_OS_IDR_SET_IE3_FIELD( pmuirq7, pmuirq6, pmuirq5, pmuirq4, pmuirq3, pmuirq2, pmuirq1, pmuirq0, spm, l2, cgc_det, cgc_i, gpio3_18_5, gpio3_18_4, gpio3_18_3, gpio3_18_2, gpio3_18_1, gpio3_18_0, gpio3_33_5, gpio3_33_4, gpio3_33_3, gpio3_33_2, gpio3_33_1, gpio3_33_0, ctr_mcu, rmc, ir, sp_sel, twl_depop, twl_mcu, hp, tp, cover_r, cover ) \
    ...
    ((u32)(pmuirq3) << REG_OS_IDR_SET_IE3_PMUIRQ3_SHIFT) | \
    ((u32)(pmuirq2) << REG_OS_IDR_SET_IE3_PMUIRQ2_SHIFT) | \
    ((u32)(pmuirq1) << REG_OS_IDR_SET_IE3_PMUIRQ1_SHIFT) | \
    ((u32)(pmuirq0) << REG_OS_IDR_SET_IE3_PMUIRQ0_SHIFT) | \
    ((u32)(spm) << REG_OS_IDR_SET_IE3_SPM_SHIFT) | \
    ((u32)(l2) << REG_OS_IDR_SET_IE3_L2_SHIFT) | \
    ((u32)(cgc_det) << REG_OS_IDR_SET_IE3_CGC_DET_SHIFT) | \
    ((u32)(cgc_i) << REG_OS_IDR_SET_IE3_CGC_I_SHIFT) | \
    ((u32)(gpio3_18_5) << REG_OS_IDR_SET_IE3_GPIO3_18_5_SHIFT) | \
    ((u32)(gpio3_18_4) << REG_OS_IDR_SET_IE3_GPIO3_18_4_SHIFT) | \
    ...
    ((u32)(ir) << REG_OS_IDR_SET_IE3_IR_SHIFT) | \
    ...
    ((u32)(tp) << REG_OS_IDR_SET_IE3_TP_SHIFT) | \
    ((u32)(cover_r) << REG_OS_IDR_SET_IE3_COVER_R_SHIFT) | \
...
#ifndef SDK_ASM
#define REG_OS_IDR_CLR_IE1_FIELD( xdma_abt, xdma7, xdma6, xdma5, xdma4, xdma3, xdma2, xdma1, xdma0, gpu_p3d, gpu_ppf, gpu_pdc1, gpu_pdc0, gpu_psc1, gpu_psc0, dbg_spi, j1_tx, j1_rx, j0_tx, j0_rx ) \
    (u32)( \
...
#define REG_OS_IDR_CLR_IE2_I2C3_SHIFT                      28
#define REG_OS_IDR_CLR_IE2_I2C3_SIZE                       1
#define REG_OS_IDR_CLR_IE2_I2C3_MASK                       0x10000000
...
#ifndef SDK_ASM
#define REG_OS_IDR_CLR_IE2_FIELD( ds_wl, i2c3, key, mic, pdn_lgy, pdn_wake, spi2, spi1, i2c2, i2c1, pxi_rx, pxi_tx, cpu1, cpu0, sclr2, sclr1, yuv2rgb, dsp, cam2, cam1, lgc_det, lgc_i, lmc, sd3_a, sd3, sd2_a, sd2 ) \
    (u32)( \
    ((u32)(ds_wl) << REG_OS_IDR_CLR_IE2_DS_WL_SHIFT) | \
    ((u32)(i2c3) << REG_OS_IDR_CLR_IE2_I2C3_SHIFT) | \
...
#define REG_OS_IDR_CLR_IE3_PMUIRQ7_SHIFT                   31
#define REG_OS_IDR_CLR_IE3_PMUIRQ7_SIZE                    1
#define REG_OS_IDR_CLR_IE3_PMUIRQ7_MASK                    0x80000000

#define REG_OS_IDR_CLR_IE3_PMUIRQ6_SHIFT                   30
#define REG_OS_IDR_CLR_IE3_PMUIRQ6_SIZE                    1
#define REG_OS_IDR_CLR_IE3_PMUIRQ6_MASK                    0x40000000

#define REG_OS_IDR_CLR_IE3_PMUIRQ5_SHIFT                   29
#define REG_OS_IDR_CLR_IE3_PMUIRQ5_SIZE                    1
#define REG_OS_IDR_CLR_IE3_PMUIRQ5_MASK                    0x20000000

#define REG_OS_IDR_CLR_IE3_PMUIRQ4_SHIFT                   28
#define REG_OS_IDR_CLR_IE3_PMUIRQ4_SIZE                    1
#define REG_OS_IDR_CLR_IE3_PMUIRQ4_MASK                    0x10000000

#define REG_OS_IDR_CLR_IE3_PMUIRQ3_SHIFT                   27
#define REG_OS_IDR_CLR_IE3_PMUIRQ3_SIZE                    1
#define REG_OS_IDR_CLR_IE3_PMUIRQ3_MASK                    0x08000000

#define REG_OS_IDR_CLR_IE3_PMUIRQ2_SHIFT                   26
#define REG_OS_IDR_CLR_IE3_PMUIRQ2_SIZE                    1
#define REG_OS_IDR_CLR_IE3_PMUIRQ2_MASK                    0x04000000
...
#define REG_OS_IDR_CLR_IE3_SPM_SHIFT                       23
#define REG_OS_IDR_CLR_IE3_SPM_SIZE                        1
#define REG_OS_IDR_CLR_IE3_SPM_MASK                        0x00800000

#define REG_OS_IDR_CLR_IE3_L2_SHIFT                        22
#define REG_OS_IDR_CLR_IE3_L2_SIZE                         1
#define REG_OS_IDR_CLR_IE3_L2_MASK                         0x00400000
...
#define REG_OS_IDR_CLR_IE3_GPIO3_18_5_SHIFT                19
#define REG_OS_IDR_CLR_IE3_GPIO3_18_5_SIZE                 1
#define REG_OS_IDR_CLR_IE3_GPIO3_18_5_MASK                 0x00080000

#define REG_OS_IDR_CLR_IE3_GPIO3_18_4_SHIFT                18
#define REG_OS_IDR_CLR_IE3_GPIO3_18_4_SIZE                 1
#define REG_OS_IDR_CLR_IE3_GPIO3_18_4_MASK                 0x00040000

#define REG_OS_IDR_CLR_IE3_GPIO3_18_3_SHIFT                17
#define REG_OS_IDR_CLR_IE3_GPIO3_18_3_SIZE                 1
#define REG_OS_IDR_CLR_IE3_GPIO3_18_3_MASK                 0x00020000

#define REG_OS_IDR_CLR_IE3_GPIO3_18_2_SHIFT                16
#define REG_OS_IDR_CLR_IE3_GPIO3_18_2_SIZE                 1
#define REG_OS_IDR_CLR_IE3_GPIO3_18_2_MASK                 0x00010000

#define REG_OS_IDR_CLR_IE3_GPIO3_18_1_SHIFT                15
#define REG_OS_IDR_CLR_IE3_GPIO3_18_1_SIZE                 1
#define REG_OS_IDR_CLR_IE3_GPIO3_18_1_MASK                 0x00008000

#define REG_OS_IDR_CLR_IE3_GPIO3_18_0_SHIFT                14
#define REG_OS_IDR_CLR_IE3_GPIO3_18_0_SIZE                 1
#define REG_OS_IDR_CLR_IE3_GPIO3_18_0_MASK                 0x00004000
...
#define REG_OS_IDR_CLR_IE3_IR_SHIFT                        10
#define REG_OS_IDR_CLR_IE3_IR_SIZE                         1
#define REG_OS_IDR_CLR_IE3_IR_MASK                         0x00000400
...
#define REG_OS_IDR_CLR_IE3_TP_SHIFT                        3
#define REG_OS_IDR_CLR_IE3_TP_SIZE                         1
#define REG_OS_IDR_CLR_IE3_TP_MASK                         0x00000008

#define REG_OS_IDR_CLR_IE3_COVER_R_SHIFT                   2
#define REG_OS_IDR_CLR_IE3_COVER_R_SIZE                    1
#define REG_OS_IDR_CLR_IE3_COVER_R_MASK                    0x00000004
...
#ifndef SDK_ASM
#define REG_OS_IDR_CLR_IE3_FIELD( pmuirq7, pmuirq6, pmuirq5, pmuirq4, pmuirq3, pmuirq2, pmuirq1, pmuirq0, spm, l2, cgc_det, cgc_i, gpio3_18_5, gpio3_18_4, gpio3_18_3, gpio3_18_2, gpio3_18_1, gpio3_18_0, gpio3_33_5, gpio3_33_4, gpio3_33_3, gpio3_33_2, gpio3_33_1, gpio3_33_0, ctr_mcu, rmc, ir, sp_sel, twl_depop, twl_mcu, hp, tp, cover_r, cover ) \
    (u32)( \
    ...
    ((u32)(pmuirq3) << REG_OS_IDR_CLR_IE3_PMUIRQ3_SHIFT) | \
    ((u32)(pmuirq2) << REG_OS_IDR_CLR_IE3_PMUIRQ2_SHIFT) | \
    ((u32)(pmuirq1) << REG_OS_IDR_CLR_IE3_PMUIRQ1_SHIFT) | \
    ((u32)(pmuirq0) << REG_OS_IDR_CLR_IE3_PMUIRQ0_SHIFT) | \
    ((u32)(spm) << REG_OS_IDR_CLR_IE3_SPM_SHIFT) | \
    ((u32)(l2) << REG_OS_IDR_CLR_IE3_L2_SHIFT) | \
    ((u32)(cgc_det) << REG_OS_IDR_CLR_IE3_CGC_DET_SHIFT) | \
    ((u32)(cgc_i) << REG_OS_IDR_CLR_IE3_CGC_I_SHIFT) | \
    ((u32)(gpio3_18_5) << REG_OS_IDR_CLR_IE3_GPIO3_18_5_SHIFT) | \
    ((u32)(gpio3_18_4) << REG_OS_IDR_CLR_IE3_GPIO3_18_4_SHIFT) | \
    ...
    ((u32)(ir) << REG_OS_IDR_CLR_IE3_IR_SHIFT) | \
    ...
    ((u32)(tp) << REG_OS_IDR_CLR_IE3_TP_SHIFT) | \
    ((u32)(cover_r) << REG_OS_IDR_CLR_IE3_COVER_R_SHIFT) | \
...
#ifndef SDK_ASM
#define REG_OS_IDR_SET_PND1_FIELD( xdma_abt, xdma7, xdma6, xdma5, xdma4, xdma3, xdma2, xdma1, xdma0, gpu_p3d, gpu_ppf, gpu_pdc1, gpu_pdc0, gpu_psc1, gpu_psc0, dbg_spi, j1_tx, j1_rx, j0_tx, j0_rx ) \
    (u32)( \
...
#define REG_OS_IDR_SET_PND2_I2C3_SHIFT                     28
#define REG_OS_IDR_SET_PND2_I2C3_SIZE                      1
#define REG_OS_IDR_SET_PND2_I2C3_MASK                      0x10000000
...
#ifndef SDK_ASM
#define REG_OS_IDR_SET_PND2_FIELD( ds_wl, i2c3, key, mic, pdn_lgy, pdn_wake, spi2, spi1, i2c2, i2c1, pxi_rx, pxi_tx, cpu1, cpu0, sclr2, sclr1, yuv2rgb, dsp, cam2, cam1, lgc_det, lgc_i, lmc, sd3_a, sd3, sd2_a, sd2 ) \
    (u32)( \
    ((u32)(ds_wl) << REG_OS_IDR_SET_PND2_DS_WL_SHIFT) | \
    ((u32)(i2c3) << REG_OS_IDR_SET_PND2_I2C3_SHIFT) | \
...
#define REG_OS_IDR_SET_PND3_PMUIRQ7_SHIFT                  31
#define REG_OS_IDR_SET_PND3_PMUIRQ7_SIZE                   1
#define REG_OS_IDR_SET_PND3_PMUIRQ7_MASK                   0x80000000

#define REG_OS_IDR_SET_PND3_PMUIRQ6_SHIFT                  30
#define REG_OS_IDR_SET_PND3_PMUIRQ6_SIZE                   1
#define REG_OS_IDR_SET_PND3_PMUIRQ6_MASK                   0x40000000

#define REG_OS_IDR_SET_PND3_PMUIRQ5_SHIFT                  29
#define REG_OS_IDR_SET_PND3_PMUIRQ5_SIZE                   1
#define REG_OS_IDR_SET_PND3_PMUIRQ5_MASK                   0x20000000

#define REG_OS_IDR_SET_PND3_PMUIRQ4_SHIFT                  28
#define REG_OS_IDR_SET_PND3_PMUIRQ4_SIZE                   1
#define REG_OS_IDR_SET_PND3_PMUIRQ4_MASK                   0x10000000

#define REG_OS_IDR_SET_PND3_PMUIRQ3_SHIFT                  27
#define REG_OS_IDR_SET_PND3_PMUIRQ3_SIZE                   1
#define REG_OS_IDR_SET_PND3_PMUIRQ3_MASK                   0x08000000

#define REG_OS_IDR_SET_PND3_PMUIRQ2_SHIFT                  26
#define REG_OS_IDR_SET_PND3_PMUIRQ2_SIZE                   1
#define REG_OS_IDR_SET_PND3_PMUIRQ2_MASK                   0x04000000
...
#define REG_OS_IDR_SET_PND3_SPM_SHIFT                      23
#define REG_OS_IDR_SET_PND3_SPM_SIZE                       1
#define REG_OS_IDR_SET_PND3_SPM_MASK                       0x00800000

#define REG_OS_IDR_SET_PND3_L2_SHIFT                       22
#define REG_OS_IDR_SET_PND3_L2_SIZE                        1
#define REG_OS_IDR_SET_PND3_L2_MASK                        0x00400000
...
#define REG_OS_IDR_SET_PND3_GPIO3_18_5_SHIFT               19
#define REG_OS_IDR_SET_PND3_GPIO3_18_5_SIZE                1
#define REG_OS_IDR_SET_PND3_GPIO3_18_5_MASK                0x00080000

#define REG_OS_IDR_SET_PND3_GPIO3_18_4_SHIFT               18
#define REG_OS_IDR_SET_PND3_GPIO3_18_4_SIZE                1
#define REG_OS_IDR_SET_PND3_GPIO3_18_4_MASK                0x00040000

#define REG_OS_IDR_SET_PND3_GPIO3_18_3_SHIFT               17
#define REG_OS_IDR_SET_PND3_GPIO3_18_3_SIZE                1
#define REG_OS_IDR_SET_PND3_GPIO3_18_3_MASK                0x00020000

#define REG_OS_IDR_SET_PND3_GPIO3_18_2_SHIFT               16
#define REG_OS_IDR_SET_PND3_GPIO3_18_2_SIZE                1
#define REG_OS_IDR_SET_PND3_GPIO3_18_2_MASK                0x00010000

#define REG_OS_IDR_SET_PND3_GPIO3_18_1_SHIFT               15
#define REG_OS_IDR_SET_PND3_GPIO3_18_1_SIZE                1
#define REG_OS_IDR_SET_PND3_GPIO3_18_1_MASK                0x00008000

#define REG_OS_IDR_SET_PND3_GPIO3_18_0_SHIFT               14
#define REG_OS_IDR_SET_PND3_GPIO3_18_0_SIZE                1
#define REG_OS_IDR_SET_PND3_GPIO3_18_0_MASK                0x00004000
...
#define REG_OS_IDR_SET_PND3_IR_SHIFT                       10
#define REG_OS_IDR_SET_PND3_IR_SIZE                        1
#define REG_OS_IDR_SET_PND3_IR_MASK                        0x00000400
...
#define REG_OS_IDR_SET_PND3_TP_SHIFT                       3
#define REG_OS_IDR_SET_PND3_TP_SIZE                        1
#define REG_OS_IDR_SET_PND3_TP_MASK                        0x00000008

#define REG_OS_IDR_SET_PND3_COVER_R_SHIFT                  2
#define REG_OS_IDR_SET_PND3_COVER_R_SIZE                   1
#define REG_OS_IDR_SET_PND3_COVER_R_MASK                   0x00000004
...
#ifndef SDK_ASM
#define REG_OS_IDR_SET_PND3_FIELD( pmuirq7, pmuirq6, pmuirq5, pmuirq4, pmuirq3, pmuirq2, pmuirq1, pmuirq0, spm, l2, cgc_det, cgc_i, gpio3_18_5, gpio3_18_4, gpio3_18_3, gpio3_18_2, gpio3_18_1, gpio3_18_0, gpio3_33_5, gpio3_33_4, gpio3_33_3, gpio3_33_2, gpio3_33_1, gpio3_33_0, ctr_mcu, rmc, ir, sp_sel, twl_depop, twl_mcu, hp, tp, cover_r, cover ) \
    (u32)( \
    ...
    ((u32)(pmuirq3) << REG_OS_IDR_SET_PND3_PMUIRQ3_SHIFT) | \
    ((u32)(pmuirq2) << REG_OS_IDR_SET_PND3_PMUIRQ2_SHIFT) | \
    ((u32)(pmuirq1) << REG_OS_IDR_SET_PND3_PMUIRQ1_SHIFT) | \
    ((u32)(pmuirq0) << REG_OS_IDR_SET_PND3_PMUIRQ0_SHIFT) | \
    ((u32)(spm) << REG_OS_IDR_SET_PND3_SPM_SHIFT) | \
    ((u32)(l2) << REG_OS_IDR_SET_PND3_L2_SHIFT) | \
    ((u32)(cgc_det) << REG_OS_IDR_SET_PND3_CGC_DET_SHIFT) | \
    ((u32)(cgc_i) << REG_OS_IDR_SET_PND3_CGC_I_SHIFT) | \
    ((u32)(gpio3_18_5) << REG_OS_IDR_SET_PND3_GPIO3_18_5_SHIFT) | \
    ((u32)(gpio3_18_4) << REG_OS_IDR_SET_PND3_GPIO3_18_4_SHIFT) | \
    ...
    ((u32)(ir) << REG_OS_IDR_SET_PND3_IR_SHIFT) | \
    ...
    ((u32)(tp) << REG_OS_IDR_SET_PND3_TP_SHIFT) | \
    ((u32)(cover_r) << REG_OS_IDR_SET_PND3_COVER_R_SHIFT) | \
...
#ifndef SDK_ASM
#define REG_OS_IDR_CLR_PND1_FIELD( xdma_abt, xdma7, xdma6, xdma5, xdma4, xdma3, xdma2, xdma1, xdma0, gpu_p3d, gpu_ppf, gpu_pdc1, gpu_pdc0, gpu_psc1, gpu_psc0, dbg_spi, j1_tx, j1_rx, j0_tx, j0_rx ) \
    (u32)( \
...
#define REG_OS_IDR_CLR_PND2_I2C3_SHIFT                     28
#define REG_OS_IDR_CLR_PND2_I2C3_SIZE                      1
#define REG_OS_IDR_CLR_PND2_I2C3_MASK                      0x10000000
...
#ifndef SDK_ASM
#define REG_OS_IDR_CLR_PND2_FIELD( ds_wl, i2c3, key, mic, pdn_lgy, pdn_wake, spi2, spi1, i2c2, i2c1, pxi_rx, pxi_tx, cpu1, cpu0, sclr2, sclr1, yuv2rgb, dsp, cam2, cam1, lgc_det, lgc_i, lmc, sd3_a, sd3, sd2_a, sd2 ) \
    (u32)( \
    ((u32)(ds_wl) << REG_OS_IDR_CLR_PND2_DS_WL_SHIFT) | \
    ((u32)(i2c3) << REG_OS_IDR_CLR_PND2_I2C3_SHIFT) | \
...
#define REG_OS_IDR_CLR_PND3_PMUIRQ7_SHIFT                  31
#define REG_OS_IDR_CLR_PND3_PMUIRQ7_SIZE                   1
#define REG_OS_IDR_CLR_PND3_PMUIRQ7_MASK                   0x80000000

#define REG_OS_IDR_CLR_PND3_PMUIRQ6_SHIFT                  30
#define REG_OS_IDR_CLR_PND3_PMUIRQ6_SIZE                   1
#define REG_OS_IDR_CLR_PND3_PMUIRQ6_MASK                   0x40000000

#define REG_OS_IDR_CLR_PND3_PMUIRQ5_SHIFT                  29
#define REG_OS_IDR_CLR_PND3_PMUIRQ5_SIZE                   1
#define REG_OS_IDR_CLR_PND3_PMUIRQ5_MASK                   0x20000000

#define REG_OS_IDR_CLR_PND3_PMUIRQ4_SHIFT                  28
#define REG_OS_IDR_CLR_PND3_PMUIRQ4_SIZE                   1
#define REG_OS_IDR_CLR_PND3_PMUIRQ4_MASK                   0x10000000

#define REG_OS_IDR_CLR_PND3_PMUIRQ3_SHIFT                  27
#define REG_OS_IDR_CLR_PND3_PMUIRQ3_SIZE                   1
#define REG_OS_IDR_CLR_PND3_PMUIRQ3_MASK                   0x08000000

#define REG_OS_IDR_CLR_PND3_PMUIRQ2_SHIFT                  26
#define REG_OS_IDR_CLR_PND3_PMUIRQ2_SIZE                   1
#define REG_OS_IDR_CLR_PND3_PMUIRQ2_MASK                   0x04000000
...
#define REG_OS_IDR_CLR_PND3_SPM_SHIFT                      23
#define REG_OS_IDR_CLR_PND3_SPM_SIZE                       1
#define REG_OS_IDR_CLR_PND3_SPM_MASK                       0x00800000

#define REG_OS_IDR_CLR_PND3_L2_SHIFT                       22
#define REG_OS_IDR_CLR_PND3_L2_SIZE                        1
#define REG_OS_IDR_CLR_PND3_L2_MASK                        0x00400000
...
#define REG_OS_IDR_CLR_PND3_GPIO3_18_5_SHIFT               19
#define REG_OS_IDR_CLR_PND3_GPIO3_18_5_SIZE                1
#define REG_OS_IDR_CLR_PND3_GPIO3_18_5_MASK                0x00080000

#define REG_OS_IDR_CLR_PND3_GPIO3_18_4_SHIFT               18
#define REG_OS_IDR_CLR_PND3_GPIO3_18_4_SIZE                1
#define REG_OS_IDR_CLR_PND3_GPIO3_18_4_MASK                0x00040000

#define REG_OS_IDR_CLR_PND3_GPIO3_18_3_SHIFT               17
#define REG_OS_IDR_CLR_PND3_GPIO3_18_3_SIZE                1
#define REG_OS_IDR_CLR_PND3_GPIO3_18_3_MASK                0x00020000

#define REG_OS_IDR_CLR_PND3_GPIO3_18_2_SHIFT               16
#define REG_OS_IDR_CLR_PND3_GPIO3_18_2_SIZE                1
#define REG_OS_IDR_CLR_PND3_GPIO3_18_2_MASK                0x00010000

#define REG_OS_IDR_CLR_PND3_GPIO3_18_1_SHIFT               15
#define REG_OS_IDR_CLR_PND3_GPIO3_18_1_SIZE                1
#define REG_OS_IDR_CLR_PND3_GPIO3_18_1_MASK                0x00008000

#define REG_OS_IDR_CLR_PND3_GPIO3_18_0_SHIFT               14
#define REG_OS_IDR_CLR_PND3_GPIO3_18_0_SIZE                1
#define REG_OS_IDR_CLR_PND3_GPIO3_18_0_MASK                0x00004000
...
#define REG_OS_IDR_CLR_PND3_IR_SHIFT                       10
#define REG_OS_IDR_CLR_PND3_IR_SIZE                        1
#define REG_OS_IDR_CLR_PND3_IR_MASK                        0x00000400
...
#define REG_OS_IDR_CLR_PND3_TP_SHIFT                       3
#define REG_OS_IDR_CLR_PND3_TP_SIZE                        1
#define REG_OS_IDR_CLR_PND3_TP_MASK                        0x00000008

#define REG_OS_IDR_CLR_PND3_COVER_R_SHIFT                  2
#define REG_OS_IDR_CLR_PND3_COVER_R_SIZE                   1
#define REG_OS_IDR_CLR_PND3_COVER_R_MASK                   0x00000004
...
#ifndef SDK_ASM
#define REG_OS_IDR_CLR_PND3_FIELD( pmuirq7, pmuirq6, pmuirq5, pmuirq4, pmuirq3, pmuirq2, pmuirq1, pmuirq0, spm, l2, cgc_det, cgc_i, gpio3_18_5, gpio3_18_4, gpio3_18_3, gpio3_18_2, gpio3_18_1, gpio3_18_0, gpio3_33_5, gpio3_33_4, gpio3_33_3, gpio3_33_2, gpio3_33_1, gpio3_33_0, ctr_mcu, rmc, ir, sp_sel, twl_depop, twl_mcu, hp, tp, cover_r, cover ) \
    (u32)( \
    ...
    ((u32)(pmuirq3) << REG_OS_IDR_CLR_PND3_PMUIRQ3_SHIFT) | \
    ((u32)(pmuirq2) << REG_OS_IDR_CLR_PND3_PMUIRQ2_SHIFT) | \
    ((u32)(pmuirq1) << REG_OS_IDR_CLR_PND3_PMUIRQ1_SHIFT) | \
    ((u32)(pmuirq0) << REG_OS_IDR_CLR_PND3_PMUIRQ0_SHIFT) | \
    ((u32)(spm) << REG_OS_IDR_CLR_PND3_SPM_SHIFT) | \
    ((u32)(l2) << REG_OS_IDR_CLR_PND3_L2_SHIFT) | \
    ((u32)(cgc_det) << REG_OS_IDR_CLR_PND3_CGC_DET_SHIFT) | \
    ((u32)(cgc_i) << REG_OS_IDR_CLR_PND3_CGC_I_SHIFT) | \
    ((u32)(gpio3_18_5) << REG_OS_IDR_CLR_PND3_GPIO3_18_5_SHIFT) | \
    ((u32)(gpio3_18_4) << REG_OS_IDR_CLR_PND3_GPIO3_18_4_SHIFT) | \
    ...
    ((u32)(ir) << REG_OS_IDR_CLR_PND3_IR_SHIFT) | \
    ...
    ((u32)(tp) << REG_OS_IDR_CLR_PND3_TP_SHIFT) | \
    ((u32)(cover_r) << REG_OS_IDR_CLR_PND3_COVER_R_SHIFT) | \
...
#ifndef SDK_ASM
#define REG_OS_IDR_ACT1_FIELD( xdma_abt, xdma7, xdma6, xdma5, xdma4, xdma3, xdma2, xdma1, xdma0, gpu_p3d, gpu_ppf, gpu_pdc1, gpu_pdc0, gpu_psc1, gpu_psc0, dbg_spi, j1_tx, j1_rx, j0_tx, j0_rx ) \
    (u32)( \
...
#define REG_OS_IDR_ACT2_I2C3_SHIFT                         28
#define REG_OS_IDR_ACT2_I2C3_SIZE                          1
#define REG_OS_IDR_ACT2_I2C3_MASK                          0x10000000
...
#ifndef SDK_ASM
#define REG_OS_IDR_ACT2_FIELD( ds_wl, i2c3, key, mic, pdn_lgy, pdn_wake, spi2, spi1, i2c2, i2c1, pxi_rx, pxi_tx, cpu1, cpu0, sclr2, sclr1, yuv2rgb, dsp, cam2, cam1, lgc_det, lgc_i, lmc, sd3_a, sd3, sd2_a, sd2 ) \
    (u32)( \
    ((u32)(ds_wl) << REG_OS_IDR_ACT2_DS_WL_SHIFT) | \
    ((u32)(i2c3) << REG_OS_IDR_ACT2_I2C3_SHIFT) | \
...
#define REG_OS_IDR_ACT3_PMUIRQ7_SHIFT                      31
#define REG_OS_IDR_ACT3_PMUIRQ7_SIZE                       1
#define REG_OS_IDR_ACT3_PMUIRQ7_MASK                       0x80000000

#define REG_OS_IDR_ACT3_PMUIRQ6_SHIFT                      30
#define REG_OS_IDR_ACT3_PMUIRQ6_SIZE                       1
#define REG_OS_IDR_ACT3_PMUIRQ6_MASK                       0x40000000

#define REG_OS_IDR_ACT3_PMUIRQ5_SHIFT                      29
#define REG_OS_IDR_ACT3_PMUIRQ5_SIZE                       1
#define REG_OS_IDR_ACT3_PMUIRQ5_MASK                       0x20000000

#define REG_OS_IDR_ACT3_PMUIRQ4_SHIFT                      28
#define REG_OS_IDR_ACT3_PMUIRQ4_SIZE                       1
#define REG_OS_IDR_ACT3_PMUIRQ4_MASK                       0x10000000

#define REG_OS_IDR_ACT3_PMUIRQ3_SHIFT                      27
#define REG_OS_IDR_ACT3_PMUIRQ3_SIZE                       1
#define REG_OS_IDR_ACT3_PMUIRQ3_MASK                       0x08000000

#define REG_OS_IDR_ACT3_PMUIRQ2_SHIFT                      26
#define REG_OS_IDR_ACT3_PMUIRQ2_SIZE                       1
#define REG_OS_IDR_ACT3_PMUIRQ2_MASK                       0x04000000
...
#define REG_OS_IDR_ACT3_SPM_SHIFT                          23
#define REG_OS_IDR_ACT3_SPM_SIZE                           1
#define REG_OS_IDR_ACT3_SPM_MASK                           0x00800000

#define REG_OS_IDR_ACT3_L2_SHIFT                           22
#define REG_OS_IDR_ACT3_L2_SIZE                            1
#define REG_OS_IDR_ACT3_L2_MASK                            0x00400000
...
#define REG_OS_IDR_ACT3_GPIO3_18_5_SHIFT                   19
#define REG_OS_IDR_ACT3_GPIO3_18_5_SIZE                    1
#define REG_OS_IDR_ACT3_GPIO3_18_5_MASK                    0x00080000

#define REG_OS_IDR_ACT3_GPIO3_18_4_SHIFT                   18
#define REG_OS_IDR_ACT3_GPIO3_18_4_SIZE                    1
#define REG_OS_IDR_ACT3_GPIO3_18_4_MASK                    0x00040000

#define REG_OS_IDR_ACT3_GPIO3_18_3_SHIFT                   17
#define REG_OS_IDR_ACT3_GPIO3_18_3_SIZE                    1
#define REG_OS_IDR_ACT3_GPIO3_18_3_MASK                    0x00020000

#define REG_OS_IDR_ACT3_GPIO3_18_2_SHIFT                   16
#define REG_OS_IDR_ACT3_GPIO3_18_2_SIZE                    1
#define REG_OS_IDR_ACT3_GPIO3_18_2_MASK                    0x00010000

#define REG_OS_IDR_ACT3_GPIO3_18_1_SHIFT                   15
#define REG_OS_IDR_ACT3_GPIO3_18_1_SIZE                    1
#define REG_OS_IDR_ACT3_GPIO3_18_1_MASK                    0x00008000

#define REG_OS_IDR_ACT3_GPIO3_18_0_SHIFT                   14
#define REG_OS_IDR_ACT3_GPIO3_18_0_SIZE                    1
#define REG_OS_IDR_ACT3_GPIO3_18_0_MASK                    0x00004000
...
#define REG_OS_IDR_ACT3_IR_SHIFT                           10
#define REG_OS_IDR_ACT3_IR_SIZE                            1
#define REG_OS_IDR_ACT3_IR_MASK                            0x00000400
...
#define REG_OS_IDR_ACT3_TP_SHIFT                           3
#define REG_OS_IDR_ACT3_TP_SIZE                            1
#define REG_OS_IDR_ACT3_TP_MASK                            0x00000008

#define REG_OS_IDR_ACT3_COVER_R_SHIFT                      2
#define REG_OS_IDR_ACT3_COVER_R_SIZE                       1
#define REG_OS_IDR_ACT3_COVER_R_MASK                       0x00000004
...
#ifndef SDK_ASM
#define REG_OS_IDR_ACT3_FIELD( pmuirq7, pmuirq6, pmuirq5, pmuirq4, pmuirq3, pmuirq2, pmuirq1, pmuirq0, spm, l2, cgc_det, cgc_i, gpio3_18_5, gpio3_18_4, gpio3_18_3, gpio3_18_2, gpio3_18_1, gpio3_18_0, gpio3_33_5, gpio3_33_4, gpio3_33_3, gpio3_33_2, gpio3_33_1, gpio3_33_0, ctr_mcu, rmc, ir, sp_sel, twl_depop, twl_mcu, hp, tp, cover_r, cover ) \
    (u32)( \
    ...
    ((u32)(pmuirq3) << REG_OS_IDR_ACT3_PMUIRQ3_SHIFT) | \
    ((u32)(pmuirq2) << REG_OS_IDR_ACT3_PMUIRQ2_SHIFT) | \
    ((u32)(pmuirq1) << REG_OS_IDR_ACT3_PMUIRQ1_SHIFT) | \
    ((u32)(pmuirq0) << REG_OS_IDR_ACT3_PMUIRQ0_SHIFT) | \
    ((u32)(spm) << REG_OS_IDR_ACT3_SPM_SHIFT) | \
    ((u32)(l2) << REG_OS_IDR_ACT3_L2_SHIFT) | \
    ((u32)(cgc_det) << REG_OS_IDR_ACT3_CGC_DET_SHIFT) | \
    ((u32)(cgc_i) << REG_OS_IDR_ACT3_CGC_I_SHIFT) | \
    ((u32)(gpio3_18_5) << REG_OS_IDR_ACT3_GPIO3_18_5_SHIFT) | \
    ((u32)(gpio3_18_4) << REG_OS_IDR_ACT3_GPIO3_18_4_SHIFT) | \
    ...
    ((u32)(ir) << REG_OS_IDR_ACT3_IR_SHIFT) | \
    ...
    ((u32)(tp) << REG_OS_IDR_ACT3_TP_SHIFT) | \
    ((u32)(cover_r) << REG_OS_IDR_ACT3_COVER_R_SHIFT) | \
...
#define REG_OS_IDR_CFG6_IR_1N_SHIFT                        21
#define REG_OS_IDR_CFG6_IR_1N_SIZE                         1
#define REG_OS_IDR_CFG6_IR_1N_MASK                         0x00200000

#define REG_OS_IDR_CFG6_IR_TRG_SHIFT                       20
#define REG_OS_IDR_CFG6_IR_TRG_SIZE                        1
#define REG_OS_IDR_CFG6_IR_TRG_MASK                        0x00100000
...
#define REG_OS_IDR_CFG6_FIELD( gpio3_33_7_1n, gpio3_33_7_trg, gpio3_33_6_1n, gpio3_33_6_trg, gpio3_33_5_1n, gpio3_33_5_trg, gpio3_33_4_1n, gpio3_33_4_trg, gpio3_33_3_1n, gpio3_33_3_trg, gpio3_33_2_1n, gpio3_33_2_trg, gpio3_33_1_1n, gpio3_33_1_trg, gpio3_33_0_1n, gpio3_33_0_trg, ir_1n, ir_trg, sp_sel_1n, sp_sel_trg, twl_depop_1n, twl_depop_trg, twl_mcu_1n, twl_mcu_trg, hp_1n, hp_trg, rtc_1n, rtc_trg, cover_1n, cover_trg ) \
    ...
    ((u32)(ir_1n) << REG_OS_IDR_CFG6_IR_1N_SHIFT) | \
    ((u32)(ir_trg) << REG_OS_IDR_CFG6_IR_TRG_SHIFT) | \
...
#define REG_OS_IDR_CFG7_PMUIRQ7_1N_SHIFT                   31
#define REG_OS_IDR_CFG7_PMUIRQ7_1N_SIZE                    1
#define REG_OS_IDR_CFG7_PMUIRQ7_1N_MASK                    0x80000000

#define REG_OS_IDR_CFG7_PMUIRQ7_TRG_SHIFT                  30
#define REG_OS_IDR_CFG7_PMUIRQ7_TRG_SIZE                   1
#define REG_OS_IDR_CFG7_PMUIRQ7_TRG_MASK                   0x40000000

#define REG_OS_IDR_CFG7_PMUIRQ6_1N_SHIFT                   29
#define REG_OS_IDR_CFG7_PMUIRQ6_1N_SIZE                    1
#define REG_OS_IDR_CFG7_PMUIRQ6_1N_MASK                    0x20000000

#define REG_OS_IDR_CFG7_PMUIRQ6_TRG_SHIFT                  28
#define REG_OS_IDR_CFG7_PMUIRQ6_TRG_SIZE                   1
#define REG_OS_IDR_CFG7_PMUIRQ6_TRG_MASK                   0x10000000

#define REG_OS_IDR_CFG7_PMUIRQ5_1N_SHIFT                   27
#define REG_OS_IDR_CFG7_PMUIRQ5_1N_SIZE                    1
#define REG_OS_IDR_CFG7_PMUIRQ5_1N_MASK                    0x08000000

#define REG_OS_IDR_CFG7_PMUIRQ5_TRG_SHIFT                  26
#define REG_OS_IDR_CFG7_PMUIRQ5_TRG_SIZE                   1
#define REG_OS_IDR_CFG7_PMUIRQ5_TRG_MASK                   0x04000000

#define REG_OS_IDR_CFG7_PMUIRQ4_1N_SHIFT                   25
#define REG_OS_IDR_CFG7_PMUIRQ4_1N_SIZE                    1
#define REG_OS_IDR_CFG7_PMUIRQ4_1N_MASK                    0x02000000

#define REG_OS_IDR_CFG7_PMUIRQ4_TRG_SHIFT                  24
#define REG_OS_IDR_CFG7_PMUIRQ4_TRG_SIZE                   1
#define REG_OS_IDR_CFG7_PMUIRQ4_TRG_MASK                   0x01000000

#define REG_OS_IDR_CFG7_PMUIRQ3_1N_SHIFT                   23
#define REG_OS_IDR_CFG7_PMUIRQ3_1N_SIZE                    1
#define REG_OS_IDR_CFG7_PMUIRQ3_1N_MASK                    0x00800000

#define REG_OS_IDR_CFG7_PMUIRQ3_TRG_SHIFT                  22
#define REG_OS_IDR_CFG7_PMUIRQ3_TRG_SIZE                   1
#define REG_OS_IDR_CFG7_PMUIRQ3_TRG_MASK                   0x00400000

#define REG_OS_IDR_CFG7_PMUIRQ2_1N_SHIFT                   21
#define REG_OS_IDR_CFG7_PMUIRQ2_1N_SIZE                    1
#define REG_OS_IDR_CFG7_PMUIRQ2_1N_MASK                    0x00200000

#define REG_OS_IDR_CFG7_PMUIRQ2_TRG_SHIFT                  20
#define REG_OS_IDR_CFG7_PMUIRQ2_TRG_SIZE                   1
#define REG_OS_IDR_CFG7_PMUIRQ2_TRG_MASK                   0x00100000
...
#define REG_OS_IDR_CFG7_SPM_1N_SHIFT                       15
#define REG_OS_IDR_CFG7_SPM_1N_SIZE                        1
#define REG_OS_IDR_CFG7_SPM_1N_MASK                        0x00008000

#define REG_OS_IDR_CFG7_SPM_TRG_SHIFT                      14
#define REG_OS_IDR_CFG7_SPM_TRG_SIZE                       1
#define REG_OS_IDR_CFG7_SPM_TRG_MASK                       0x00004000

#define REG_OS_IDR_CFG7_L2_1N_SHIFT                        13
#define REG_OS_IDR_CFG7_L2_1N_SIZE                         1
#define REG_OS_IDR_CFG7_L2_1N_MASK                         0x00002000

#define REG_OS_IDR_CFG7_L2_TRG_SHIFT                       12
#define REG_OS_IDR_CFG7_L2_TRG_SIZE                        1
#define REG_OS_IDR_CFG7_L2_TRG_MASK                        0x00001000
...
#define REG_OS_IDR_CFG7_CGC_DET_TRG_SHIFT                  10
#define REG_OS_IDR_CFG7_CGC_DET_TRG_SIZE                   1
#define REG_OS_IDR_CFG7_CGC_DET_TRG_MASK                   0x00000400

#define REG_OS_IDR_CFG7_CGC_I_1N_SHIFT                     9
#define REG_OS_IDR_CFG7_CGC_I_1N_SIZE                      1
#define REG_OS_IDR_CFG7_CGC_I_1N_MASK                      0x00000200
...
#define REG_OS_IDR_CFG7_FIELD( pmuirq7_1n, pmuirq7_trg, pmuirq6_1n, pmuirq6_trg, pmuirq5_1n, pmuirq5_trg, pmuirq4_1n, pmuirq4_trg, pmuirq3_1n, pmuirq3_trg, pmuirq2_1n, pmuirq2_trg, pmuirq1_1n, pmuirq1_trg, pmuirq0_1n, pmuirq0_trg, spm_1n, spm_trg, l2_1n, l2_trg, cgc_det_1n, cgc_det_trg, cgc_i_1n, cgc_i_trg, gpio3_18_3_1n, gpio3_18_3_trg, gpio3_18_2_1n, gpio3_18_2_trg, gpio3_18_1_1n, gpio3_18_1_trg, gpio3_18_0_1n, gpio3_18_0_trg, ctr_mcu_1n, ctr_mcu_trg, rmc_1n, rmc_trg ) \
    ...
    ((u32)(pmuirq3_1n) << REG_OS_IDR_CFG7_PMUIRQ3_1N_SHIFT) | \
    ((u32)(pmuirq3_trg) << REG_OS_IDR_CFG7_PMUIRQ3_TRG_SHIFT) | \
    ((u32)(pmuirq2_1n) << REG_OS_IDR_CFG7_PMUIRQ2_1N_SHIFT) | \
    ((u32)(pmuirq2_trg) << REG_OS_IDR_CFG7_PMUIRQ2_TRG_SHIFT) | \
    ...
    ((u32)(spm_1n) << REG_OS_IDR_CFG7_SPM_1N_SHIFT) | \
    ((u32)(spm_trg) << REG_OS_IDR_CFG7_SPM_TRG_SHIFT) | \
    ((u32)(l2_1n) << REG_OS_IDR_CFG7_L2_1N_SHIFT) | \
    ((u32)(l2_trg) << REG_OS_IDR_CFG7_L2_TRG_SHIFT) | \
...
#define REG_OS_L2_CACHE_ID_IMPLEMENTER_SHIFT               24
#define REG_OS_L2_CACHE_ID_IMPLEMENTER_SIZE                8
#define REG_OS_L2_CACHE_ID_IMPLEMENTER_MASK                0xff000000

#define REG_OS_L2_CACHE_ID_ID_SHIFT                        10
#define REG_OS_L2_CACHE_ID_ID_SIZE                         6
#define REG_OS_L2_CACHE_ID_ID_MASK                         0x0000fc00

#define REG_OS_L2_CACHE_ID_PART_NUM_SHIFT                  6
#define REG_OS_L2_CACHE_ID_PART_NUM_SIZE                   4
#define REG_OS_L2_CACHE_ID_PART_NUM_MASK                   0x000003c0

#define REG_OS_L2_CACHE_ID_RTL_RELEASE_SHIFT               0
#define REG_OS_L2_CACHE_ID_RTL_RELEASE_SIZE                6
#define REG_OS_L2_CACHE_ID_RTL_RELEASE_MASK                0x0000003f

#ifndef SDK_ASM
#define REG_OS_L2_CACHE_ID_FIELD( implementer, id, part_num, rtl_release ) \
    (u32)( \
    ((u32)(implementer) << REG_OS_L2_CACHE_ID_IMPLEMENTER_SHIFT) | \
    ((u32)(id) << REG_OS_L2_CACHE_ID_ID_SHIFT) | \
    ((u32)(part_num) << REG_OS_L2_CACHE_ID_PART_NUM_SHIFT) | \
    ((u32)(rtl_release) << REG_OS_L2_CACHE_ID_RTL_RELEASE_SHIFT))
#endif


/* L2_CACHE_TYPE */

#define REG_OS_L2_CACHE_TYPE_DATA_BANKING_SHIFT            31
#define REG_OS_L2_CACHE_TYPE_DATA_BANKING_SIZE             1
#define REG_OS_L2_CACHE_TYPE_DATA_BANKING_MASK             0x80000000

#define REG_OS_L2_CACHE_TYPE_CTYPE_SHIFT                   25
#define REG_OS_L2_CACHE_TYPE_CTYPE_SIZE                    4
#define REG_OS_L2_CACHE_TYPE_CTYPE_MASK                    0x1e000000

#define REG_OS_L2_CACHE_TYPE_H_SHIFT                       24
#define REG_OS_L2_CACHE_TYPE_H_SIZE                        1
#define REG_OS_L2_CACHE_TYPE_H_MASK                        0x01000000

#define REG_OS_L2_CACHE_TYPE_DSIZE_SHIFT                   19
#define REG_OS_L2_CACHE_TYPE_DSIZE_SIZE                    5
#define REG_OS_L2_CACHE_TYPE_DSIZE_MASK                    0x00f80000

#define REG_OS_L2_CACHE_TYPE_ASSOC1_SHIFT                  18
#define REG_OS_L2_CACHE_TYPE_ASSOC1_SIZE                   1
#define REG_OS_L2_CACHE_TYPE_ASSOC1_MASK                   0x00040000

#define REG_OS_L2_CACHE_TYPE_CACHE_LINE_LEN1_SHIFT         12
#define REG_OS_L2_CACHE_TYPE_CACHE_LINE_LEN1_SIZE          2
#define REG_OS_L2_CACHE_TYPE_CACHE_LINE_LEN1_MASK          0x00003000

#define REG_OS_L2_CACHE_TYPE_ISIZE_SHIFT                   7
#define REG_OS_L2_CACHE_TYPE_ISIZE_SIZE                    5
#define REG_OS_L2_CACHE_TYPE_ISIZE_MASK                    0x00000f80

#define REG_OS_L2_CACHE_TYPE_ASSOC0_SHIFT                  6
#define REG_OS_L2_CACHE_TYPE_ASSOC0_SIZE                   1
#define REG_OS_L2_CACHE_TYPE_ASSOC0_MASK                   0x00000040

#define REG_OS_L2_CACHE_TYPE_CACHE_LINE_LEN0_SHIFT         0
#define REG_OS_L2_CACHE_TYPE_CACHE_LINE_LEN0_SIZE          2
#define REG_OS_L2_CACHE_TYPE_CACHE_LINE_LEN0_MASK          0x00000003

#ifndef SDK_ASM
#define REG_OS_L2_CACHE_TYPE_FIELD( data_banking, ctype, h, dsize, assoc1, cache_line_len1, isize, assoc0, cache_line_len0 ) \
    (u32)( \
    ((u32)(data_banking) << REG_OS_L2_CACHE_TYPE_DATA_BANKING_SHIFT) | \
    ((u32)(ctype) << REG_OS_L2_CACHE_TYPE_CTYPE_SHIFT) | \
    ((u32)(h) << REG_OS_L2_CACHE_TYPE_H_SHIFT) | \
    ((u32)(dsize) << REG_OS_L2_CACHE_TYPE_DSIZE_SHIFT) | \
    ((u32)(assoc1) << REG_OS_L2_CACHE_TYPE_ASSOC1_SHIFT) | \
    ((u32)(cache_line_len1) << REG_OS_L2_CACHE_TYPE_CACHE_LINE_LEN1_SHIFT) | \
    ((u32)(isize) << REG_OS_L2_CACHE_TYPE_ISIZE_SHIFT) | \
    ((u32)(assoc0) << REG_OS_L2_CACHE_TYPE_ASSOC0_SHIFT) | \
    ((u32)(cache_line_len0) << REG_OS_L2_CACHE_TYPE_CACHE_LINE_LEN0_SHIFT))
#endif


/* L2_CTRL */

#define REG_OS_L2_CTRL_EN_SHIFT                            0
#define REG_OS_L2_CTRL_EN_SIZE                             1
#define REG_OS_L2_CTRL_EN_MASK                             0x01

#ifndef SDK_ASM
#define REG_OS_L2_CTRL_FIELD( en ) \
    (u8)( \
    ((u32)(en) << REG_OS_L2_CTRL_EN_SHIFT))
#endif


/* L2_AUX_CTRL */

#define REG_OS_L2_AUX_CTRL_EARLY_BRESP_EN_SHIFT            30
#define REG_OS_L2_AUX_CTRL_EARLY_BRESP_EN_SIZE             1
#define REG_OS_L2_AUX_CTRL_EARLY_BRESP_EN_MASK             0x40000000

#define REG_OS_L2_AUX_CTRL_I_PREFETCH_EN_SHIFT             29
#define REG_OS_L2_AUX_CTRL_I_PREFETCH_EN_SIZE              1
#define REG_OS_L2_AUX_CTRL_I_PREFETCH_EN_MASK              0x20000000

#define REG_OS_L2_AUX_CTRL_D_PREFETCH_EN_SHIFT             28
#define REG_OS_L2_AUX_CTRL_D_PREFETCH_EN_SIZE              1
#define REG_OS_L2_AUX_CTRL_D_PREFETCH_EN_MASK              0x10000000

#define REG_OS_L2_AUX_CTRL_NON_SECURE_INT_ACCESS_CNTR_SHIFT 27
#define REG_OS_L2_AUX_CTRL_NON_SECURE_INT_ACCESS_CNTR_SIZE 1
#define REG_OS_L2_AUX_CTRL_NON_SECURE_INT_ACCESS_CNTR_MASK 0x08000000

#define REG_OS_L2_AUX_CTRL_NON_SECURE_LOCKDOWN_EN_SHIFT    26
#define REG_OS_L2_AUX_CTRL_NON_SECURE_LOCKDOWN_EN_SIZE     1
#define REG_OS_L2_AUX_CTRL_NON_SECURE_LOCKDOWN_EN_MASK     0x04000000

#define REG_OS_L2_AUX_CTRL_CACHE_REPLACEMENT_POLICY_SHIFT  25
#define REG_OS_L2_AUX_CTRL_CACHE_REPLACEMENT_POLICY_SIZE   1
#define REG_OS_L2_AUX_CTRL_CACHE_REPLACEMENT_POLICY_MASK   0x02000000

#define REG_OS_L2_AUX_CTRL_FORCE_WRITE_ALLOC_SHIFT         23
#define REG_OS_L2_AUX_CTRL_FORCE_WRITE_ALLOC_SIZE          2
#define REG_OS_L2_AUX_CTRL_FORCE_WRITE_ALLOC_MASK          0x01800000

#define REG_OS_L2_AUX_CTRL_SHARED_ATTR_OVERRIDE_EN_SHIFT   22
#define REG_OS_L2_AUX_CTRL_SHARED_ATTR_OVERRIDE_EN_SIZE    1
#define REG_OS_L2_AUX_CTRL_SHARED_ATTR_OVERRIDE_EN_MASK    0x00400000

#define REG_OS_L2_AUX_CTRL_PARITY_EN_SHIFT                 21
#define REG_OS_L2_AUX_CTRL_PARITY_EN_SIZE                  1
#define REG_OS_L2_AUX_CTRL_PARITY_EN_MASK                  0x00200000

#define REG_OS_L2_AUX_CTRL_EVENT_MONITOR_BUS_EN_SHIFT      20
#define REG_OS_L2_AUX_CTRL_EVENT_MONITOR_BUS_EN_SIZE       1
#define REG_OS_L2_AUX_CTRL_EVENT_MONITOR_BUS_EN_MASK       0x00100000

#define REG_OS_L2_AUX_CTRL_WAY_SIZE_SHIFT                  17
#define REG_OS_L2_AUX_CTRL_WAY_SIZE_SIZE                   3
#define REG_OS_L2_AUX_CTRL_WAY_SIZE_MASK                   0x000e0000

#define REG_OS_L2_AUX_CTRL_ASSOC_SHIFT                     16
#define REG_OS_L2_AUX_CTRL_ASSOC_SIZE                      1
#define REG_OS_L2_AUX_CTRL_ASSOC_MASK                      0x00010000

#define REG_OS_L2_AUX_CTRL_SHARED_ATTR_INV_EN_SHIFT        13
#define REG_OS_L2_AUX_CTRL_SHARED_ATTR_INV_EN_SIZE         1
#define REG_OS_L2_AUX_CTRL_SHARED_ATTR_INV_EN_MASK         0x00002000

#define REG_OS_L2_AUX_CTRL_EX_CACHE_CFG_SHIFT              12
#define REG_OS_L2_AUX_CTRL_EX_CACHE_CFG_SIZE               1
#define REG_OS_L2_AUX_CTRL_EX_CACHE_CFG_MASK               0x00001000

#define REG_OS_L2_AUX_CTRL_STORE_BUF_DEV_LIMIT_EN_SHIFT    11
#define REG_OS_L2_AUX_CTRL_STORE_BUF_DEV_LIMIT_EN_SIZE     1
#define REG_OS_L2_AUX_CTRL_STORE_BUF_DEV_LIMIT_EN_MASK     0x00000800

#define REG_OS_L2_AUX_CTRL_HI_PRI_SO_DEV_SHIFT             10
#define REG_OS_L2_AUX_CTRL_HI_PRI_SO_DEV_SIZE              1
#define REG_OS_L2_AUX_CTRL_HI_PRI_SO_DEV_MASK              0x00000400

#define REG_OS_L2_AUX_CTRL_FULL_LINE_ZERO_EN_SHIFT         0
#define REG_OS_L2_AUX_CTRL_FULL_LINE_ZERO_EN_SIZE          1
#define REG_OS_L2_AUX_CTRL_FULL_LINE_ZERO_EN_MASK          0x00000001

#ifndef SDK_ASM
#define REG_OS_L2_AUX_CTRL_FIELD( early_bresp_en, i_prefetch_en, d_prefetch_en, non_secure_int_access_cntr, non_secure_lockdown_en, cache_replacement_policy, force_write_alloc, shared_attr_override_en, parity_en, event_monitor_bus_en, way_size, assoc, shared_attr_inv_en, ex_cache_cfg, store_buf_dev_limit_en, hi_pri_so_dev, full_line_zero_en ) \
    (u32)( \
    ((u32)(early_bresp_en) << REG_OS_L2_AUX_CTRL_EARLY_BRESP_EN_SHIFT) | \
    ((u32)(i_prefetch_en) << REG_OS_L2_AUX_CTRL_I_PREFETCH_EN_SHIFT) | \
    ((u32)(d_prefetch_en) << REG_OS_L2_AUX_CTRL_D_PREFETCH_EN_SHIFT) | \
    ((u32)(non_secure_int_access_cntr) << REG_OS_L2_AUX_CTRL_NON_SECURE_INT_ACCESS_CNTR_SHIFT) | \
    ((u32)(non_secure_lockdown_en) << REG_OS_L2_AUX_CTRL_NON_SECURE_LOCKDOWN_EN_SHIFT) | \
    ((u32)(cache_replacement_policy) << REG_OS_L2_AUX_CTRL_CACHE_REPLACEMENT_POLICY_SHIFT) | \
    ((u32)(force_write_alloc) << REG_OS_L2_AUX_CTRL_FORCE_WRITE_ALLOC_SHIFT) | \
    ((u32)(shared_attr_override_en) << REG_OS_L2_AUX_CTRL_SHARED_ATTR_OVERRIDE_EN_SHIFT) | \
    ((u32)(parity_en) << REG_OS_L2_AUX_CTRL_PARITY_EN_SHIFT) | \
    ((u32)(event_monitor_bus_en) << REG_OS_L2_AUX_CTRL_EVENT_MONITOR_BUS_EN_SHIFT) | \
    ((u32)(way_size) << REG_OS_L2_AUX_CTRL_WAY_SIZE_SHIFT) | \
    ((u32)(assoc) << REG_OS_L2_AUX_CTRL_ASSOC_SHIFT) | \
    ((u32)(shared_attr_inv_en) << REG_OS_L2_AUX_CTRL_SHARED_ATTR_INV_EN_SHIFT) | \
    ((u32)(ex_cache_cfg) << REG_OS_L2_AUX_CTRL_EX_CACHE_CFG_SHIFT) | \
    ((u32)(store_buf_dev_limit_en) << REG_OS_L2_AUX_CTRL_STORE_BUF_DEV_LIMIT_EN_SHIFT) | \
    ((u32)(hi_pri_so_dev) << REG_OS_L2_AUX_CTRL_HI_PRI_SO_DEV_SHIFT) | \
    ((u32)(full_line_zero_en) << REG_OS_L2_AUX_CTRL_FULL_LINE_ZERO_EN_SHIFT))
#endif


/* L2_TAG_RAM_CTRL */

#define REG_OS_L2_TAG_RAM_CTRL_WRITE_ACCESS_LATENCY_SHIFT  8
#define REG_OS_L2_TAG_RAM_CTRL_WRITE_ACCESS_LATENCY_SIZE   3
#define REG_OS_L2_TAG_RAM_CTRL_WRITE_ACCESS_LATENCY_MASK   0x0700

#define REG_OS_L2_TAG_RAM_CTRL_READ_ACCESS_LATENCY_SHIFT   4
#define REG_OS_L2_TAG_RAM_CTRL_READ_ACCESS_LATENCY_SIZE    3
#define REG_OS_L2_TAG_RAM_CTRL_READ_ACCESS_LATENCY_MASK    0x0070

#define REG_OS_L2_TAG_RAM_CTRL_SETUP_LATENCY_SHIFT         0
#define REG_OS_L2_TAG_RAM_CTRL_SETUP_LATENCY_SIZE          3
#define REG_OS_L2_TAG_RAM_CTRL_SETUP_LATENCY_MASK          0x0007

#ifndef SDK_ASM
#define REG_OS_L2_TAG_RAM_CTRL_FIELD( write_access_latency, read_access_latency, setup_latency ) \
    (u16)( \
    ((u32)(write_access_latency) << REG_OS_L2_TAG_RAM_CTRL_WRITE_ACCESS_LATENCY_SHIFT) | \
    ((u32)(read_access_latency) << REG_OS_L2_TAG_RAM_CTRL_READ_ACCESS_LATENCY_SHIFT) | \
    ((u32)(setup_latency) << REG_OS_L2_TAG_RAM_CTRL_SETUP_LATENCY_SHIFT))
#endif


/* L2_DATA_RAM_CTRL */

#define REG_OS_L2_DATA_RAM_CTRL_WRITE_ACCESS_LATENCY_SHIFT 8
#define REG_OS_L2_DATA_RAM_CTRL_WRITE_ACCESS_LATENCY_SIZE  3
#define REG_OS_L2_DATA_RAM_CTRL_WRITE_ACCESS_LATENCY_MASK  0x0700

#define REG_OS_L2_DATA_RAM_CTRL_READ_ACCESS_LATENCY_SHIFT  4
#define REG_OS_L2_DATA_RAM_CTRL_READ_ACCESS_LATENCY_SIZE   3
#define REG_OS_L2_DATA_RAM_CTRL_READ_ACCESS_LATENCY_MASK   0x0070

#define REG_OS_L2_DATA_RAM_CTRL_SETUP_LATENCY_SHIFT        0
#define REG_OS_L2_DATA_RAM_CTRL_SETUP_LATENCY_SIZE         3
#define REG_OS_L2_DATA_RAM_CTRL_SETUP_LATENCY_MASK         0x0007

#ifndef SDK_ASM
#define REG_OS_L2_DATA_RAM_CTRL_FIELD( write_access_latency, read_access_latency, setup_latency ) \
    (u16)( \
    ((u32)(write_access_latency) << REG_OS_L2_DATA_RAM_CTRL_WRITE_ACCESS_LATENCY_SHIFT) | \
    ((u32)(read_access_latency) << REG_OS_L2_DATA_RAM_CTRL_READ_ACCESS_LATENCY_SHIFT) | \
    ((u32)(setup_latency) << REG_OS_L2_DATA_RAM_CTRL_SETUP_LATENCY_SHIFT))
#endif


/* L2_EV_COUNTER_CTRL */

#define REG_OS_L2_EV_COUNTER_CTRL_RESET_SHIFT              1
#define REG_OS_L2_EV_COUNTER_CTRL_RESET_SIZE               2
#define REG_OS_L2_EV_COUNTER_CTRL_RESET_MASK               0x06

#define REG_OS_L2_EV_COUNTER_CTRL_EV_COUNTER_EN_SHIFT      0
#define REG_OS_L2_EV_COUNTER_CTRL_EV_COUNTER_EN_SIZE       1
#define REG_OS_L2_EV_COUNTER_CTRL_EV_COUNTER_EN_MASK       0x01

#ifndef SDK_ASM
#define REG_OS_L2_EV_COUNTER_CTRL_FIELD( reset, ev_counter_en ) \
    (u8)( \
    ((u32)(reset) << REG_OS_L2_EV_COUNTER_CTRL_RESET_SHIFT) | \
    ((u32)(ev_counter_en) << REG_OS_L2_EV_COUNTER_CTRL_EV_COUNTER_EN_SHIFT))
#endif


/* L2_EV_COUNTER1_CFG */

#define REG_OS_L2_EV_COUNTER1_CFG_EV_SOURCE_SHIFT          2
#define REG_OS_L2_EV_COUNTER1_CFG_EV_SOURCE_SIZE           4
#define REG_OS_L2_EV_COUNTER1_CFG_EV_SOURCE_MASK           0x3c

#define REG_OS_L2_EV_COUNTER1_CFG_EV_COUNTER_INT_GEN_SHIFT 0
#define REG_OS_L2_EV_COUNTER1_CFG_EV_COUNTER_INT_GEN_SIZE  2
#define REG_OS_L2_EV_COUNTER1_CFG_EV_COUNTER_INT_GEN_MASK  0x03

#ifndef SDK_ASM
#define REG_OS_L2_EV_COUNTER1_CFG_FIELD( ev_source, ev_counter_int_gen ) \
    (u8)( \
    ((u32)(ev_source) << REG_OS_L2_EV_COUNTER1_CFG_EV_SOURCE_SHIFT) | \
    ((u32)(ev_counter_int_gen) << REG_OS_L2_EV_COUNTER1_CFG_EV_COUNTER_INT_GEN_SHIFT))
#endif


/* L2_EV_COUNTER0_CFG */

#define REG_OS_L2_EV_COUNTER0_CFG_EV_SOURCE_SHIFT          2
#define REG_OS_L2_EV_COUNTER0_CFG_EV_SOURCE_SIZE           4
#define REG_OS_L2_EV_COUNTER0_CFG_EV_SOURCE_MASK           0x3c

#define REG_OS_L2_EV_COUNTER0_CFG_EV_COUNTER_INT_GEN_SHIFT 0
#define REG_OS_L2_EV_COUNTER0_CFG_EV_COUNTER_INT_GEN_SIZE  2
#define REG_OS_L2_EV_COUNTER0_CFG_EV_COUNTER_INT_GEN_MASK  0x03

#ifndef SDK_ASM
#define REG_OS_L2_EV_COUNTER0_CFG_FIELD( ev_source, ev_counter_int_gen ) \
    (u8)( \
    ((u32)(ev_source) << REG_OS_L2_EV_COUNTER0_CFG_EV_SOURCE_SHIFT) | \
    ((u32)(ev_counter_int_gen) << REG_OS_L2_EV_COUNTER0_CFG_EV_COUNTER_INT_GEN_SHIFT))
#endif
...
#define REG_OS_L2_INT_MASK_DECERR_SHIFT                    8
#define REG_OS_L2_INT_MASK_DECERR_SIZE                     1
#define REG_OS_L2_INT_MASK_DECERR_MASK                     0x0100

#define REG_OS_L2_INT_MASK_SLVERR_SHIFT                    7
#define REG_OS_L2_INT_MASK_SLVERR_SIZE                     1
#define REG_OS_L2_INT_MASK_SLVERR_MASK                     0x0080

#define REG_OS_L2_INT_MASK_ERRRD_SHIFT                     6
#define REG_OS_L2_INT_MASK_ERRRD_SIZE                      1
#define REG_OS_L2_INT_MASK_ERRRD_MASK                      0x0040

#define REG_OS_L2_INT_MASK_ERRRT_SHIFT                     5
#define REG_OS_L2_INT_MASK_ERRRT_SIZE                      1
#define REG_OS_L2_INT_MASK_ERRRT_MASK                      0x0020

#define REG_OS_L2_INT_MASK_ERRWD_SHIFT                     4
#define REG_OS_L2_INT_MASK_ERRWD_SIZE                      1
#define REG_OS_L2_INT_MASK_ERRWD_MASK                      0x0010

#define REG_OS_L2_INT_MASK_ERRWT_SHIFT                     3
#define REG_OS_L2_INT_MASK_ERRWT_SIZE                      1
#define REG_OS_L2_INT_MASK_ERRWT_MASK                      0x0008

#define REG_OS_L2_INT_MASK_PARRD_SHIFT                     2
#define REG_OS_L2_INT_MASK_PARRD_SIZE                      1
#define REG_OS_L2_INT_MASK_PARRD_MASK                      0x0004

#define REG_OS_L2_INT_MASK_PARRT_SHIFT                     1
#define REG_OS_L2_INT_MASK_PARRT_SIZE                      1
#define REG_OS_L2_INT_MASK_PARRT_MASK                      0x0002

#define REG_OS_L2_INT_MASK_ECNTR_SHIFT                     0
#define REG_OS_L2_INT_MASK_ECNTR_SIZE                      1
#define REG_OS_L2_INT_MASK_ECNTR_MASK                      0x0001

#ifndef SDK_ASM
#define REG_OS_L2_INT_MASK_FIELD( decerr, slverr, errrd, errrt, errwd, errwt, parrd, parrt, ecntr ) \
    (u16)( \
    ((u32)(decerr) << REG_OS_L2_INT_MASK_DECERR_SHIFT) | \
    ((u32)(slverr) << REG_OS_L2_INT_MASK_SLVERR_SHIFT) | \
    ((u32)(errrd) << REG_OS_L2_INT_MASK_ERRRD_SHIFT) | \
    ((u32)(errrt) << REG_OS_L2_INT_MASK_ERRRT_SHIFT) | \
    ((u32)(errwd) << REG_OS_L2_INT_MASK_ERRWD_SHIFT) | \
    ((u32)(errwt) << REG_OS_L2_INT_MASK_ERRWT_SHIFT) | \
    ((u32)(parrd) << REG_OS_L2_INT_MASK_PARRD_SHIFT) | \
    ((u32)(parrt) << REG_OS_L2_INT_MASK_PARRT_SHIFT) | \
    ((u32)(ecntr) << REG_OS_L2_INT_MASK_ECNTR_SHIFT))
#endif


/* L2_INT_MASK_STATUS */

#define REG_OS_L2_INT_MASK_STATUS_DECERR_SHIFT             8
#define REG_OS_L2_INT_MASK_STATUS_DECERR_SIZE              1
#define REG_OS_L2_INT_MASK_STATUS_DECERR_MASK              0x0100

#define REG_OS_L2_INT_MASK_STATUS_SLVERR_SHIFT             7
#define REG_OS_L2_INT_MASK_STATUS_SLVERR_SIZE              1
#define REG_OS_L2_INT_MASK_STATUS_SLVERR_MASK              0x0080

#define REG_OS_L2_INT_MASK_STATUS_ERRRD_SHIFT              6
#define REG_OS_L2_INT_MASK_STATUS_ERRRD_SIZE               1
#define REG_OS_L2_INT_MASK_STATUS_ERRRD_MASK               0x0040

#define REG_OS_L2_INT_MASK_STATUS_ERRRT_SHIFT              5
#define REG_OS_L2_INT_MASK_STATUS_ERRRT_SIZE               1
#define REG_OS_L2_INT_MASK_STATUS_ERRRT_MASK               0x0020

#define REG_OS_L2_INT_MASK_STATUS_ERRWD_SHIFT              4
#define REG_OS_L2_INT_MASK_STATUS_ERRWD_SIZE               1
#define REG_OS_L2_INT_MASK_STATUS_ERRWD_MASK               0x0010

#define REG_OS_L2_INT_MASK_STATUS_ERRWT_SHIFT              3
#define REG_OS_L2_INT_MASK_STATUS_ERRWT_SIZE               1
#define REG_OS_L2_INT_MASK_STATUS_ERRWT_MASK               0x0008

#define REG_OS_L2_INT_MASK_STATUS_PARRD_SHIFT              2
#define REG_OS_L2_INT_MASK_STATUS_PARRD_SIZE               1
#define REG_OS_L2_INT_MASK_STATUS_PARRD_MASK               0x0004

#define REG_OS_L2_INT_MASK_STATUS_PARRT_SHIFT              1
#define REG_OS_L2_INT_MASK_STATUS_PARRT_SIZE               1
#define REG_OS_L2_INT_MASK_STATUS_PARRT_MASK               0x0002

#define REG_OS_L2_INT_MASK_STATUS_ECNTR_SHIFT              0
#define REG_OS_L2_INT_MASK_STATUS_ECNTR_SIZE               1
#define REG_OS_L2_INT_MASK_STATUS_ECNTR_MASK               0x0001

#ifndef SDK_ASM
#define REG_OS_L2_INT_MASK_STATUS_FIELD( decerr, slverr, errrd, errrt, errwd, errwt, parrd, parrt, ecntr ) \
    (u16)( \
    ((u32)(decerr) << REG_OS_L2_INT_MASK_STATUS_DECERR_SHIFT) | \
    ((u32)(slverr) << REG_OS_L2_INT_MASK_STATUS_SLVERR_SHIFT) | \
    ((u32)(errrd) << REG_OS_L2_INT_MASK_STATUS_ERRRD_SHIFT) | \
    ((u32)(errrt) << REG_OS_L2_INT_MASK_STATUS_ERRRT_SHIFT) | \
    ((u32)(errwd) << REG_OS_L2_INT_MASK_STATUS_ERRWD_SHIFT) | \
    ((u32)(errwt) << REG_OS_L2_INT_MASK_STATUS_ERRWT_SHIFT) | \
    ((u32)(parrd) << REG_OS_L2_INT_MASK_STATUS_PARRD_SHIFT) | \
    ((u32)(parrt) << REG_OS_L2_INT_MASK_STATUS_PARRT_SHIFT) | \
    ((u32)(ecntr) << REG_OS_L2_INT_MASK_STATUS_ECNTR_SHIFT))
#endif


/* L2_INT_RAW_STATUS */

#define REG_OS_L2_INT_RAW_STATUS_DECERR_SHIFT              8
#define REG_OS_L2_INT_RAW_STATUS_DECERR_SIZE               1
#define REG_OS_L2_INT_RAW_STATUS_DECERR_MASK               0x0100

#define REG_OS_L2_INT_RAW_STATUS_SLVERR_SHIFT              7
#define REG_OS_L2_INT_RAW_STATUS_SLVERR_SIZE               1
#define REG_OS_L2_INT_RAW_STATUS_SLVERR_MASK               0x0080

#define REG_OS_L2_INT_RAW_STATUS_ERRRD_SHIFT               6
#define REG_OS_L2_INT_RAW_STATUS_ERRRD_SIZE                1
#define REG_OS_L2_INT_RAW_STATUS_ERRRD_MASK                0x0040

#define REG_OS_L2_INT_RAW_STATUS_ERRRT_SHIFT               5
#define REG_OS_L2_INT_RAW_STATUS_ERRRT_SIZE                1
#define REG_OS_L2_INT_RAW_STATUS_ERRRT_MASK                0x0020

#define REG_OS_L2_INT_RAW_STATUS_ERRWD_SHIFT               4
#define REG_OS_L2_INT_RAW_STATUS_ERRWD_SIZE                1
#define REG_OS_L2_INT_RAW_STATUS_ERRWD_MASK                0x0010

#define REG_OS_L2_INT_RAW_STATUS_ERRWT_SHIFT               3
#define REG_OS_L2_INT_RAW_STATUS_ERRWT_SIZE                1
#define REG_OS_L2_INT_RAW_STATUS_ERRWT_MASK                0x0008

#define REG_OS_L2_INT_RAW_STATUS_PARRD_SHIFT               2
#define REG_OS_L2_INT_RAW_STATUS_PARRD_SIZE                1
#define REG_OS_L2_INT_RAW_STATUS_PARRD_MASK                0x0004

#define REG_OS_L2_INT_RAW_STATUS_PARRT_SHIFT               1
#define REG_OS_L2_INT_RAW_STATUS_PARRT_SIZE                1
#define REG_OS_L2_INT_RAW_STATUS_PARRT_MASK                0x0002

#define REG_OS_L2_INT_RAW_STATUS_ECNTR_SHIFT               0
#define REG_OS_L2_INT_RAW_STATUS_ECNTR_SIZE                1
#define REG_OS_L2_INT_RAW_STATUS_ECNTR_MASK                0x0001

#ifndef SDK_ASM
#define REG_OS_L2_INT_RAW_STATUS_FIELD( decerr, slverr, errrd, errrt, errwd, errwt, parrd, parrt, ecntr ) \
    (u16)( \
    ((u32)(decerr) << REG_OS_L2_INT_RAW_STATUS_DECERR_SHIFT) | \
    ((u32)(slverr) << REG_OS_L2_INT_RAW_STATUS_SLVERR_SHIFT) | \
    ((u32)(errrd) << REG_OS_L2_INT_RAW_STATUS_ERRRD_SHIFT) | \
    ((u32)(errrt) << REG_OS_L2_INT_RAW_STATUS_ERRRT_SHIFT) | \
    ((u32)(errwd) << REG_OS_L2_INT_RAW_STATUS_ERRWD_SHIFT) | \
    ((u32)(errwt) << REG_OS_L2_INT_RAW_STATUS_ERRWT_SHIFT) | \
    ((u32)(parrd) << REG_OS_L2_INT_RAW_STATUS_PARRD_SHIFT) | \
    ((u32)(parrt) << REG_OS_L2_INT_RAW_STATUS_PARRT_SHIFT) | \
    ((u32)(ecntr) << REG_OS_L2_INT_RAW_STATUS_ECNTR_SHIFT))
#endif


/* L2_INT_CLEAR */

#define REG_OS_L2_INT_CLEAR_DECERR_SHIFT                   8
#define REG_OS_L2_INT_CLEAR_DECERR_SIZE                    1
#define REG_OS_L2_INT_CLEAR_DECERR_MASK                    0x0100

#define REG_OS_L2_INT_CLEAR_SLVERR_SHIFT                   7
#define REG_OS_L2_INT_CLEAR_SLVERR_SIZE                    1
#define REG_OS_L2_INT_CLEAR_SLVERR_MASK                    0x0080

#define REG_OS_L2_INT_CLEAR_ERRRD_SHIFT                    6
#define REG_OS_L2_INT_CLEAR_ERRRD_SIZE                     1
#define REG_OS_L2_INT_CLEAR_ERRRD_MASK                     0x0040

#define REG_OS_L2_INT_CLEAR_ERRRT_SHIFT                    5
#define REG_OS_L2_INT_CLEAR_ERRRT_SIZE                     1
#define REG_OS_L2_INT_CLEAR_ERRRT_MASK                     0x0020

#define REG_OS_L2_INT_CLEAR_ERRWD_SHIFT                    4
#define REG_OS_L2_INT_CLEAR_ERRWD_SIZE                     1
#define REG_OS_L2_INT_CLEAR_ERRWD_MASK                     0x0010

#define REG_OS_L2_INT_CLEAR_ERRWT_SHIFT                    3
#define REG_OS_L2_INT_CLEAR_ERRWT_SIZE                     1
#define REG_OS_L2_INT_CLEAR_ERRWT_MASK                     0x0008

#define REG_OS_L2_INT_CLEAR_PARRD_SHIFT                    2
#define REG_OS_L2_INT_CLEAR_PARRD_SIZE                     1
#define REG_OS_L2_INT_CLEAR_PARRD_MASK                     0x0004

#define REG_OS_L2_INT_CLEAR_PARRT_SHIFT                    1
#define REG_OS_L2_INT_CLEAR_PARRT_SIZE                     1
#define REG_OS_L2_INT_CLEAR_PARRT_MASK                     0x0002

#define REG_OS_L2_INT_CLEAR_ECNTR_SHIFT                    0
#define REG_OS_L2_INT_CLEAR_ECNTR_SIZE                     1
#define REG_OS_L2_INT_CLEAR_ECNTR_MASK                     0x0001

#ifndef SDK_ASM
#define REG_OS_L2_INT_CLEAR_FIELD( decerr, slverr, errrd, errrt, errwd, errwt, parrd, parrt, ecntr ) \
    (u16)( \
    ((u32)(decerr) << REG_OS_L2_INT_CLEAR_DECERR_SHIFT) | \
    ((u32)(slverr) << REG_OS_L2_INT_CLEAR_SLVERR_SHIFT) | \
    ((u32)(errrd) << REG_OS_L2_INT_CLEAR_ERRRD_SHIFT) | \
    ((u32)(errrt) << REG_OS_L2_INT_CLEAR_ERRRT_SHIFT) | \
    ((u32)(errwd) << REG_OS_L2_INT_CLEAR_ERRWD_SHIFT) | \
    ((u32)(errwt) << REG_OS_L2_INT_CLEAR_ERRWT_SHIFT) | \
    ((u32)(parrd) << REG_OS_L2_INT_CLEAR_PARRD_SHIFT) | \
    ((u32)(parrt) << REG_OS_L2_INT_CLEAR_PARRT_SHIFT) | \
    ((u32)(ecntr) << REG_OS_L2_INT_CLEAR_ECNTR_SHIFT))
#endif


/* L2_CACHE_SYNC */

#define REG_OS_L2_CACHE_SYNC_C_SHIFT                       0
#define REG_OS_L2_CACHE_SYNC_C_SIZE                        1
#define REG_OS_L2_CACHE_SYNC_C_MASK                        0x01

#ifndef SDK_ASM
#define REG_OS_L2_CACHE_SYNC_FIELD( c ) \
    (u8)( \
    ((u32)(c) << REG_OS_L2_CACHE_SYNC_C_SHIFT))
#endif


/* L2_INV_PA */

#define REG_OS_L2_INV_PA_TAG_INDEX_SHIFT                   5
#define REG_OS_L2_INV_PA_TAG_INDEX_SIZE                    27
#define REG_OS_L2_INV_PA_TAG_INDEX_MASK                    0xffffffe0

#define REG_OS_L2_INV_PA_C_SHIFT                           0
#define REG_OS_L2_INV_PA_C_SIZE                            1
#define REG_OS_L2_INV_PA_C_MASK                            0x00000001

#ifndef SDK_ASM
#define REG_OS_L2_INV_PA_FIELD( tag_index, c ) \
    (u32)( \
    ((u32)(tag_index) << REG_OS_L2_INV_PA_TAG_INDEX_SHIFT) | \
    ((u32)(c) << REG_OS_L2_INV_PA_C_SHIFT))
#endif


/* L2_INV_WAY */

#define REG_OS_L2_INV_WAY_WAY_BITS_SHIFT                   0
#define REG_OS_L2_INV_WAY_WAY_BITS_SIZE                    16
#define REG_OS_L2_INV_WAY_WAY_BITS_MASK                    0xffff

#ifndef SDK_ASM
#define REG_OS_L2_INV_WAY_FIELD( way_bits ) \
    (u16)( \
    ((u32)(way_bits) << REG_OS_L2_INV_WAY_WAY_BITS_SHIFT))
#endif


/* L2_CLEAN_PA */

#define REG_OS_L2_CLEAN_PA_TAG_INDEX_SHIFT                 5
#define REG_OS_L2_CLEAN_PA_TAG_INDEX_SIZE                  27
#define REG_OS_L2_CLEAN_PA_TAG_INDEX_MASK                  0xffffffe0

#define REG_OS_L2_CLEAN_PA_C_SHIFT                         0
#define REG_OS_L2_CLEAN_PA_C_SIZE                          1
#define REG_OS_L2_CLEAN_PA_C_MASK                          0x00000001

#ifndef SDK_ASM
#define REG_OS_L2_CLEAN_PA_FIELD( tag_index, c ) \
    (u32)( \
    ((u32)(tag_index) << REG_OS_L2_CLEAN_PA_TAG_INDEX_SHIFT) | \
    ((u32)(c) << REG_OS_L2_CLEAN_PA_C_SHIFT))
#endif


/* L2_CLEAN_INDEX */

#define REG_OS_L2_CLEAN_INDEX_WAY_SHIFT                    28
#define REG_OS_L2_CLEAN_INDEX_WAY_SIZE                     4
#define REG_OS_L2_CLEAN_INDEX_WAY_MASK                     0xf0000000

#define REG_OS_L2_CLEAN_INDEX_INDEX_SHIFT                  5
#define REG_OS_L2_CLEAN_INDEX_INDEX_SIZE                   23
#define REG_OS_L2_CLEAN_INDEX_INDEX_MASK                   0x0fffffe0

#define REG_OS_L2_CLEAN_INDEX_C_SHIFT                      0
#define REG_OS_L2_CLEAN_INDEX_C_SIZE                       1
#define REG_OS_L2_CLEAN_INDEX_C_MASK                       0x00000001

#ifndef SDK_ASM
#define REG_OS_L2_CLEAN_INDEX_FIELD( way, index, c ) \
    (u32)( \
    ((u32)(way) << REG_OS_L2_CLEAN_INDEX_WAY_SHIFT) | \
    ((u32)(index) << REG_OS_L2_CLEAN_INDEX_INDEX_SHIFT) | \
    ((u32)(c) << REG_OS_L2_CLEAN_INDEX_C_SHIFT))
#endif


/* L2_CLEAN_WAY */

#define REG_OS_L2_CLEAN_WAY_WAY_BITS_SHIFT                 0
#define REG_OS_L2_CLEAN_WAY_WAY_BITS_SIZE                  16
#define REG_OS_L2_CLEAN_WAY_WAY_BITS_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_CLEAN_WAY_FIELD( way_bits ) \
    (u16)( \
    ((u32)(way_bits) << REG_OS_L2_CLEAN_WAY_WAY_BITS_SHIFT))
#endif


/* L2_CLEAN_INV_PA */

#define REG_OS_L2_CLEAN_INV_PA_TAG_INDEX_SHIFT             5
#define REG_OS_L2_CLEAN_INV_PA_TAG_INDEX_SIZE              27
#define REG_OS_L2_CLEAN_INV_PA_TAG_INDEX_MASK              0xffffffe0

#define REG_OS_L2_CLEAN_INV_PA_C_SHIFT                     0
#define REG_OS_L2_CLEAN_INV_PA_C_SIZE                      1
#define REG_OS_L2_CLEAN_INV_PA_C_MASK                      0x00000001

#ifndef SDK_ASM
#define REG_OS_L2_CLEAN_INV_PA_FIELD( tag_index, c ) \
    (u32)( \
    ((u32)(tag_index) << REG_OS_L2_CLEAN_INV_PA_TAG_INDEX_SHIFT) | \
    ((u32)(c) << REG_OS_L2_CLEAN_INV_PA_C_SHIFT))
#endif


/* L2_CLEAN_INV_INDEX */

#define REG_OS_L2_CLEAN_INV_INDEX_WAY_SHIFT                28
#define REG_OS_L2_CLEAN_INV_INDEX_WAY_SIZE                 4
#define REG_OS_L2_CLEAN_INV_INDEX_WAY_MASK                 0xf0000000

#define REG_OS_L2_CLEAN_INV_INDEX_INDEX_SHIFT              5
#define REG_OS_L2_CLEAN_INV_INDEX_INDEX_SIZE               23
#define REG_OS_L2_CLEAN_INV_INDEX_INDEX_MASK               0x0fffffe0

#define REG_OS_L2_CLEAN_INV_INDEX_C_SHIFT                  0
#define REG_OS_L2_CLEAN_INV_INDEX_C_SIZE                   1
#define REG_OS_L2_CLEAN_INV_INDEX_C_MASK                   0x00000001

#ifndef SDK_ASM
#define REG_OS_L2_CLEAN_INV_INDEX_FIELD( way, index, c ) \
    (u32)( \
    ((u32)(way) << REG_OS_L2_CLEAN_INV_INDEX_WAY_SHIFT) | \
    ((u32)(index) << REG_OS_L2_CLEAN_INV_INDEX_INDEX_SHIFT) | \
    ((u32)(c) << REG_OS_L2_CLEAN_INV_INDEX_C_SHIFT))
#endif


/* L2_CLEAN_INV_WAY */

#define REG_OS_L2_CLEAN_INV_WAY_WAY_BITS_SHIFT             0
#define REG_OS_L2_CLEAN_INV_WAY_WAY_BITS_SIZE              16
#define REG_OS_L2_CLEAN_INV_WAY_WAY_BITS_MASK              0xffff

#ifndef SDK_ASM
#define REG_OS_L2_CLEAN_INV_WAY_FIELD( way_bits ) \
    (u16)( \
    ((u32)(way_bits) << REG_OS_L2_CLEAN_INV_WAY_WAY_BITS_SHIFT))
#endif


/* L2_D_LOCKDOWN0 */

#define REG_OS_L2_D_LOCKDOWN0_D_LOCK_SHIFT                 0
#define REG_OS_L2_D_LOCKDOWN0_D_LOCK_SIZE                  16
#define REG_OS_L2_D_LOCKDOWN0_D_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_D_LOCKDOWN0_FIELD( d_lock ) \
    (u16)( \
    ((u32)(d_lock) << REG_OS_L2_D_LOCKDOWN0_D_LOCK_SHIFT))
#endif


/* L2_I_LOCKDOWN0 */

#define REG_OS_L2_I_LOCKDOWN0_I_LOCK_SHIFT                 0
#define REG_OS_L2_I_LOCKDOWN0_I_LOCK_SIZE                  16
#define REG_OS_L2_I_LOCKDOWN0_I_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_I_LOCKDOWN0_FIELD( i_lock ) \
    (u16)( \
    ((u32)(i_lock) << REG_OS_L2_I_LOCKDOWN0_I_LOCK_SHIFT))
#endif


/* L2_D_LOCKDOWN1 */

#define REG_OS_L2_D_LOCKDOWN1_D_LOCK_SHIFT                 0
#define REG_OS_L2_D_LOCKDOWN1_D_LOCK_SIZE                  16
#define REG_OS_L2_D_LOCKDOWN1_D_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_D_LOCKDOWN1_FIELD( d_lock ) \
    (u16)( \
    ((u32)(d_lock) << REG_OS_L2_D_LOCKDOWN1_D_LOCK_SHIFT))
#endif


/* L2_I_LOCKDOWN1 */

#define REG_OS_L2_I_LOCKDOWN1_I_LOCK_SHIFT                 0
#define REG_OS_L2_I_LOCKDOWN1_I_LOCK_SIZE                  16
#define REG_OS_L2_I_LOCKDOWN1_I_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_I_LOCKDOWN1_FIELD( i_lock ) \
    (u16)( \
    ((u32)(i_lock) << REG_OS_L2_I_LOCKDOWN1_I_LOCK_SHIFT))
#endif


/* L2_D_LOCKDOWN2 */

#define REG_OS_L2_D_LOCKDOWN2_D_LOCK_SHIFT                 0
#define REG_OS_L2_D_LOCKDOWN2_D_LOCK_SIZE                  16
#define REG_OS_L2_D_LOCKDOWN2_D_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_D_LOCKDOWN2_FIELD( d_lock ) \
    (u16)( \
    ((u32)(d_lock) << REG_OS_L2_D_LOCKDOWN2_D_LOCK_SHIFT))
#endif


/* L2_I_LOCKDOWN2 */

#define REG_OS_L2_I_LOCKDOWN2_I_LOCK_SHIFT                 0
#define REG_OS_L2_I_LOCKDOWN2_I_LOCK_SIZE                  16
#define REG_OS_L2_I_LOCKDOWN2_I_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_I_LOCKDOWN2_FIELD( i_lock ) \
    (u16)( \
    ((u32)(i_lock) << REG_OS_L2_I_LOCKDOWN2_I_LOCK_SHIFT))
#endif


/* L2_D_LOCKDOWN3 */

#define REG_OS_L2_D_LOCKDOWN3_D_LOCK_SHIFT                 0
#define REG_OS_L2_D_LOCKDOWN3_D_LOCK_SIZE                  16
#define REG_OS_L2_D_LOCKDOWN3_D_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_D_LOCKDOWN3_FIELD( d_lock ) \
    (u16)( \
    ((u32)(d_lock) << REG_OS_L2_D_LOCKDOWN3_D_LOCK_SHIFT))
#endif


/* L2_I_LOCKDOWN3 */

#define REG_OS_L2_I_LOCKDOWN3_I_LOCK_SHIFT                 0
#define REG_OS_L2_I_LOCKDOWN3_I_LOCK_SIZE                  16
#define REG_OS_L2_I_LOCKDOWN3_I_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_I_LOCKDOWN3_FIELD( i_lock ) \
    (u16)( \
    ((u32)(i_lock) << REG_OS_L2_I_LOCKDOWN3_I_LOCK_SHIFT))
#endif


/* L2_D_LOCKDOWN4 */

#define REG_OS_L2_D_LOCKDOWN4_D_LOCK_SHIFT                 0
#define REG_OS_L2_D_LOCKDOWN4_D_LOCK_SIZE                  16
#define REG_OS_L2_D_LOCKDOWN4_D_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_D_LOCKDOWN4_FIELD( d_lock ) \
    (u16)( \
    ((u32)(d_lock) << REG_OS_L2_D_LOCKDOWN4_D_LOCK_SHIFT))
#endif


/* L2_I_LOCKDOWN4 */

#define REG_OS_L2_I_LOCKDOWN4_I_LOCK_SHIFT                 0
#define REG_OS_L2_I_LOCKDOWN4_I_LOCK_SIZE                  16
#define REG_OS_L2_I_LOCKDOWN4_I_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_I_LOCKDOWN4_FIELD( i_lock ) \
    (u16)( \
    ((u32)(i_lock) << REG_OS_L2_I_LOCKDOWN4_I_LOCK_SHIFT))
#endif


/* L2_D_LOCKDOWN5 */

#define REG_OS_L2_D_LOCKDOWN5_D_LOCK_SHIFT                 0
#define REG_OS_L2_D_LOCKDOWN5_D_LOCK_SIZE                  16
#define REG_OS_L2_D_LOCKDOWN5_D_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_D_LOCKDOWN5_FIELD( d_lock ) \
    (u16)( \
    ((u32)(d_lock) << REG_OS_L2_D_LOCKDOWN5_D_LOCK_SHIFT))
#endif


/* L2_I_LOCKDOWN5 */

#define REG_OS_L2_I_LOCKDOWN5_I_LOCK_SHIFT                 0
#define REG_OS_L2_I_LOCKDOWN5_I_LOCK_SIZE                  16
#define REG_OS_L2_I_LOCKDOWN5_I_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_I_LOCKDOWN5_FIELD( i_lock ) \
    (u16)( \
    ((u32)(i_lock) << REG_OS_L2_I_LOCKDOWN5_I_LOCK_SHIFT))
#endif


/* L2_D_LOCKDOWN6 */

#define REG_OS_L2_D_LOCKDOWN6_D_LOCK_SHIFT                 0
#define REG_OS_L2_D_LOCKDOWN6_D_LOCK_SIZE                  16
#define REG_OS_L2_D_LOCKDOWN6_D_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_D_LOCKDOWN6_FIELD( d_lock ) \
    (u16)( \
    ((u32)(d_lock) << REG_OS_L2_D_LOCKDOWN6_D_LOCK_SHIFT))
#endif


/* L2_I_LOCKDOWN6 */

#define REG_OS_L2_I_LOCKDOWN6_I_LOCK_SHIFT                 0
#define REG_OS_L2_I_LOCKDOWN6_I_LOCK_SIZE                  16
#define REG_OS_L2_I_LOCKDOWN6_I_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_I_LOCKDOWN6_FIELD( i_lock ) \
    (u16)( \
    ((u32)(i_lock) << REG_OS_L2_I_LOCKDOWN6_I_LOCK_SHIFT))
#endif


/* L2_D_LOCKDOWN7 */

#define REG_OS_L2_D_LOCKDOWN7_D_LOCK_SHIFT                 0
#define REG_OS_L2_D_LOCKDOWN7_D_LOCK_SIZE                  16
#define REG_OS_L2_D_LOCKDOWN7_D_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_D_LOCKDOWN7_FIELD( d_lock ) \
    (u16)( \
    ((u32)(d_lock) << REG_OS_L2_D_LOCKDOWN7_D_LOCK_SHIFT))
#endif


/* L2_I_LOCKDOWN7 */

#define REG_OS_L2_I_LOCKDOWN7_I_LOCK_SHIFT                 0
#define REG_OS_L2_I_LOCKDOWN7_I_LOCK_SIZE                  16
#define REG_OS_L2_I_LOCKDOWN7_I_LOCK_MASK                  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_I_LOCKDOWN7_FIELD( i_lock ) \
    (u16)( \
    ((u32)(i_lock) << REG_OS_L2_I_LOCKDOWN7_I_LOCK_SHIFT))
#endif


/* L2_LOCK_LINE_EN */

#define REG_OS_L2_LOCK_LINE_EN_LOCKDOWN_LINE_EN_SHIFT      0
#define REG_OS_L2_LOCK_LINE_EN_LOCKDOWN_LINE_EN_SIZE       1
#define REG_OS_L2_LOCK_LINE_EN_LOCKDOWN_LINE_EN_MASK       0x01

#ifndef SDK_ASM
#define REG_OS_L2_LOCK_LINE_EN_FIELD( lockdown_line_en ) \
    (u8)( \
    ((u32)(lockdown_line_en) << REG_OS_L2_LOCK_LINE_EN_LOCKDOWN_LINE_EN_SHIFT))
#endif


/* L2_UNLOCK_WAY */

#define REG_OS_L2_UNLOCK_WAY_UNLOCK_ALL_LINES_WAY_OP_SHIFT 0
#define REG_OS_L2_UNLOCK_WAY_UNLOCK_ALL_LINES_WAY_OP_SIZE  16
#define REG_OS_L2_UNLOCK_WAY_UNLOCK_ALL_LINES_WAY_OP_MASK  0xffff

#ifndef SDK_ASM
#define REG_OS_L2_UNLOCK_WAY_FIELD( unlock_all_lines_way_op ) \
    (u16)( \
    ((u32)(unlock_all_lines_way_op) << REG_OS_L2_UNLOCK_WAY_UNLOCK_ALL_LINES_WAY_OP_SHIFT))
#endif


/* L2_DEBUG_CTRL */

#define REG_OS_L2_DEBUG_CTRL_SPNIDEN_SHIFT                 2
#define REG_OS_L2_DEBUG_CTRL_SPNIDEN_SIZE                  1
#define REG_OS_L2_DEBUG_CTRL_SPNIDEN_MASK                  0x04

#define REG_OS_L2_DEBUG_CTRL_DWB_SHIFT                     1
#define REG_OS_L2_DEBUG_CTRL_DWB_SIZE                      1
#define REG_OS_L2_DEBUG_CTRL_DWB_MASK                      0x02

#define REG_OS_L2_DEBUG_CTRL_DCL_SHIFT                     0
#define REG_OS_L2_DEBUG_CTRL_DCL_SIZE                      1
#define REG_OS_L2_DEBUG_CTRL_DCL_MASK                      0x01

#ifndef SDK_ASM
#define REG_OS_L2_DEBUG_CTRL_FIELD( spniden, dwb, dcl ) \
    (u8)( \
    ((u32)(spniden) << REG_OS_L2_DEBUG_CTRL_SPNIDEN_SHIFT) | \
    ((u32)(dwb) << REG_OS_L2_DEBUG_CTRL_DWB_SHIFT) | \
    ((u32)(dcl) << REG_OS_L2_DEBUG_CTRL_DCL_SHIFT))
#endif


/* L2_PREFETCH_CTRL */

#define REG_OS_L2_PREFETCH_CTRL_DOUBLE_LINEFILL_EN_SHIFT   30
#define REG_OS_L2_PREFETCH_CTRL_DOUBLE_LINEFILL_EN_SIZE    1
#define REG_OS_L2_PREFETCH_CTRL_DOUBLE_LINEFILL_EN_MASK    0x40000000

#define REG_OS_L2_PREFETCH_CTRL_I_PREFETCH_EN_SHIFT        29
#define REG_OS_L2_PREFETCH_CTRL_I_PREFETCH_EN_SIZE         1
#define REG_OS_L2_PREFETCH_CTRL_I_PREFETCH_EN_MASK         0x20000000

#define REG_OS_L2_PREFETCH_CTRL_D_PREFETCH_EN_SHIFT        28
#define REG_OS_L2_PREFETCH_CTRL_D_PREFETCH_EN_SIZE         1
#define REG_OS_L2_PREFETCH_CTRL_D_PREFETCH_EN_MASK         0x10000000

#define REG_OS_L2_PREFETCH_CTRL_DOUBLE_LINEFILL_WRAP_READ_DISABLE_SHIFT 27
#define REG_OS_L2_PREFETCH_CTRL_DOUBLE_LINEFILL_WRAP_READ_DISABLE_SIZE 1
#define REG_OS_L2_PREFETCH_CTRL_DOUBLE_LINEFILL_WRAP_READ_DISABLE_MASK 0x08000000

#define REG_OS_L2_PREFETCH_CTRL_PREFETCH_DROP_EN_SHIFT     24
#define REG_OS_L2_PREFETCH_CTRL_PREFETCH_DROP_EN_SIZE      1
#define REG_OS_L2_PREFETCH_CTRL_PREFETCH_DROP_EN_MASK      0x01000000

#define REG_OS_L2_PREFETCH_CTRL_INCR_DOUBLE_LINEFILL_EN_SHIFT 23
#define REG_OS_L2_PREFETCH_CTRL_INCR_DOUBLE_LINEFILL_EN_SIZE 1
#define REG_OS_L2_PREFETCH_CTRL_INCR_DOUBLE_LINEFILL_EN_MASK 0x00800000

#define REG_OS_L2_PREFETCH_CTRL_NOT_SAME_ID_EX_SEQ_EN_SHIFT 21
#define REG_OS_L2_PREFETCH_CTRL_NOT_SAME_ID_EX_SEQ_EN_SIZE 1
#define REG_OS_L2_PREFETCH_CTRL_NOT_SAME_ID_EX_SEQ_EN_MASK 0x00200000

#define REG_OS_L2_PREFETCH_CTRL_PREFETCH_OFFSET_SHIFT      0
#define REG_OS_L2_PREFETCH_CTRL_PREFETCH_OFFSET_SIZE       5
#define REG_OS_L2_PREFETCH_CTRL_PREFETCH_OFFSET_MASK       0x0000001f

#ifndef SDK_ASM
#define REG_OS_L2_PREFETCH_CTRL_FIELD( double_linefill_en, i_prefetch_en, d_prefetch_en, double_linefill_wrap_read_disable, prefetch_drop_en, incr_double_linefill_en, not_same_id_ex_seq_en, prefetch_offset ) \
    (u32)( \
    ((u32)(double_linefill_en) << REG_OS_L2_PREFETCH_CTRL_DOUBLE_LINEFILL_EN_SHIFT) | \
    ((u32)(i_prefetch_en) << REG_OS_L2_PREFETCH_CTRL_I_PREFETCH_EN_SHIFT) | \
    ((u32)(d_prefetch_en) << REG_OS_L2_PREFETCH_CTRL_D_PREFETCH_EN_SHIFT) | \
    ((u32)(double_linefill_wrap_read_disable) << REG_OS_L2_PREFETCH_CTRL_DOUBLE_LINEFILL_WRAP_READ_DISABLE_SHIFT) | \
    ((u32)(prefetch_drop_en) << REG_OS_L2_PREFETCH_CTRL_PREFETCH_DROP_EN_SHIFT) | \
    ((u32)(incr_double_linefill_en) << REG_OS_L2_PREFETCH_CTRL_INCR_DOUBLE_LINEFILL_EN_SHIFT) | \
    ((u32)(not_same_id_ex_seq_en) << REG_OS_L2_PREFETCH_CTRL_NOT_SAME_ID_EX_SEQ_EN_SHIFT) | \
    ((u32)(prefetch_offset) << REG_OS_L2_PREFETCH_CTRL_PREFETCH_OFFSET_SHIFT))
#endif


/* L2_POWER_CTRL */

#define REG_OS_L2_POWER_CTRL_DYNAMIC_CLK_GATING_EN_SHIFT   1
#define REG_OS_L2_POWER_CTRL_DYNAMIC_CLK_GATING_EN_SIZE    1
#define REG_OS_L2_POWER_CTRL_DYNAMIC_CLK_GATING_EN_MASK    0x02

#define REG_OS_L2_POWER_CTRL_STANDBY_MODE_EN_SHIFT         0
#define REG_OS_L2_POWER_CTRL_STANDBY_MODE_EN_SIZE          1
#define REG_OS_L2_POWER_CTRL_STANDBY_MODE_EN_MASK          0x01

#ifndef SDK_ASM
#define REG_OS_L2_POWER_CTRL_FIELD( dynamic_clk_gating_en, standby_mode_en ) \
    (u8)( \
    ((u32)(dynamic_clk_gating_en) << REG_OS_L2_POWER_CTRL_DYNAMIC_CLK_GATING_EN_SHIFT) | \
    ((u32)(standby_mode_en) << REG_OS_L2_POWER_CTRL_STANDBY_MODE_EN_SHIFT))
#endif
...
/* NN_HW_CTR_EIU_MPCORE_IOREG_EIUPATCH_OS_H_ */
#endif
