#ident "$Id: dvd_low_rvl.c,v 1.4 2006/04/29 00:23:46 paulm Exp $"
...
static uint8_t             h3HashArray[96 * 1024];
                ...
                const uint8_t* const hashValuePtr)
{
    ...
    result = IOS_GenerateHashSw(&hashContext, hashArray, hashArrayLength,
    ...
    */
    ...
    result = IOS_GenerateHashSw(&hashContext, NULL,
