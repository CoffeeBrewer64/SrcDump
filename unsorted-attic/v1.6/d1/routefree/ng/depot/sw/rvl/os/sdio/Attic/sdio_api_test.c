 ...
 *
 * $Id: sdio_api_test.c,v 1.5 2006/03/21 02:26:02 wheeler Exp $
 */

char ident[] = "$Id: sdio_api_test.c,v 1.5 2006/03/21 02:26:02 wheeler Exp $";
...
tasks_t cmd53_data[] = {
    /* Round 1   */
    #if 1
    	{ SDIO_WR, SDIO_CMD53, 0, 1, 0x80c4, 4, 0x11223344, 0x0, 1, SDIO_PIO },
    #else
    	{ SDIO_WR, SDIO_CMD53, 0, 1, 0x80c4, 4, 0x55667788, 0x0, 1, SDIO_DMA },
    #endif
    // { SDIO_WR, SDIO_CMD53, 0, 1, 0x80c0, 4, 0x40003, 0x0, 1, SDIO_DMA }, 
    #if 0
		{ SDIO_RD, SDIO_CMD53, 0, 1, 0x80c4, 4, 0x0, 0x11223344, 1, SDIO_PIO },    	  
    #else 
   	 	{ SDIO_RD, SDIO_CMD53, 0, 1, 0x80c4, 4, 0x0, 0x55667788, 1, SDIO_DMA },
    #endif
...
*/
    ...
    printf ("--- Send Reset SDIO Command ---\n");
	...
	#if 1 
		set_driver_debug(Handles[config.SDDevSlot][0],1|DEBUG_SER_REG_MREAD|0x2401);
